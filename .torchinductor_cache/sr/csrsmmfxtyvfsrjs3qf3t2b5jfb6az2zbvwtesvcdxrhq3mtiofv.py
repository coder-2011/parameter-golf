...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/bj/cbjf33hkyqyhy5qnoral7jcag2wd2amsdtajr2ejlvwkgjfopadt.py
...
#   %primals_2 : Tensor "bf16[131072, 96][96, 1]cuda:6" = PlaceHolder[target=primals_2]
#   %sum_1 : Tensor "f32[128, 1024, 96][98304, 96, 1]cuda:6" = PlaceHolder[target=sum_1]
#   %embedding : Tensor "bf16[128, 1024, 8, 96][786432, 768, 96, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%primals_2, %primals_1), kwargs = {})
#   %sum_1 : Tensor "f32[128, 1024, 96][98304, 96, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%embedding, [-2]), kwargs = {dtype: torch.float32})
#   %mul : Tensor "f32[128, 1024, 96][98304, 96, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.3535533905932738), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[128, 1024, 96][98304, 96, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sf/csf4fct3xrt2f6fruvm5fqry33cr43oyf3qxa64pm4frphqopytx.py
# Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy, aten.t]
# Source node to ATen node mapping:
#   linear => convert_element_type_default_7, permute
# Graph fragment:
#   %primals_3 : Tensor "bf16[384, 96][96, 1]cuda:6" = PlaceHolder[target=primals_3]
#   %convert_element_type_default_7 : Tensor "bf16[384, 96][96, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_3, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[96, 384][1, 96]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_7, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/n4/cn4zg5hms43vbck7uyheijg7tijjizquojoc5tqxxofk3qblizt7.py
...
#   %convert_element_type_5 : Tensor "bf16[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_4, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ig/cigyshxvgo6md7osyg4slhepgrad5f3hcnnph4sbvl6hkxvw7xjz.py
...
# Graph fragment:
#   %primals_9 : Tensor "i64[128, 1024][1024, 1]cuda:6" = PlaceHolder[target=primals_9]
...
#   %buf9 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:6" = PlaceHolder[target=buf9]
...
#   %mul_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_1, %sigmoid), kwargs = {})
#   %convert_element_type_9 : Tensor "bf16[][]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_7, torch.bfloat16), kwargs = {})
...
#   %add : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_6, %mul_2), kwargs = {})
...
#   %full_default : Tensor "bf16[128, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([128, 1, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %slice_2 : Tensor "bf16[128, 1023, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%add, 1, 0, -1), kwargs = {})
#   %cat : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.cat.default](args = ([%full_default, %slice_2], 1), kwargs = {})
#   %ne : Tensor "b8[128, 1024][1024, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.ne.Scalar](args = (%primals_9, 1), kwargs = {})
...
#   %unsqueeze_2 : Tensor "bf16[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%convert_element_type_11, -1), kwargs = {})
...
#   %mul_4 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %add), kwargs = {})
#   %mul_5 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %mul_3), kwargs = {})
#   %add_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_4, %mul_5), kwargs = {})
...
#   %convert_element_type_13 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.float32), kwargs = {})
...
#   %add_2 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean, 1e-06), kwargs = {})
#   %rsqrt : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_2,), kwargs = {})
#   %mul_6 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_13, %rsqrt), kwargs = {})
#   %mul_7 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_6, %convert_element_type_12), kwargs = {})
#   %convert_element_type_14 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_7, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/j5/cj5c5tnu5vfrjt7y4hr7k2thglgrijisyjjw7vonosg5wsxpopbm.py
...
#   %slice_3 : Tensor "bf16[128, 1024, 4, 48][786432, 768, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_6, 2, 12, 9223372036854775807), kwargs = {})
#   %clone : Tensor "bf16[128, 1024, 4, 48][196608, 192, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_3,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone
...
# Graph fragment:
#   %primals_14 : Tensor "f32[8, 12][12, 1]cuda:6" = PlaceHolder[target=primals_14]
#   %convert_element_type_17 : Tensor "bf16[8, 12][12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_14, torch.bfloat16), kwargs = {})
...
#   %slice_4 : Tensor "bf16[128, 1024, 12][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%convert_element_type_14, 2, 0, 12), kwargs = {})
#   %clone_1 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_4,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_1
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pw/cpwlgmcazyoftobt2z3pwadfeqietfplbiuusfz7z6423o47eslu.py
...
#   %sigmoid_2 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_8,), kwargs = {})
...
#   %mul_9 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%permute_8, %unsqueeze_3), kwargs = {})
#   return %mul_9
...
#   %buf30 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:6" = PlaceHolder[target=buf30]
...
#   %add_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_11, %add_1), kwargs = {})
...
#   %convert_element_type_23 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_3, torch.float32), kwargs = {})
...
#   %add_4 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_1, 1e-06), kwargs = {})
#   %rsqrt_1 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_4,), kwargs = {})
#   %mul_10 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_23, %rsqrt_1), kwargs = {})
#   %mul_11 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_10, %convert_element_type_22), kwargs = {})
#   %convert_element_type_24 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_11, torch.bfloat16), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(6):
            ...
            triton_per_fused__to_copy_embedding_mul_sum_0.run(primals_1, primals_2, buf2, 12582912, 8, stream=stream6)
            del primals_2
            buf1 = empty_strided_cuda((96, 384), (1, 96), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy, aten.t]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_t_1.run(primals_3, buf1, 36864, stream=stream6)
            del primals_3
            ...
            # Topologically Sorted Source Nodes: [to_1], Original ATen: [aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_2.run(primals_4, buf4, 384, stream=stream6)
            del primals_4
            ...
            # Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_1, to_4, mul_2, add, to_5, sigmoid_1, getitem, zeros_like, getitem_2, cat, ne, to_6, unsqueeze, mul_3, sub, mul_4, mul_5, add_2, to_7, rms_norm], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten._to_copy, aten.add, aten.unsqueeze, aten.zeros_like, aten.slice, aten.cat, aten.ne, aten.rsub, aten._fused_rms_norm]
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_cat_mul_ne_rsub_sigmoid_slice_unsqueeze_view_zeros_like_3.run(buf10, primals_9, primals_6, buf3, buf5, primals_7, primals_8, primals_10, buf7, buf6, buf8, buf11, 131072, 384, stream=stream6)
            del primals_9
            ...
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf12, (128, 1024, 16, 48), (786432, 768, 48, 1), 0), buf13, buf14, reinterpret_tensor(primals_12, (1024, 24), (24, 1), 0), reinterpret_tensor(primals_13, (1024, 24), (24, 1), 0), 1572864, 1, 1, stream=stream6)
            buf17 = empty_strided_cuda((128, 1024, 4, 48), (196608, 192, 48, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_2, view, getitem, v], Original ATen: [aten._unsafe_view, aten.view, aten.slice, aten.clone]
            stream6 = get_raw_stream(6)
            triton_poi_fused__unsafe_view_clone_slice_view_4.run(buf12, buf17, 25165824, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [to_9, linear_3], Original ATen: [aten._to_copy, aten.t]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_t_5.run(primals_14, buf24, 96, stream=stream6)
            del primals_14
            buf25 = empty_strided_cuda((128, 1024, 12), (12288, 12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_6, contiguous_3], Original ATen: [aten.slice, aten.clone]
            stream6 = get_raw_stream(6)
            triton_poi_fused_clone_slice_6.run(buf11, buf25, 1572864, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_3, mul_6, sigmoid_2, getitem_7, mul_7], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream6 = get_raw_stream(6)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_7.run(buf19, buf26, buf27, 50331648, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [linear_4, add_3, to_11, rms_norm_1], Original ATen: [aten._unsafe_view, aten.add, aten._to_copy, aten._fused_rms_norm]
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_8.run(buf29, buf31, buf8, primals_16, buf32, 131072, 384, stream=stream6)
...
def get_args():
    ...
    primals_2 = rand_strided((131072, 96), (96, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_3 = rand_strided((384, 96), (96, 1), device='cuda:6', dtype=torch.bfloat16)
    ...
    primals_9 = rand_strided((128, 1024), (1024, 1), device='cuda:6', dtype=torch.int64)
    ...
    primals_12 = rand_strided((1, 1024, 1, 24), (24576, 24, 24, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_13 = rand_strided((1, 1024, 1, 24), (24576, 24, 24, 1), device='cuda:6', dtype=torch.bfloat16)
