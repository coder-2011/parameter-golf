...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ev/cevsx5if7klqg2pd24c3d4gl5kc73yyox5dunn6uhgg7bchbbtht.py
...
#   %primals_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:0" = PlaceHolder[target=primals_3]
...
#   %mul_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %view_1), kwargs = {})
#   %sum_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_4, [0, 1], True), kwargs = {dtype: torch.float32})
#   %mul_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %primals_3), kwargs = {})
#   %sum_2 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_5, [0, 1], True), kwargs = {dtype: torch.float32})
#   return %buf0,%buf5
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/4w/c4w3ntyjswxvvbnfw4oilzncy2vpobvmrozvoqdxjfx76rkag6uw.py
...
#   sum_1 => sum_1
# Graph fragment:
#   %buf0 : Tensor "f32[1, 1, 384, 349][134016, 134016, 1, 384]cuda:0" = PlaceHolder[target=buf0]
#   %view_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm, [128, 1024, 384]), kwargs = {})
#   %mul_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %view_1), kwargs = {})
#   %sum_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_4, [0, 1], True), kwargs = {dtype: torch.float32})
#   return %sum_1
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/b3/cb3oapmviquttbt2lmhroxkxal5loh76cpatdy7g7wo2bxcvuhx7.py
...
# Graph fragment:
#   %tangents_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:0" = PlaceHolder[target=tangents_1]
#   %primals_1 : Tensor "f32[384][1]cuda:0" = PlaceHolder[target=primals_1]
#   %exp : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%primals_1,), kwargs = {})
#   %log1p : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.log1p.default](args = (%exp,), kwargs = {})
#   %gt : Tensor "b8[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.gt.Scalar](args = (%primals_1, 20), kwargs = {})
#   %where : Tensor "f32[384][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.where.self](args = (%gt, %primals_1, %log1p), kwargs = {})
#   %mul_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %where), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_3, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xv/cxvcvbvh7c3gcieebm7gx2dufvyquguw34ez4dmuecuybiqdjovb.py
...
#   where_1 => where_1
# Graph fragment:
#   %buf5 : Tensor "f32[1, 1, 384, 349][134016, 134016, 1, 384]cuda:0" = PlaceHolder[target=buf5]
#   %sum_2 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:0" = PlaceHolder[target=sum_2]
#   %primals_1 : Tensor "f32[384][1]cuda:0" = PlaceHolder[target=primals_1]
#   %primals_2 : Tensor "f32[384][1]cuda:0" = PlaceHolder[target=primals_2]
#   %sum_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:0" = PlaceHolder[target=sum_1]
#   %exp : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%primals_1,), kwargs = {})
#   %log1p : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.log1p.default](args = (%exp,), kwargs = {})
#   %gt : Tensor "b8[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.gt.Scalar](args = (%primals_1, 20), kwargs = {})
#   %where : Tensor "f32[384][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.where.self](args = (%gt, %primals_1, %log1p), kwargs = {})
#   %view_2 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%sum_1, [384]), kwargs = {})
#   %mul_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %primals_3), kwargs = {})
#   %sum_2 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_5, [0, 1], True), kwargs = {dtype: torch.float32})
#   %view_5 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%sum_2, [384]), kwargs = {})
#   %exp_1 : Tensor "f32[384][1]cuda:0"[num_users=3] = call_function[target=torch.ops.aten.exp.default](args = (%primals_2,), kwargs = {})
#   %neg : Tensor "f32[384][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.neg.default](args = (%where,), kwargs = {})
#   %mul : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%neg, %exp_1), kwargs = {})
#   %exp_2 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%mul,), kwargs = {})
#   %mul_6 : Tensor "f32[384][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_5, %exp_2), kwargs = {})
#   %mul_7 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_6, %neg), kwargs = {})
#   %mul_8 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_6, %exp_1), kwargs = {})
#   %neg_1 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.neg.default](args = (%mul_8,), kwargs = {})
#   %add_1 : Tensor "f32[384][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_2, %neg_1), kwargs = {})
#   %mul_9 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_7, %exp_1), kwargs = {})
#   %mul_10 : Tensor "f32[384][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%primals_1, 1), kwargs = {})
#   %exp_3 : Tensor "f32[384][1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.exp.default](args = (%mul_10,), kwargs = {})
#   %gt_1 : Tensor "b8[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.gt.Scalar](args = (%mul_10, 20), kwargs = {})
#   %mul_12 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_1, %exp_3), kwargs = {})
#   %add_2 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%exp_3, 1.0), kwargs = {})
#   %div : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_12, %add_2), kwargs = {})
#   %where_1 : Tensor "f32[384][1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt_1, %add_1, %div), kwargs = {})
...
@triton_heuristics.reduction(
    ...
    reduction_hint=ReductionHint.OUTER_TINY,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_red_fused__unsafe_view_mul_sum_0.run(tangents_1, mm, primals_3, buf0, buf5, 134016, 376, stream=stream0)
            del mm
            del primals_3
            buf1 = empty_strided_cuda((1, 1, 384), (384, 384, 1), torch.float32)
            # Topologically Sorted Source Nodes: [matmul, mul_4, sum_1], Original ATen: [aten._unsafe_view, aten.mul, aten.sum]
            stream0 = get_raw_stream(0)
            triton_red_fused__unsafe_view_mul_sum_1.run(buf0, buf1, 384, 349, stream=stream0)
            del buf0
            buf2 = empty_strided_cuda((128, 1024, 384), (393216, 384, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [dt, mul_3, convert_element_type_2], Original ATen: [aten.softplus, aten.mul, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_mul_softplus_2.run(tangents_1, primals_1, buf2, 50331648, stream=stream0)
            del tangents_1
            ...
            # Topologically Sorted Source Nodes: [dt, view_2, mul_5, sum_2, view_5, A, neg, mul, decay, mul_6, mul_7, mul_8, neg_1, add_1, mul_9, mul_10, exp_3, gt_1, mul_12, add_2, div, where_1], Original ATen: [aten.softplus, aten.view, aten.mul, aten.sum, aten.exp, aten.neg, aten.add, aten.softplus_backward]
            stream0 = get_raw_stream(0)
            triton_red_fused_add_exp_mul_neg_softplus_softplus_backward_sum_view_3.run(buf8, buf5, primals_1, primals_2, buf7, 384, 349, stream=stream0)
            del buf5
            del primals_1
            del primals_2
...
def get_args():
    ...
    primals_3 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:0', dtype=torch.float32)
    primals_4 = rand_strided((384, 384), (384, 1), device='cuda:0', dtype=torch.bfloat16)
