...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/46/c46hez4onohnymrkjf637jhhhlnfwqec7ynxwu3b3m4icawu6v5o.py
...
#   %sum_1 : Tensor "f32[350, 1000, 128][128000, 128, 1]cuda:6" = PlaceHolder[target=sum_1]
...
#   %embedding_1 : Tensor "bf16[350, 1000, 8, 128][1024000, 1024, 128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%arg6_1, %add_1), kwargs = {})
...
#   %mul_3 : Tensor "f32[350, 1000, 128][128000, 128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.3535533905932738), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(6):
            ...
            # Topologically Sorted Source Nodes: [setitem, setitem_1, remainder, add, arange, mul_2, add_1, embedding_1, sum_1, mul_3, linear], Original ATen: [aten.select, aten.lift_fresh, aten.fill, aten.slice, aten.remainder, aten.add, aten.copy, aten.arange, aten.mul, aten.embedding, aten.sum, aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_per_fused__to_copy_add_arange_copy_embedding_fill_lift_fresh_mul_remainder_select_slice_sum_1.run(buf1, arg6_1, buf3, 44800000, 8, stream=stream6)
            del arg6_1
            del buf1
