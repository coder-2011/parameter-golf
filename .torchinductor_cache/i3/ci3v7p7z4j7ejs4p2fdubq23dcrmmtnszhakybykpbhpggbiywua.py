...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ba/cbaefjvx3ldymrlybh46ls3szwkk2lol37lk6kg3d67bgp276udj.py
...
#   %arg1_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4" = PlaceHolder[target=arg1_1]
#   %arg2_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:4" = PlaceHolder[target=arg2_1]
...
#   %buf20 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:4" = PlaceHolder[target=buf20]
#   %arg11_1 : Tensor "f32[384][1]cuda:4" = PlaceHolder[target=arg11_1]
#   %mul_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4" = PlaceHolder[target=mul_4]
...
#   %mul : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %arg1_1), kwargs = {})
...
#   %mul_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_3, %arg2_1), kwargs = {})
#   %add : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %mul_1), kwargs = {})
...
#   %rsqrt : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_1,), kwargs = {})
#   %mul_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add, %rsqrt), kwargs = {})
#   %mul_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_2, %arg3_1), kwargs = {})
...
#   %pow_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add, 2), kwargs = {})
...
#   %add_2 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_1, 1e-06), kwargs = {})
#   %rsqrt_1 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_2,), kwargs = {})
#   %mul_7 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add, %rsqrt_1), kwargs = {})
#   %mul_8 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_7, %arg11_1), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/t2/ct2y72ojwdeg5taspxa7jmphxlbw2xpooxltrlrwiploettc6cz4.py
...
#   %view_2 : Tensor "bf16[128, 1024, 24, 48][1179648, 1152, 48, 1]cuda:4"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%view_1, [128, 1024, 24, 48]), kwargs = {})
#   %permute_4 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty, [0, 2, 1, 3]), kwargs = {})
#   %permute_5 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty_1, [0, 2, 1, 3]), kwargs = {})
...
#   %permute_3 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%clone, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/vo/cvo2shxnidaidv3zilsd6y3hkgeaz4sbld3ibjabcippb7cslphs.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ga/cga2y7ypu4a52aoascdgibfvzarholh7xmteufktlzhi2pj5cww2.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/jn/cjn6poacwvoyojp7mdize6qhhe6mskm3wjbtct4xpib5m3si7p6f.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pd/cpdzji7tmwudaor3mh4w7jvnrdh4dzquqwmi6vu7hxtui5obwgqh.py
...
#   square => pow_3
# Graph fragment:
#   %mm_3 : Tensor "bf16[131072, 1024][1024, 1]cuda:4" = PlaceHolder[target=mm_3]
#   %view_9 : Tensor "bf16[128, 1024, 1024][1048576, 1024, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_3, [128, 1024, 1024]), kwargs = {})
#   %convert_element_type_16 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:4"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_9, torch.float32), kwargs = {})
#   %gt : Tensor "b8[128, 1024, 1024][1048576, 1024, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.gt.Scalar](args = (%convert_element_type_16, 0), kwargs = {})
#   %mul_10 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_16, 0.5), kwargs = {})
#   %where : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt, %convert_element_type_16, %mul_10), kwargs = {})
#   %pow_3 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%where, 2), kwargs = {})
#   %convert_element_type_21 : Tensor "bf16[128, 1024, 1024][1048576, 1024, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%pow_3, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rb/crb6hl4t7iczzns7hdzy3rblesdkpavgahe445q7hhhpjhjjgqtt.py
...
#   %mul_13 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4" = PlaceHolder[target=mul_13]
#   %buf26 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:4" = PlaceHolder[target=buf26]
#   %arg15_1 : Tensor "f32[384][1]cuda:4" = PlaceHolder[target=arg15_1]
#   %buf46 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:4" = PlaceHolder[target=buf46]
#   %arg21_1 : Tensor "f32[384][1]cuda:4" = PlaceHolder[target=arg21_1]
#   %mul_17 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4" = PlaceHolder[target=mul_17]
#   %select : Tensor "f32[384][1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg0_1, 0, 0), kwargs = {})
#   %unsqueeze : Tensor "f32[1, 384][384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select, 0), kwargs = {})
#   %unsqueeze_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze, 1), kwargs = {})
#   %mul : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %arg1_1), kwargs = {})
...
#   %add_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_3, %mul_12), kwargs = {})
...
#   %mul_14 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_12, %arg2_1), kwargs = {})
#   %add_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_13, %mul_14), kwargs = {})
...
#   %rsqrt_2 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_6,), kwargs = {})
#   %mul_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_5, %rsqrt_2), kwargs = {})
#   %mul_16 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %arg15_1), kwargs = {})
...
#   %pow_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_5, 2), kwargs = {})
#   %mean_3 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_5, [2], True), kwargs = {})
#   %add_7 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_3, 1e-06), kwargs = {})
#   %rsqrt_3 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_7,), kwargs = {})
#   %mul_20 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_5, %rsqrt_3), kwargs = {})
#   %mul_21 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_20, %arg21_1), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/di/cdiapiapu3rkotusa3gyk3pk55zw7x3djq2t4j5rrgpmxsdmflfp.py
...
#   %buf52 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:4" = PlaceHolder[target=buf52]
#   %arg25_1 : Tensor "f32[384][1]cuda:4" = PlaceHolder[target=arg25_1]
#   %buf66 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:4" = PlaceHolder[target=buf66]
...
#   %add_9 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_8, %mul_25), kwargs = {})
...
#   %mul_27 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_21, %arg2_1), kwargs = {})
#   %add_10 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_26, %mul_27), kwargs = {})
...
#   %rsqrt_4 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_11,), kwargs = {})
#   %mul_28 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %rsqrt_4), kwargs = {})
#   %mul_29 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %arg25_1), kwargs = {})
...
#   %pow_8 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_10, 2), kwargs = {})
#   %mean_5 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_8, [2], True), kwargs = {})
#   %add_12 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_5, 1e-06), kwargs = {})
#   %rsqrt_5 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_12,), kwargs = {})
#   %mul_33 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %rsqrt_5), kwargs = {})
#   %mul_34 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_33, %arg31_1), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'out_ptr0': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=4, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/jz/cjzvixpbov5azwidqj7acg2ahgqlcdrpg5gimlwief46rkbywpyv.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(4):
            ...
            triton_red_fused__fused_rms_norm__to_copy_add_mul_select_unsqueeze_0.run(arg0_1, arg1_1, arg2_1, arg3_1, arg11_1, buf1, buf21, buf2, 131072, 384, stream=stream4)
            del arg11_1
            del arg3_1
            ...
            stream4 = get_raw_stream(4)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf3, (128, 1024, 24, 48), (1179648, 1152, 48, 1), 0), buf4, buf5, reinterpret_tensor(arg5_1, (1024, 24), (24, 1), 0), reinterpret_tensor(arg6_1, (1024, 24), (24, 1), 0), 2097152, 1, 1, stream=stream4)
            buf8 = empty_strided_cuda((128, 8, 1024, 48), (393216, 48, 384, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear, view, scaled_dot_product_attention, getitem_4, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            stream4 = get_raw_stream(4)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_1.run(buf3, buf8, 50331648, stream=stream4)
            del buf3
            # Topologically Sorted Source Nodes: [linear, view, scaled_dot_product_attention, getitem_4, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [getitem_7, contiguous_6, linear_1], Original ATen: [aten.slice, aten.clone, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_clone_slice_2.run(buf1, buf15, 1572864, stream=stream4)
            buf16 = empty_strided_cuda((8, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_3.run(arg7_1, buf16, 96, stream=stream4)
            del arg7_1
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_1, mul_3, sigmoid, getitem_8, mul_4], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream4 = get_raw_stream(4)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_4.run(buf18, buf17, 50331648, stream=stream4)
            del buf17
            ...
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_5.run(buf23, 134217728, stream=stream4)
            ...
            # Topologically Sorted Source Nodes: [getitem, getitem_1, mul, getitem_2, getitem_3, mul_1, add, getitem_11, getitem_12, getitem_9, linear_2, mul_6, add_1, getitem_10, linear_4, mul_7, add_2, mul_8, getitem_13, getitem_14, mul_9, add_3, rms_norm_2, mul_10, linear_5, rms_norm_3, mul_13, linear_8], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_red_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_6.run(arg14_1, arg0_1, arg1_1, arg2_1, arg9_1, buf19, arg10_1, buf24, arg15_1, arg21_1, buf25, buf27, buf47, buf28, 131072, 384, stream=stream4)
            del arg0_1
            del arg10_1
            del arg15_1
            del arg1_1
            ...
            stream4 = get_raw_stream(4)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf29, (128, 1024, 24, 48), (1179648, 1152, 48, 1), 0), buf30, buf31, reinterpret_tensor(arg5_1, (1024, 24), (24, 1), 0), reinterpret_tensor(arg6_1, (1024, 24), (24, 1), 0), 2097152, 1, 1, stream=stream4)
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_1.run(buf29, buf34, 50331648, stream=stream4)
            del buf29
            # Topologically Sorted Source Nodes: [linear_5, view_1, scaled_dot_product_attention_1, getitem_15, contiguous_8, transpose_6], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_clone_slice_2.run(buf27, buf41, 1572864, stream=stream4)
            del buf27
            buf42 = empty_strided_cuda((8, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_6], Original ATen: [aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_3.run(arg17_1, buf42, 96, stream=stream4)
            del arg17_1
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_4.run(buf44, buf43, 50331648, stream=stream4)
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_5.run(buf49, 134217728, stream=stream4)
            ...
            # Topologically Sorted Source Nodes: [getitem_13, getitem_14, mul_9, add_3, getitem_22, getitem_23, getitem_20, linear_7, mul_14, add_4, getitem_21, linear_9, mul_15, add_5, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_7.run(buf51, arg24_1, arg14_1, arg2_1, arg19_1, buf45, arg20_1, buf50, arg25_1, arg31_1, buf52, buf53, buf67, 131072, 384, stream=stream4)
            del arg14_1
            del arg19_1
            del arg20_1
            del arg24_1
            ...
            stream4 = get_raw_stream(4)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf54, (128, 1024, 24, 48), (1179648, 1152, 48, 1), 0), buf55, buf56, reinterpret_tensor(arg5_1, (1024, 24), (24, 1), 0), reinterpret_tensor(arg6_1, (1024, 24), (24, 1), 0), 2097152, 1, 1, stream=stream4)
            del arg5_1
            del arg6_1
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_1.run(buf54, buf59, 50331648, stream=stream4)
            del buf54
            # Topologically Sorted Source Nodes: [linear_10, view_2, scaled_dot_product_attention_2, getitem_26, contiguous_16, transpose_10], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [rms_norm_4, mul_18, getitem_29, contiguous_22, linear_11], Original ATen: [aten._fused_rms_norm, aten.mul, aten.slice, aten.clone, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__fused_rms_norm__to_copy_clone_mul_slice_8.run(buf51, buf52, arg25_1, buf68, 131072, 12, stream=stream4)
            del arg25_1
            del buf52
            buf69 = buf42; del buf42  # reuse
            # Topologically Sorted Source Nodes: [linear_11], Original ATen: [aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_3.run(arg27_1, buf69, 96, stream=stream4)
            del arg27_1
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_4.run(buf71, buf70, 50331648, stream=stream4)
            del buf70
...
def get_args():
    ...
    arg1_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:4', dtype=torch.float32)
    arg2_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:4', dtype=torch.bfloat16)
    ...
    arg5_1 = rand_strided((1, 1024, 1, 24), (24576, 24, 24, 1), device='cuda:4', dtype=torch.bfloat16)
    arg6_1 = rand_strided((1, 1024, 1, 24), (24576, 24, 24, 1), device='cuda:4', dtype=torch.bfloat16)
    ...
    arg12_1 = rand_strided((1024, 384), (384, 1), device='cuda:4', dtype=torch.bfloat16)
    arg13_1 = rand_strided((384, 1024), (1024, 1), device='cuda:4', dtype=torch.bfloat16)
    ...
    arg22_1 = rand_strided((1024, 384), (384, 1), device='cuda:4', dtype=torch.bfloat16)
    arg23_1 = rand_strided((384, 1024), (1024, 1), device='cuda:4', dtype=torch.bfloat16)
