...
_tensor_constant0 = None  # device(type='cuda', index=2) torch.int64 (12,) (1,) 7b42fa4ae080
_tensor_constant1 = None  # device(type='cuda', index=2) torch.int64 (12,) (1,) 7b42fa4bf5c0
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pt/cptixx2cjhgnyq7ivcfbzj362bygh2buxkfu5vu736cblxnd4dms.py
...
#   %remainder : Tensor "i64[128, 1023, 12][12276, 12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 32767), kwargs = {})
