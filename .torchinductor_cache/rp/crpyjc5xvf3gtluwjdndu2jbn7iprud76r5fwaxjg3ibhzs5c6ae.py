...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gq/cgqezvsdxqek5gzyyp3xmao3pe3dwfy2ds4i7wwjv5cw2ursyjyp.py
...
# Graph fragment:
#   %permute_17 : Tensor "bf16[8, 12][12, 1]cuda:5" = PlaceHolder[target=permute_17]
#   %constant_pad_nd_default : Tensor "bf16[8, 16][16, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%permute_17, [0, 4, 0, 0]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2c/c2cgoinoycau5hs5jji5drnenoddu5euvanjexjyd2tks3qgd6au.py
...
# Graph fragment:
#   %mm_6 : Tensor "bf16[8, 12][12, 1]cuda:5" = PlaceHolder[target=mm_6]
#   %convert_element_type_43 : Tensor "f32[8, 12][12, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_6, torch.float32), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2q/c2qcxsbsdupxkfu5r7mf3ofbx3ljgbdeyqfe4jytynwth65acmxq.py
...
#   %mm_default : Tensor "bf16[131072, 16][16, 1]cuda:5" = PlaceHolder[target=mm_default]
...
#   %slice_tensor : Tensor "bf16[131072, 12][16, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_default, 1, 0, -4), kwargs = {})
#   %view_17 : Tensor "bf16[128, 1024, 12][16384, 16, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%slice_tensor, [128, 1024, 12]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/53/c53zjyxkt77rjwghqm5y4oscvcumjwx7r6uwkoj47fcgcl4uei7t.py
...
# Graph fragment:
#   %full_default_5 : Tensor "f32[32768, 128][128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([32768, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:5, pin_memory: False})
#   return %index_put
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/op/copwu7qo2zstnlj2fopuqqzvoqxn4vntfpijvova5xfhq65vnosd.py
...
#   %index_put : Tensor "f32[32768, 128][128, 1]cuda:5" = PlaceHolder[target=index_put]
...
#   %mul_45 : Tensor "f32[128, 1024, 128][131072, 128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_75, 0.5), kwargs = {})
#   %unsqueeze_6 : Tensor "f32[128, 1024, 1, 128][131072, 128, 128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_45, -2), kwargs = {})
#   %expand : Tensor "f32[128, 1024, 4, 128][131072, 128, 0, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze_6, [128, 1024, 4, 128]), kwargs = {})
#   %convert_element_type_default : Tensor "f32[128, 1024, 4, 128][524288, 512, 128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%expand, torch.float32), kwargs = {})
#   %eq : Tensor "b8[128, 1024, 4][4096, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%add_1, -1), kwargs = {})
#   %unsqueeze_7 : Tensor "b8[128, 1024, 4, 1][4096, 4, 1, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%eq, -1), kwargs = {})
#   %full_default_4 : Tensor "f32[][]cuda:5"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:5, pin_memory: False})
#   %where : Tensor "f32[128, 1024, 4, 128][524288, 512, 128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%unsqueeze_7, %full_default_4, %convert_element_type_default), kwargs = {})
#   %full_default_5 : Tensor "f32[32768, 128][128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([32768, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:5, pin_memory: False})
#   %index_put : Tensor "f32[32768, 128][128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_5, [%add_1], %where, True), kwargs = {})
#   return %buf43
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/l6/cl6v2ch7p5rb6rqf3bujjapj3oei756fywwplpb6mvc24cl5xiuc.py
...
# Graph fragment:
#   %buf43 : Tensor "f32[32768, 128][128, 1]cuda:5" = PlaceHolder[target=buf43]
#   %convert_element_type_80 : Tensor "bf16[32768, 128][128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%index_put, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/f4/cf4auxps4ym3ogbifx3wmwppmbg2qkrszefw4fhrmqlfjfkq35hn.py
...
# Graph fragment:
#   %buf46 : Tensor "f32[8192, 384][384, 1]cuda:5" = PlaceHolder[target=buf46]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(5):
            ...
            # Topologically Sorted Source Nodes: [constant_pad_nd_default], Original ATen: [aten.mm]
            stream5 = get_raw_stream(5)
            triton_poi_fused_mm_2.run(permute_17, buf9, 128, stream=stream5)
            del permute_17
            ...
            # Topologically Sorted Source Nodes: [convert_element_type_43], Original ATen: [aten._to_copy]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_3.run(buf8, buf11, 96, stream=stream5)
            del buf8
            ...
            stream5 = get_raw_stream(5)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_mm_slice_backward_view_5.run(buf25, add_3, rsqrt, buf10, buf21, primals_13, tangents_3, workspace_1, 131072, 384, stream=stream5)
            ...
            # Topologically Sorted Source Nodes: [full_default_2, to_6, sigmoid_1, getitem_8, mul_32, to_7, unsqueeze, sub, mul_34, linear, linear_1, sigmoid, to_5, mul_36, slice_13, add_12, mul_40, mul_41, mul_42, convert_element_type_62, convert_element_type_63, sub_5, mul_43, mul_44, convert_element_type_64], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.rsub, aten._unsafe_view, aten.view, aten.slice, aten.add, aten.sigmoid_backward]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy__unsafe_view_add_mul_rsub_sigmoid_sigmoid_backward_slice_slice_backward_unsqueeze_view_6.run(buf25, primals_12, ne, primals_11, mm, addmm, buf34, buf39, 50331648, stream=stream5)
            ...
            # Topologically Sorted Source Nodes: [full_default_7], Original ATen: [aten.embedding_dense_backward]
            stream5 = get_raw_stream(5)
            triton_poi_fused_embedding_dense_backward_7.run(buf45, 3145728, stream=stream5)
            buf32 = empty_strided_cuda((128, 1024, 1), (1024, 1, 131072), torch.float32)
            # Call mix order reduction kernel
            # Topologically Sorted Source Nodes: [full_default_2, to_6, sigmoid_1, getitem_8, mul_32, to_7, unsqueeze, mul_6, mul_33, sum_7, sub, mul_34, linear, linear_1, sigmoid, mul_4, to_5, mul_5, add_2, mul_35, sum_8, mul_36, slice_13, add_12, mul_39, sum_9, view_28, add_13, full_default_4, convert_element_type_81, eq_1, unsqueeze_8, where_1, full_default_7, index_put_1], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.sum, aten.rsub, aten._unsafe_view, aten.view, aten.add, aten.slice, aten.embedding_dense_backward]
            workspace_2 = empty_strided_cuda((1572864, ), (1, ), torch.float32)
            stream5 = get_raw_stream(5)
            triton_per_fused__to_copy__unsafe_view_add_embedding_dense_backward_mul_rsub_sigmoid_slice_slice_backward_sum_unsqueeze_view_8.run(buf25, primals_12, ne, mm, addmm, primals_5, buf35, cat, embedding, primals_11, buf32, buf45, workspace_2, 131072, 384, stream=stream5)
            ...
            # Topologically Sorted Source Nodes: [full_default_5], Original ATen: [aten.embedding_dense_backward]
            stream5 = get_raw_stream(5)
            triton_poi_fused_embedding_dense_backward_13.run(buf42, 4194304, stream=stream5)
            # Topologically Sorted Source Nodes: [view_30, convert_element_type_75, mul_45, unsqueeze_6, expand, convert_element_type_default, eq, unsqueeze_7, full_default_4, where, full_default_5, index_put], Original ATen: [aten.view, aten._to_copy, aten.mul, aten.unsqueeze, aten.expand, aten.embedding_dense_backward]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_embedding_dense_backward_expand_mul_unsqueeze_view_14.run(add_1, buf41, buf42, 524288, 128, stream=stream5)
            del add_1
            del buf41
            buf44 = empty_strided_cuda((32768, 128), (128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [convert_element_type_80], Original ATen: [aten.embedding_dense_backward]
            stream5 = get_raw_stream(5)
            triton_poi_fused_embedding_dense_backward_15.run(buf42, buf44, 4194304, stream=stream5)
            del buf42
            buf47 = empty_strided_cuda((8192, 384), (384, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [convert_element_type_82], Original ATen: [aten.embedding_dense_backward]
            stream5 = get_raw_stream(5)
            triton_poi_fused_embedding_dense_backward_16.run(buf45, buf47, 3145728, stream=stream5)
            del buf45
...
def get_args():
    ...
    add_1 = rand_strided((128, 1024, 4), (4096, 4, 1), device='cuda:5', dtype=torch.int64)
