...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dd/cddlzupjsdorxrnsispi4kc7hdp5h4afoehbpujuyzt2fjoi6cxg.py
...
#   %primals_2 : Tensor "bf16[196608, 128][128, 1]cuda:3" = PlaceHolder[target=primals_2]
...
def get_args():
    ...
    primals_2 = rand_strided((196608, 128), (128, 1), device='cuda:3', dtype=torch.bfloat16)
