...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rd/crdwki3uumgwqrkkdtxhyzfbkzyhva3jbd6sgpaj276as4gdbhz3.py
...
#   %primals_2 : Tensor "bf16[196608, 128][128, 1]cuda:0" = PlaceHolder[target=primals_2]
...
def get_args():
    ...
    primals_2 = rand_strided((196608, 128), (128, 1), device='cuda:0', dtype=torch.bfloat16)
