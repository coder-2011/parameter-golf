...
_tensor_constant0 = None  # device(type='cuda', index=6) torch.int64 (12,) (1,) 7f64e8898e10
_tensor_constant1 = None  # device(type='cuda', index=6) torch.int64 (12,) (1,) 7f64e88dff70
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/af/cafslkbp5zkzdmwbsb7wwei2m4artsmporatm2lax73ws4unp6ww.py
...
#   %remainder : Tensor "i64[128, 1023, 12][12276, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 16383), kwargs = {})
...
#   %mul_2 : Tensor "i64[12][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%iota, 16384), kwargs = {})
