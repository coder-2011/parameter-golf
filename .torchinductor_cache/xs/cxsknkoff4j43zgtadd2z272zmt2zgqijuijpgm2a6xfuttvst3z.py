...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/fw/cfwpxedtgoist2rq23v6lozcmf4bmxann4yuy2jakc5uuatmcp4u.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2v/c2vlx4prb5r54h6vj6eia72k575wi7rb2wlqdl4efhsimzswwhb4.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tu/ctue7k77xjtrtl53b5f6whkr6arubybnz7fwm73dkkfhezzwyx5a.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/q6/cq6t6wn4nlyfzyag5mopch4cllblntowo3f37s5pw7olsnzxaclo.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/nb/cnbh4okgbucklx7len7lpqrx6xdglzre66dw5wjqwf5bgvie5em7.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/be/cbekzu7mx4xjonxccolnb7p7ghadr3cuqxgrskm2w66x63h37gdg.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/5b/c5belkv4mjxua2mvvhhpxvhd3qqjtctv6yhclfcom26la4uqwivy.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tk/ctkdedgybzuagkcjvh54qlmxpxhx6uq3rkj5dtuugqynseuqz2ta.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/oj/cojqspg4bbaw7yamg4hvwqwt6kwhlrdvzmh4grnyxyx5wzuw2exe.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ld/cldmakdpzflyzyzgpv5uy3ezodld6mv4emhnqpsbmx3yglzu2xhw.py
# Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_41, convert_element_type_62, convert_element_type_63, sub_5, mul_43, mul_44, convert_element_type_64, view_26, sum_10], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten.sigmoid_backward, aten.sum]
# Source node to ATen node mapping:
#   convert_element_type_62 => convert_element_type_62
#   convert_element_type_63 => convert_element_type_63
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/mq/cmqddgrnyeecu6q75reodpw26fkz66cgr7igkexqigw7fsydxonc.py
...
# Graph fragment:
#   %full_default_5 : Tensor "f32[57344, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([57344, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   return %index_put
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xa/cxabm267df5btrvr2qwwhukxubmiqgelr4c2qxw644gldmcqkooe.py
...
#   where => where
# Graph fragment:
#   %add_1 : Tensor "i64[128, 1024, 7][7168, 7, 1]cuda:0" = PlaceHolder[target=add_1]
#   %mm_13 : Tensor "bf16[131072, 128][128, 1]cuda:0" = PlaceHolder[target=mm_13]
#   %index_put : Tensor "f32[57344, 128][128, 1]cuda:0" = PlaceHolder[target=index_put]
...
#   %mul_45 : Tensor "f32[128, 1024, 128][131072, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_75, 0.37796447300922725), kwargs = {})
...
#   %expand : Tensor "f32[128, 1024, 7, 128][131072, 128, 0, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze_6, [128, 1024, 7, 128]), kwargs = {})
#   %convert_element_type_default : Tensor "f32[128, 1024, 7, 128][917504, 896, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%expand, torch.float32), kwargs = {})
#   %eq : Tensor "b8[128, 1024, 7][7168, 7, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%add_1, -1), kwargs = {})
#   %unsqueeze_7 : Tensor "b8[128, 1024, 7, 1][7168, 7, 1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%eq, -1), kwargs = {})
#   %full_default_4 : Tensor "f32[][]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %where : Tensor "f32[128, 1024, 7, 128][917504, 896, 128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%unsqueeze_7, %full_default_4, %convert_element_type_default), kwargs = {})
#   %full_default_5 : Tensor "f32[57344, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([57344, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:0, pin_memory: False})
#   %index_put : Tensor "f32[57344, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_5, [%add_1], %where, True), kwargs = {})
#   return %buf43
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/uv/cuvnpjacfzqbg73kuch2zgtf526iw2ilzmvsk24r7eh47gyl7acg.py
...
# Graph fragment:
#   %buf43 : Tensor "f32[57344, 128][128, 1]cuda:0" = PlaceHolder[target=buf43]
#   %convert_element_type_80 : Tensor "bf16[57344, 128][128, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%index_put, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dj/cdj73napdp6udnatfxyzijxismn7l4aug4mtfeuoxpihcmccllks.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [full_default_5], Original ATen: [aten.embedding_dense_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_embedding_dense_backward_13.run(buf42, 7340032, stream=stream0)
            # Topologically Sorted Source Nodes: [view_30, convert_element_type_75, mul_45, unsqueeze_6, expand, convert_element_type_default, eq, unsqueeze_7, full_default_4, where, full_default_5, index_put], Original ATen: [aten.view, aten._to_copy, aten.mul, aten.unsqueeze, aten.expand, aten.embedding_dense_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_embedding_dense_backward_expand_mul_unsqueeze_view_14.run(add_1, buf41, buf42, 917504, 128, stream=stream0)
            del add_1
            del buf41
            buf44 = empty_strided_cuda((57344, 128), (128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [convert_element_type_80], Original ATen: [aten.embedding_dense_backward]
            stream0 = get_raw_stream(0)
            triton_poi_fused_embedding_dense_backward_15.run(buf42, buf44, 7340032, stream=stream0)
            del buf42
...
def get_args():
    ...
    add_1 = rand_strided((128, 1024, 7), (7168, 7, 1), device='cuda:0', dtype=torch.int64)
