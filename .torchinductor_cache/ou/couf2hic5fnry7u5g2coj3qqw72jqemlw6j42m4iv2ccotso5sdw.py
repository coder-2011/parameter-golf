...
#   %convert_element_type_22 : Tensor "bf16[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_16, torch.bfloat16), kwargs = {})
...
#   %mul_12 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_25, %convert_element_type_27), kwargs = {})
#   %convert_element_type_23 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_3, torch.float32), kwargs = {})
#   %mul_10 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_23, %rsqrt_1), kwargs = {})
#   %mul_14 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_10, %mul_12), kwargs = {})
#   %sum_2 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_14, [2], True), kwargs = {})
#   %div : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_10, 384), kwargs = {})
#   %mul_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %sum_2), kwargs = {})
#   %sub_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_12, %mul_15), kwargs = {})
#   %mul_16 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_1, %rsqrt_1), kwargs = {})
#   %mul_17 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_25, %mul_10), kwargs = {})
#   %sum_3 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_17, [0, 1]), kwargs = {})
#   %convert_element_type_28 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_16, torch.bfloat16), kwargs = {})
#   %add_5 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%tangents_2, %convert_element_type_28), kwargs = {})
#   return %sum_2,%add_5
...
#   %mul_18 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_15, %permute_8), kwargs = {})
...
#   %mul_8 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_8, 0.5), kwargs = {})
#   %sigmoid_2 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_8,), kwargs = {})
#   %unsqueeze_3 : Tensor "bf16[128, 1024, 8, 1][8192, 8, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sigmoid_2, 3), kwargs = {})
#   %mul_19 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_15, %unsqueeze_3), kwargs = {})
#   %sum_4 : Tensor "f32[128, 1024, 8, 1][8192, 8, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_18, [3], True), kwargs = {dtype: torch.float32})
...
#   %mul_20 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_37, %sub_2), kwargs = {})
#   %mul_21 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_36, %mul_20), kwargs = {})
#   %convert_element_type_38 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_21, torch.bfloat16), kwargs = {})
#   %mul_22 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_38, 0.5), kwargs = {})
#   %permute_19 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%mul_19, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/va/cvaipzalwxkbwxn7yevt5qeblkqywgk5n6xrwck5su6rfl2yu6ma.py
...
#   %slice_5 : Tensor "bf16[128, 1024, 4, 48][786432, 768, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%empty_2, 2, 12, 9223372036854775807), kwargs = {})
#   %copy : Tensor "bf16[128, 1024, 4, 48][786432, 768, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_5, %permute_20), kwargs = {})
#   %slice_scatter_default_1 : Tensor "bf16[128, 1024, 16, 48][786432, 768, 48, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%empty_2, %copy, 2, 12, 9223372036854775807), kwargs = {})
...
#   view_25 => view_25
# Graph fragment:
#   %add_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_1]
...
#   %add_6 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%tangents_3, %add_5), kwargs = {})
...
#   %full_default_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %slice_scatter_default : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default_1, %view_17, 2, 0, 12), kwargs = {})
...
#   %add_7 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %view_25), kwargs = {})
#   %convert_element_type_48 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_7, torch.float32), kwargs = {})
#   %convert_element_type_12 : Tensor "bf16[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_10, torch.bfloat16), kwargs = {})
...
#   %mul_23 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_48, %convert_element_type_50), kwargs = {})
#   %convert_element_type_13 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.float32), kwargs = {})
#   %mul_6 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_13, %rsqrt), kwargs = {})
#   %mul_25 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_6, %mul_23), kwargs = {})
#   %sum_5 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_25, [2], True), kwargs = {})
#   %div_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_6, 384), kwargs = {})
#   %mul_26 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_1, %sum_5), kwargs = {})
#   %sub_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_23, %mul_26), kwargs = {})
#   %mul_27 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_3, %rsqrt), kwargs = {})
#   %mul_28 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_48, %mul_6), kwargs = {})
#   %sum_6 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_28, [0, 1]), kwargs = {})
#   %convert_element_type_51 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_27, torch.bfloat16), kwargs = {})
#   %add_8 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_6, %convert_element_type_51), kwargs = {})
#   return %sum_5,%add_8
...
# Graph fragment:
#   %add_8 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_8]
#   %primals_8 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_8]
#   %ne : Tensor "b8[128, 1024][1024, 1]cuda:6" = PlaceHolder[target=ne]
#   %primals_7 : Tensor "f32[][]cuda:6" = PlaceHolder[target=primals_7]
#   %mul_37 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=mul_37]
...
#   %full_default_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %convert_element_type_10 : Tensor "bf16[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_8, torch.bfloat16), kwargs = {})
...
#   %unsqueeze : Tensor "bf16[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sigmoid_1, 0), kwargs = {})
#   %unsqueeze_1 : Tensor "bf16[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze, 1), kwargs = {})
#   %mul_29 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, %unsqueeze_1), kwargs = {})
...
#   %unsqueeze_2 : Tensor "bf16[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%convert_element_type_11, -1), kwargs = {})
#   %sub : Tensor "bf16[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (1, %unsqueeze_1), kwargs = {})
#   %mul_31 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, %sub), kwargs = {})
...
#   %convert_element_type_9 : Tensor "bf16[][]cuda:6"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_7, torch.bfloat16), kwargs = {})
#   %mul_33 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_29, %unsqueeze_2), kwargs = {})
#   %slice_8 : Tensor "bf16[128, 1023, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mul_33, 1, 1, 1024), kwargs = {})
#   %slice_scatter_default_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default_1, %slice_8, 1, 0, -1), kwargs = {})
#   %add_10 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_31, %slice_scatter_default_2), kwargs = {})
#   %mul_37 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %convert_element_type_9), kwargs = {})
#   %mul_38 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_37, %view_1), kwargs = {})
#   %mul_39 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_37, %sigmoid), kwargs = {})
#   %convert_element_type_62 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_38, torch.float32), kwargs = {})
...
#   %mul_40 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_63, %sub_5), kwargs = {})
#   %mul_41 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_62, %mul_40), kwargs = {})
#   %convert_element_type_64 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_41, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/fp/cfpuwshcsnfyhk6ptbfvb6hf3adptr6z46xbphz7hfzjwza4of4u.py
...
#   %primals_6 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=primals_6]
#   %primals_7 : Tensor "f32[][]cuda:6" = PlaceHolder[target=primals_7]
#   %full_default_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %convert_element_type_10 : Tensor "bf16[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_8, torch.bfloat16), kwargs = {})
#   %sigmoid_1 : Tensor "bf16[384][1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.sigmoid.default](args = (%convert_element_type_10,), kwargs = {})
...
#   %convert_element_type_11 : Tensor "bf16[128, 1024][1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%ne, torch.bfloat16), kwargs = {})
#   %unsqueeze_2 : Tensor "bf16[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%convert_element_type_11, -1), kwargs = {})
#   %mul_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%cat, %unsqueeze_2), kwargs = {})
#   %mul_30 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, %mul_3), kwargs = {})
#   %sum_7 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_30, [0, 1], True), kwargs = {dtype: torch.float32})
#   %sub : Tensor "bf16[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (1, %unsqueeze_1), kwargs = {})
#   %mul_31 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, %sub), kwargs = {})
#   %view_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%mm, [128, 1024, 384]), kwargs = {})
#   %view_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%addmm, [128, 1024, 384]), kwargs = {})
#   %sigmoid : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_3,), kwargs = {})
#   %mul_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_1, %sigmoid), kwargs = {})
#   %convert_element_type_9 : Tensor "bf16[][]cuda:6"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_7, torch.bfloat16), kwargs = {})
#   %mul_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_1, %convert_element_type_9), kwargs = {})
#   %add : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%primals_6, %mul_2), kwargs = {})
#   %mul_32 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_8, %add), kwargs = {})
#   %sum_8 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_32, [0, 1], True), kwargs = {dtype: torch.float32})
#   %mul_33 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_29, %unsqueeze_2), kwargs = {})
#   %slice_8 : Tensor "bf16[128, 1023, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mul_33, 1, 1, 1024), kwargs = {})
#   %slice_scatter_default_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default_1, %slice_8, 1, 0, -1), kwargs = {})
#   %add_10 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_31, %slice_scatter_default_2), kwargs = {})
#   %mul_36 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %mul_1), kwargs = {})
#   %sum_9 : Tensor "f32[][]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.default](args = (%mul_36,), kwargs = {dtype: torch.float32})
...
#   %add_11 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_10, %view_28), kwargs = {})
#   return %buf32,%add_11
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/st/cstadz2w4cmdkvf6fyolcxcko37kiurswzw7k32behbb4cg2jryu.py
...
#   %add_9 : Tensor "bf16[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_54, %neg), kwargs = {})
#   %squeeze_1 : Tensor "bf16[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%add_9, 1), kwargs = {})
...
#   %mul_34 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_57, %sub_4), kwargs = {})
#   %mul_35 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_56, %mul_34), kwargs = {})
#   return %mul_35
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dx/cdxknd3r3cl45z7ijh5sfih6oczslzwoqyjz2frld7argeldr44x.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/vu/cvuz76smt2bcuvlbam3qxpxulx2qlkt2337na6wgsy52ijxlqco5.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/uh/cuh3licmgziskgoyhmudzuwxiizocsd5xw2gr5g2nybxvpr7x3kk.py
# Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_38, convert_element_type_62, convert_element_type_63, sub_5, mul_40, mul_41, convert_element_type_64, view_26, sum_10], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten.sigmoid_backward, aten.sum]
# Source node to ATen node mapping:
#   convert_element_type_62 => convert_element_type_62
#   convert_element_type_63 => convert_element_type_63
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/fm/cfmjppazyxiiu355kdg6j43gbvegd7erhshp2cd5rt7fl5l2zsro.py
...
# Graph fragment:
#   %full_default_4 : Tensor "f32[393216, 128][128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([393216, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:6, pin_memory: False})
#   return %index_put
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ok/cokjj27quob2xblkxnxipw4h66cg7lvyf7vi24jws42542l4genb.py
...
#   where => where
# Graph fragment:
#   %primals_1 : Tensor "i64[128, 1024, 12][12288, 12, 1]cuda:6" = PlaceHolder[target=primals_1]
#   %mm_13 : Tensor "bf16[131072, 128][128, 1]cuda:6" = PlaceHolder[target=mm_13]
#   %index_put : Tensor "f32[393216, 128][128, 1]cuda:6" = PlaceHolder[target=index_put]
...
#   %mul_42 : Tensor "f32[128, 1024, 128][131072, 128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_75, 0.28867513459481287), kwargs = {})
#   %unsqueeze_4 : Tensor "f32[128, 1024, 1, 128][131072, 128, 128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_42, -2), kwargs = {})
#   %expand : Tensor "f32[128, 1024, 12, 128][131072, 128, 0, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze_4, [128, 1024, 12, 128]), kwargs = {})
#   %convert_element_type_default : Tensor "f32[128, 1024, 12, 128][1572864, 1536, 128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%expand, torch.float32), kwargs = {})
#   %eq : Tensor "b8[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%primals_1, -1), kwargs = {})
#   %unsqueeze_5 : Tensor "b8[128, 1024, 12, 1][12288, 12, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%eq, -1), kwargs = {})
#   %full_default_3 : Tensor "f32[][]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %where : Tensor "f32[128, 1024, 12, 128][1572864, 1536, 128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%unsqueeze_5, %full_default_3, %convert_element_type_default), kwargs = {})
#   %full_default_4 : Tensor "f32[393216, 128][128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([393216, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %index_put : Tensor "f32[393216, 128][128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_4, [%primals_1], %where, True), kwargs = {})
#   return %buf44
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sg/csgzjycjfix7yxauf43qut545mjilddh6eb34he6yk3gzaza7cu3.py
...
# Graph fragment:
#   %buf44 : Tensor "f32[393216, 128][128, 1]cuda:6" = PlaceHolder[target=buf44]
#   %convert_element_type_80 : Tensor "bf16[393216, 128][128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%index_put, torch.bfloat16), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(6):
            ...
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_0.run(add_3, rsqrt_1, tangents_1, primals_16, tangents_2, buf3, workspace_0, 131072, 384, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [permute_20, permute_21, permute_22, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused_copy_slice_transpose_4.run(buf16, buf18, 100663296, stream=stream6)
            del buf16
            # Topologically Sorted Source Nodes: [permute_20, permute_21, permute_22, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_bwd_kernel_0.run(reinterpret_tensor(buf14, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf15, (128, 1024, 4, 48), (196608, 192, 48, 1), 0), view_6, buf18, select_1, select_3, 1572864, 1, 1, stream=stream6)
            del buf15
            del select_1
            del select_3
            del view_6
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_slice_backward_view_5.run(buf25, add_1, rsqrt, buf10, buf21, primals_10, tangents_3, workspace_1, 131072, 384, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [full_default_1, to_5, sigmoid_1, getitem, mul_29, to_6, unsqueeze, sub, mul_31, linear, linear_1, sigmoid, to_4, mul_33, slice_8, add_10, mul_37, mul_38, mul_39, convert_element_type_62, convert_element_type_63, sub_5, mul_40, mul_41, convert_element_type_64], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.rsub, aten._unsafe_view, aten.view, aten.slice, aten.add, aten.sigmoid_backward]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy__unsafe_view_add_mul_rsub_sigmoid_sigmoid_backward_slice_slice_backward_unsqueeze_view_6.run(buf25, primals_8, ne, primals_7, mm, addmm, buf34, buf40, 50331648, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__to_copy__unsafe_view_add_mul_rsub_sigmoid_slice_slice_backward_sum_unsqueeze_view_7.run(buf39, buf25, primals_8, ne, mm, addmm, cat, primals_6, primals_7, buf32, workspace_2, 131072, 384, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [to_5, sigmoid_1, convert_element_type_54, convert_element_type_55, neg, add_9, squeeze_1, squeeze_2, convert_element_type_56, convert_element_type_57, sub_4, mul_34, mul_35], Original ATen: [aten._to_copy, aten.sigmoid, aten.neg, aten.add, aten.squeeze, aten.sigmoid_backward]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_add_neg_sigmoid_sigmoid_backward_squeeze_8.run(buf30, buf29, primals_8, 384, stream=stream6)
            del primals_8
            buf33 = empty_strided_cuda((), (), torch.float32)
            # Topologically Sorted Source Nodes: [full_default_1, to_5, sigmoid_1, getitem, mul_29, to_6, unsqueeze, sub, mul_31, linear, linear_1, sigmoid, mul_1, mul_33, slice_8, add_10, mul_36, sum_9], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.rsub, aten._unsafe_view, aten.view, aten.slice, aten.add, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused__to_copy__unsafe_view_add_mul_rsub_sigmoid_slice_slice_backward_sum_unsqueeze_view_9.run(buf32, buf33, 1, 131072, stream=stream6)
            del buf32
            ...
            # Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_38, convert_element_type_62, convert_element_type_63, sub_5, mul_40, mul_41, convert_element_type_64, view_26, sum_10], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten.sigmoid_backward, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused__unsafe_view_mul_sigmoid_sigmoid_backward_sum_view_10.run(buf34, buf37, 134016, 376, stream=stream6)
            del buf34
            buf38 = reinterpret_tensor(buf29, (1, 384), (384, 1), 0); del buf29  # reuse
            # Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_38, convert_element_type_62, convert_element_type_63, sub_5, mul_40, mul_41, convert_element_type_64, view_26, sum_10], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten.sigmoid_backward, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused__unsafe_view_mul_sigmoid_sigmoid_backward_sum_view_11.run(buf37, buf38, 384, 349, stream=stream6)
            del buf37
            ...
            # Topologically Sorted Source Nodes: [full_default_4], Original ATen: [aten.embedding_dense_backward]
            stream6 = get_raw_stream(6)
            triton_poi_fused_embedding_dense_backward_12.run(buf43, 50331648, stream=stream6)
            # Topologically Sorted Source Nodes: [view_30, convert_element_type_75, mul_42, unsqueeze_4, expand, convert_element_type_default, eq, unsqueeze_5, full_default_3, where, full_default_4, index_put], Original ATen: [aten.view, aten._to_copy, aten.mul, aten.unsqueeze, aten.expand, aten.embedding_dense_backward]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_embedding_dense_backward_expand_mul_unsqueeze_view_13.run(primals_1, buf42, buf43, 1572864, 128, stream=stream6)
            del buf42
            del primals_1
            buf45 = reinterpret_tensor(buf40, (393216, 128), (128, 1), 0); del buf40  # reuse
            # Topologically Sorted Source Nodes: [convert_element_type_80], Original ATen: [aten.embedding_dense_backward]
            stream6 = get_raw_stream(6)
            triton_poi_fused_embedding_dense_backward_14.run(buf43, buf45, 50331648, stream=stream6)
            del buf43
...
def get_args():
    ...
    primals_1 = rand_strided((128, 1024, 12), (12288, 12, 1), device='cuda:6', dtype=torch.int64)
    primals_5 = rand_strided((384, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_6 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_7 = rand_strided((), (), device='cuda:6', dtype=torch.float32)
    primals_8 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_10 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_11 = rand_strided((768, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_15 = rand_strided((384, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
