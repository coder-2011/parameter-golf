...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ue/cuegx5q6dd36rb43hfdre6bhwkoajdc55hsf3cnwktntqn3qbuev.py
...
#   %convert_element_type_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:7"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg1_1, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/h4/ch42ru66ebhwm5x4rmhdoq6vwoshee62k6b4wihofmtu6w6stsex.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ly/cly3eiq66r5nhtvsegmwvo2764oor5hifzmcrlo2gzpnetl4shss.py
...
#   mul_22 => mul_2
# Graph fragment:
#   %arg5_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:7" = PlaceHolder[target=arg5_1]
#   %arg3_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:7" = PlaceHolder[target=arg3_1]
#   %arg4_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:7" = PlaceHolder[target=arg4_1]
#   %arg6_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:7" = PlaceHolder[target=arg6_1]
#   %mm_1 : Tensor "bf16[131072, 384][384, 1]cuda:7" = PlaceHolder[target=mm_1]
#   %mul_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:7"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg3_1, %arg4_1), kwargs = {})
#   %add : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:7"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg5_1, %mul_1), kwargs = {})
...
#   %mul_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:7"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg6_1, %view_3), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(7):
            ...
            triton_poi_fused__to_copy_0.run(arg1_1, buf0, 50331648, stream=stream7)
            del arg1_1
            ...
            # Topologically Sorted Source Nodes: [linear, leaky_relu, square, linear_1], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream7 = get_raw_stream(7)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_1.run(buf2, 134217728, stream=stream7)
            ...
            # Topologically Sorted Source Nodes: [mul, add, linear_1, mul_22, add_1], Original ATen: [aten.mul, aten.add, aten._unsafe_view]
            stream7 = get_raw_stream(7)
            triton_poi_fused__unsafe_view_add_mul_2.run(arg5_1, arg3_1, arg4_1, arg6_1, buf3, buf4, 50331648, stream=stream7)
            del arg3_1
            del arg4_1
            del arg5_1
            del arg6_1
...
def get_args():
    ...
    arg0_1 = rand_strided((1024, 384), (384, 1), device='cuda:7', dtype=torch.bfloat16)
    arg1_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:7', dtype=torch.float32)
    arg2_1 = rand_strided((384, 1024), (1024, 1), device='cuda:7', dtype=torch.bfloat16)
    arg3_1 = rand_strided((1, 1, 384), (384, 384, 1), device='cuda:7', dtype=torch.float32)
    arg4_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:7', dtype=torch.bfloat16)
    arg5_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:7', dtype=torch.float32)
    arg6_1 = rand_strided((1, 1, 384), (384, 384, 1), device='cuda:7', dtype=torch.float32)
