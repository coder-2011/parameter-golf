...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/6h/c6hzzirmvqyshjhxd4xdltfpx2qerpf4npabj4bgn6mn47umbbms.py
...
#   %add : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_1, %arg3_1), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            _leaky_relu_sq_matmul_kernel_0.run(reinterpret_tensor(arg1_1, (512000, 384), (384, 1), 0), arg2_1, buf0, buf1, 96000, 1, 1, stream=stream0)
            del arg1_1
            del arg2_1
            del buf0
            ...
            # Topologically Sorted Source Nodes: [reshape_1, add], Original ATen: [aten.view, aten.add]
            stream0 = get_raw_stream(0)
            triton_poi_fused_add_view_0.run(buf5, arg3_1, 196608000, stream=stream0)
            del arg3_1
        return (buf5, )
...
def get_args():
    ...
    arg1_1 = rand_strided((512, 1000, 384), (384000, 384, 1), device='cuda:0', dtype=torch.bfloat16)
