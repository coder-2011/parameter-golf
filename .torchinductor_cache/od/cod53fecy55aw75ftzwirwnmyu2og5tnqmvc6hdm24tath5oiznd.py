...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/jc/cjcrjmvvm4vpk4w7qgzt6r6mnzyd5fadmjsu3bc4nyitvsoelutz.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qp/cqpz2kbyt5z2bxfzd5k6gs7fhj4yivzmyvexnda6covdhdrdqmw6.py
...
#   %convert_element_type_default_17 : Tensor "bf16[1152, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_5, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[384, 1152][1, 384]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_17, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wf/cwf6insskxaqzptr5ajm5vjgjizuoaytqs7mk5w7qieimltsid3f.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/zw/czwrqgu6kgovwptrd4rexhojhqrf7cdgieqydpx4qondxjaobpkp.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/jx/cjxn5ozsuyzwis7o7splcn3yfcxp7fnd5jceyxemej3slw3llubp.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wp/cwpo255s7rdi6a4loh2pgs2e6motqossyqhp5gkt7t4gunm4scu7.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rk/crkas2xmhgcbnbmzhzg2io424i2r42alxorkokcmdoj4bhicrmee.py
...
# Graph fragment:
#   %primals_13 : Tensor "bf16[1024, 384][384, 1]cuda:6" = PlaceHolder[target=primals_13]
#   %convert_element_type_default_16 : Tensor "bf16[1024, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_13, torch.bfloat16), kwargs = {})
#   %permute_9 : Tensor "bf16[384, 1024][1, 384]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_16, [1, 0]), kwargs = {})
#   return %permute_9
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2m/c2mgyxnct3w6bwgo7ua5m5n7abw4zrjnx3ju2zt7ncv6lfsaljtf.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/zj/czjeyjjcvvyqnu5hk7fs5do3kw6rwhzy2rjfepvi7o3lntcfgrgq.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pj/cpjz3g6vd325zpsabfamqr7davmnyfhcftoifo246dmu3ayd2kve.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tu/ctuj5sejmv2mdbhhsc7fgpbtceifz2fmrtyrz7w4hfw45tc7frtd.py
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ds/cdsln6p6fiobj3xd3kqfmspgvkd24y53eqpixux5zyu53exl7xn5.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(6):
            ...
            # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_t_6.run(primals_13, buf22, 393216, stream=stream6)
            del primals_13
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_t_6.run(primals_14, buf25, 393216, stream=stream6)
            del primals_14
            buf26 = empty_strided_cuda((128, 1024, 1024), (1048576, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf24, buf26, 134217728, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_t_6.run(primals_23, buf51, 393216, stream=stream6)
            del primals_23
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_t_6.run(primals_24, buf54, 393216, stream=stream6)
            del primals_24
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf53, buf55, 134217728, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, linear_7, getitem_20, getitem_21, linear_9, mul_14, add_4, mul_15, add_5, getitem_22, getitem_23, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_10.run(buf60, primals_15, buf28, primals_3, primals_20, buf50, primals_21, buf56, primals_25, primals_26, primals_32, buf57, buf58, buf62, buf80, 131072, 384, stream=stream6)
...
def get_args():
    ...
    primals_13 = rand_strided((1024, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_14 = rand_strided((384, 1024), (1024, 1), device='cuda:6', dtype=torch.bfloat16)
    ...
    primals_23 = rand_strided((1024, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_24 = rand_strided((384, 1024), (1024, 1), device='cuda:6', dtype=torch.bfloat16)
