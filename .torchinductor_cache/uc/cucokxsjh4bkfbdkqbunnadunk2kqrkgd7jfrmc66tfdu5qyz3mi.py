...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/mf/cmfnp4xo7m35byggcyoehfb2kl574u3osup56zflp4btjzloaccd.py
...
#   %primals_2 : Tensor "bf16[393216, 128][128, 1]cuda:2" = PlaceHolder[target=primals_2]
...
def get_args():
    ...
    primals_2 = rand_strided((393216, 128), (128, 1), device='cuda:2', dtype=torch.bfloat16)
