...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gs/cgsyea2ukew7nz2hux3zkqnmregiauk47h765fkkhvsjuhgs3gfy.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/34/c346u5qgmddogfjimehzt4ozwd7e2kzcrw677gic2sjcpivco7oe.py
...
#   %convert_element_type_default_21 : Tensor "bf16[1152, 384][384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_5, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[384, 1152][1, 384]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_21, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/kf/ckfjjhopy3o2p75sef7enz7fzx7clfabbahu53a4pmhwanqefmvw.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/j5/cj5v7cuec23etjfqbjqh3j2b5kx6g3mz3yndeoa37tbbky3u5rt2.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/it/cita3hofhbhoq6aan23dikff6tsbmufsn57ot2xqpgaefjhkj2w5.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/bq/cbq2p4zq2xneg7m6uiep2rkdthtaqsye3kjnbsujfx6j4m33byzn.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/fe/cfe2qyqbc3pxathquzw5zyhbm7kcfd7ot26pbs55zowmrzut2fe3.py
...
# Graph fragment:
#   %primals_13 : Tensor "bf16[1536, 384][384, 1]cuda:0" = PlaceHolder[target=primals_13]
#   %convert_element_type_default_20 : Tensor "bf16[1536, 384][384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_13, torch.bfloat16), kwargs = {})
#   %permute_9 : Tensor "bf16[384, 1536][1, 384]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_20, [1, 0]), kwargs = {})
#   return %permute_9
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/du/cdufy2jqvdhnftttlzzpfvussynai6jbwuw2cftuperxw5pwu2uk.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xw/cxw2lbf3726scjeiouifnwcmbgxy2hjrua3w242722n6tpcasyyz.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/7h/c7hgtqgdmw7ucko77xm4uzfx3kf5ecrhw4uoe2opyf2nac4lqfgm.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pb/cpbfvrirhg5rquycw75kdfue2dsj6aa74mvj7b4qqx3qltk7neuo.py
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*bf16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=0, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rs/crsdbadft2qbgpmfahk27jxi2s4zl5dz5dlxxy2o323patzk7lb2.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sj/csjbzyd34xgqdczdqqevxra34qzl33bujcr477uoe3ls72qc5abc.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_t_6.run(primals_13, buf22, 589824, stream=stream0)
            del primals_13
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_t_6.run(primals_14, buf25, 589824, stream=stream0)
            del primals_14
            buf26 = empty_strided_cuda((128, 1024, 1536), (1572864, 1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf24, buf26, 201326592, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_t_6.run(primals_23, buf51, 589824, stream=stream0)
            del primals_23
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_t_6.run(primals_24, buf54, 589824, stream=stream0)
            del primals_24
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf53, buf55, 201326592, stream=stream0)
            ...
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, linear_7, getitem_20, getitem_21, linear_9, mul_14, add_4, mul_15, add_5, getitem_22, getitem_23, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21, linear_13], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream0 = get_raw_stream(0)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_10.run(buf60, primals_15, buf28, primals_3, primals_20, buf50, primals_21, buf56, primals_25, primals_26, primals_32, buf57, buf58, buf62, buf81, 131072, 384, stream=stream0)
            ...
            stream0 = get_raw_stream(0)
            triton_poi_fused__to_copy_t_6.run(primals_33, buf80, 589824, stream=stream0)
            del primals_33
            ...
            # Topologically Sorted Source Nodes: [linear_13, leaky_relu_2, square_2], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow]
            stream0 = get_raw_stream(0)
            triton_poi_fused__unsafe_view_leaky_relu_pow_12.run(buf82, buf83, 201326592, stream=stream0)
...
def get_args():
    ...
    primals_13 = rand_strided((1536, 384), (384, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_14 = rand_strided((384, 1536), (1536, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    primals_23 = rand_strided((1536, 384), (384, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_24 = rand_strided((384, 1536), (1536, 1), device='cuda:0', dtype=torch.bfloat16)
    ...
    primals_33 = rand_strided((1536, 384), (384, 1), device='cuda:0', dtype=torch.bfloat16)
