...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ta/ctae3sihxpo6k5kpfrjzirq7qzfobdldtelfcilx5v5iau3byqp6.py
...
#   %primals_2 : Tensor "bf16[196608, 128][128, 1]cuda:5" = PlaceHolder[target=primals_2]
...
def get_args():
    ...
    primals_2 = rand_strided((196608, 128), (128, 1), device='cuda:5', dtype=torch.bfloat16)
