...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/r5/cr5hd53t5qov4sz6h3pkln4iuuki557anxzg4da5erpqage5cprt.py
...
#   %select : Tensor "i64[350, 4][4000, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%empty, 1, 0), kwargs = {})
...
#   %copy : Tensor "i64[350, 4][4000, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%select, %full_default), kwargs = {})
#   %select_scatter_default : Tensor "i64[350, 1000, 4][4000, 4, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.select_scatter.default](args = (%empty, %copy, 1, 0), kwargs = {})
#   %slice_8 : Tensor "i64[350, 999, 4][4000, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%select_scatter_default, 1, 1, 9223372036854775807), kwargs = {})
...
#   %mul : Tensor "i64[350, 999, 4][3996, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze, %lift_fresh_copy), kwargs = {})
...
#   %mul_1 : Tensor "i64[350, 999, 4][3996, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %lift_fresh_copy_1), kwargs = {})
#   %bitwise_xor : Tensor "i64[350, 999, 4][3996, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.bitwise_xor.Tensor](args = (%mul, %mul_1), kwargs = {})
#   %remainder : Tensor "i64[350, 999, 4][3996, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 8191), kwargs = {})
#   %add : Tensor "i64[350, 999, 4][3996, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%remainder, 1), kwargs = {})
#   %copy_1 : Tensor "i64[350, 999, 4][4000, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_8, %add), kwargs = {})
#   %slice_scatter_default : Tensor "i64[350, 1000, 4][4000, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%select_scatter_default, %copy_1, 1, 1, 9223372036854775807), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/6b/c6brvaugqgqngwniqrpaefrzkgoqe55z7fe6c2x6yym66fir3nrj.py
...
#   sum_1 => sum_1
# Graph fragment:
#   %slice_scatter_default : Tensor "i64[350, 1000, 4][4000, 4, 1]cuda:3" = PlaceHolder[target=slice_scatter_default]
...
#   %add_1 : Tensor "i64[350, 1000, 4][4000, 4, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %mul_2), kwargs = {})
#   %embedding_1 : Tensor "bf16[350, 1000, 4, 128][512000, 512, 128, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%arg6_1, %add_1), kwargs = {})
...
#   %mul_3 : Tensor "f32[350, 1000, 128][128000, 128, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.5), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tt/cttsmhp7nhnzj5lbgrhun7mkbiftwqdmtamt6yav2mb6c47mj66q.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/cy/ccyuirci3lxof3kyyi5pvafeuphzdzcolxnjwsxhwjvrwuijdlhv.py
...
#   %buf8 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf8]
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/cw/ccwrn4us5ewut7cti3fuyxecgwu2437q2e6qldrqdm7m6wpa6tit.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xs/cxsoicxx7idqwqczojn36awhv54ur6nmcr52wy2zi4htcw2x6r2f.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/kd/ckdqd4v42zkyuahzrg2bpnirykmkcipmtpksrvbm66cggpiv5khr.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wu/cwuofnwxohmukcslcp32svimacjna7wr6q4wiiifhjoht77hdu6v.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ia/cia34ghsrwhg7imibnub2eot6fgu4ccpa2do2jen645fjcjdhjsm.py
...
#   %buf29 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf29]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(3):
            ...
            triton_poi_fused_add_bitwise_xor_copy_fill_lift_fresh_mul_remainder_select_slice_unsqueeze_0.run(arg4_1, buf1, 1400000, stream=stream3)
            buf2 = empty_strided_cuda((350, 1000, 128), (128000, 128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [arange, mul_2, add_1, embedding_1, sum_1, mul_3, linear], Original ATen: [aten.arange, aten.mul, aten.add, aten.embedding, aten.sum, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_add_arange_embedding_mul_sum_1.run(buf1, arg6_1, buf2, 44800000, stream=stream3)
            del arg6_1
            del buf1
            ...
            # Topologically Sorted Source Nodes: [embedding], Original ATen: [aten.embedding]
            stream3 = get_raw_stream(3)
            triton_poi_fused_embedding_2.run(arg4_1, arg5_1, buf4, 134400000, stream=stream3)
            del arg5_1
            ...
            # Topologically Sorted Source Nodes: [to_6, sigmoid_1, getitem_8, sub, linear, linear_1, sigmoid, mul_4, to_5, mul_5, add_2, mul_7, zeros_like, getitem_10, cat, ne, to_7, unsqueeze, mul_6, mul_8, add_3, rms_norm, to_8], Original ATen: [aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.rsub, aten._unsafe_view, aten.view, aten.mul, aten.add, aten.zeros_like, aten.slice, aten.cat, aten.ne, aten._fused_rms_norm]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_cat_mul_ne_rsub_sigmoid_slice_unsqueeze_view_zeros_like_4.run(arg11_1, buf4, buf3, buf6, arg10_1, arg4_1, arg12_1, buf7, buf9, 350000, 384, stream=stream3)
            del arg10_1
            del arg11_1
            del arg12_1
            del arg4_1
            ...
            stream3 = get_raw_stream(3)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf10, (350, 1000, 16, 48), (768000, 768, 48, 1), 0), buf11, buf12, reinterpret_tensor(arg0_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg1_1, (1000, 24), (24, 1), 0), 4200000, 1, 1, stream=stream3)
            buf15 = empty_strided_cuda((350, 4, 1000, 48), (192000, 48, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_11, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            stream3 = get_raw_stream(3)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_5.run(buf10, buf15, 67200000, stream=stream3)
            del buf10
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_11, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_6], Original ATen: [aten.slice, aten.clone]
            stream3 = get_raw_stream(3)
            triton_poi_fused_clone_slice_6.run(buf9, buf22, 4200000, stream=stream3)
            buf23 = empty_strided_cuda((350000, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_6, linear_3, to_10], Original ATen: [aten.slice, aten.clone, aten.view, aten._to_copy, aten.t, aten.mm]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_7.run(buf22, buf23, 4200000, stream=stream3)
            del buf22
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_3, mul_9, sigmoid_2, getitem_15, mul_10], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream3 = get_raw_stream(3)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_9.run(buf26, buf25, 134400000, stream=stream3)
            del buf25
            ...
            # Topologically Sorted Source Nodes: [linear_4, add_4, rms_norm_1, to_12], Original ATen: [aten._unsafe_view, aten.add, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_10.run(buf28, buf7, arg16_1, buf30, 350000, 384, stream=stream3)
            del arg16_1
