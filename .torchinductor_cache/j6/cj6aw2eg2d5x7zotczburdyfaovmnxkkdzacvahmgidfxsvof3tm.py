...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/5s/c5szqifvui3r6rywmsk2gzbqb73bxm5jjemfjdcgwzwdc5kov3hf.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/uz/cuz5tuvj6ndcf7sejvomf7kefzulwwa4tpuhzacmijrtzqjsuxzv.py
...
#   %convert_element_type_default_21 : Tensor "bf16[1152, 384][384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_5, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[384, 1152][1, 384]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_21, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/hy/chyumtavnjc25tadupv52sqbaaevi5s2bsq6adg2hkklrtaysxi4.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xn/cxna6obmirdgfdkz2ota76asc4vcvdlmlfypujropdsuhn7atspi.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/aj/caj7emj4bsmr55trkkf5l4za3nyqse343hhkdj5qrjvkia3hq2wc.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rs/crsuuturyegtyqbrqumlt4urvy2rr234forkmkvugxstktx3pbhf.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/nk/cnkacfrspbb7fw65peirroqtt46qeqgsqnvxtum2bw5ighjtyxj7.py
...
# Graph fragment:
#   %primals_13 : Tensor "bf16[1536, 384][384, 1]cuda:1" = PlaceHolder[target=primals_13]
#   %convert_element_type_default_20 : Tensor "bf16[1536, 384][384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_13, torch.bfloat16), kwargs = {})
#   %permute_9 : Tensor "bf16[384, 1536][1, 384]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_20, [1, 0]), kwargs = {})
#   return %permute_9
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/zn/cznafxjjyfry5n3ixphmyjjb2n64co3pr4pm4oz5xovdngalppdz.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/vk/cvk6uii4sjps2mnz4geo36lheaom6qg7nlaknwswnvrphdvffqly.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gy/cgy4stfymuuuuz7dnxjll6vk26c6rdby6sulzippnjf2vrccidqi.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wr/cwr4dzyc4nwjfulotw6n5llqrnbhcrvuawk4co57qe2vw2gixwlh.py
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*bf16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=1, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/4j/c4jgpkqa6ibxou4l4ub3ivaodwel3kvkal5xs4bes43uu3gyh62v.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tw/ctwsqzwnkvro34u2bre6p77yk4dbvx7qmlbgbait7s56kr5qpeto.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(1):
            ...
            # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy_t_6.run(primals_13, buf22, 589824, stream=stream1)
            del primals_13
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy_t_6.run(primals_14, buf25, 589824, stream=stream1)
            del primals_14
            buf26 = empty_strided_cuda((128, 1024, 1536), (1572864, 1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf24, buf26, 201326592, stream=stream1)
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy_t_6.run(primals_23, buf51, 589824, stream=stream1)
            del primals_23
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy_t_6.run(primals_24, buf54, 589824, stream=stream1)
            del primals_24
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf53, buf55, 201326592, stream=stream1)
            ...
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, linear_7, getitem_20, getitem_21, linear_9, mul_14, add_4, mul_15, add_5, getitem_22, getitem_23, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21, linear_13], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream1 = get_raw_stream(1)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_10.run(buf60, primals_15, buf28, primals_3, primals_20, buf50, primals_21, buf56, primals_25, primals_26, primals_32, buf57, buf58, buf62, buf81, 131072, 384, stream=stream1)
            ...
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy_t_6.run(primals_33, buf80, 589824, stream=stream1)
            del primals_33
            ...
            # Topologically Sorted Source Nodes: [linear_13, leaky_relu_2, square_2], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow]
            stream1 = get_raw_stream(1)
            triton_poi_fused__unsafe_view_leaky_relu_pow_12.run(buf82, buf83, 201326592, stream=stream1)
...
def get_args():
    ...
    primals_13 = rand_strided((1536, 384), (384, 1), device='cuda:1', dtype=torch.bfloat16)
    primals_14 = rand_strided((384, 1536), (1536, 1), device='cuda:1', dtype=torch.bfloat16)
    ...
    primals_23 = rand_strided((1536, 384), (384, 1), device='cuda:1', dtype=torch.bfloat16)
    primals_24 = rand_strided((384, 1536), (1536, 1), device='cuda:1', dtype=torch.bfloat16)
    ...
    primals_33 = rand_strided((1536, 384), (384, 1), device='cuda:1', dtype=torch.bfloat16)
