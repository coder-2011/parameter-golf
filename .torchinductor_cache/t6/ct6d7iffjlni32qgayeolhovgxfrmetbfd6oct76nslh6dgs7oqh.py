...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xg/cxgf6rshsm2m2mcx7ihnajrpp5zckgt75tbtaeicvmqllxcozdmy.py
# Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   linear => convert_element_type_2
# Graph fragment:
#   %arg1_1 : Tensor "f32[512, 1000, 1536][1536000, 1536, 1]cuda:6" = PlaceHolder[target=arg1_1]
#   %convert_element_type_2 : Tensor "bf16[512, 1000, 1536][1536000, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg1_1, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/in/ciniriz3rxqimimjvq57jdejonfedyixrrfxv6wjjflr3pimirzu.py
...
#   mul_1 => mul_1
# Graph fragment:
#   %arg4_1 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:6" = PlaceHolder[target=arg4_1]
...
#   %mul : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg2_1, %arg3_1), kwargs = {})
#   %add : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg4_1, %mul), kwargs = {})
...
#   %mul_1 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg5_1, %view_1), kwargs = {})
#   %add_1 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add, %mul_1), kwargs = {})
#   return %add_1
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(6):
            ...
            triton_poi_fused__to_copy_0.run(arg1_1, buf0, 786432000, stream=stream6)
            del arg1_1
            ...
            # Topologically Sorted Source Nodes: [mul, add, linear, mul_1, add_1], Original ATen: [aten.mul, aten.add, aten._unsafe_view]
            stream6 = get_raw_stream(6)
            triton_poi_fused__unsafe_view_add_mul_1.run(arg4_1, arg2_1, arg3_1, arg5_1, buf1, buf2, 196608000, stream=stream6)
            del arg2_1
            del arg3_1
            del arg4_1
            del arg5_1
...
def get_args():
    ...
    arg1_1 = rand_strided((512, 1000, 1536), (1536000, 1536, 1), device='cuda:6', dtype=torch.float32)
    ...
    arg4_1 = rand_strided((512, 1000, 384), (384000, 384, 1), device='cuda:6', dtype=torch.float32)
