...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/3x/c3xftvsu2twtthhd4otyjgg3mpdmt4nmgily6lnnkei4ayvui7ji.py
...
#   %primals_2 : Tensor "bf16[196608, 128][128, 1]cuda:7" = PlaceHolder[target=primals_2]
...
def get_args():
    ...
    primals_2 = rand_strided((196608, 128), (128, 1), device='cuda:7', dtype=torch.bfloat16)
