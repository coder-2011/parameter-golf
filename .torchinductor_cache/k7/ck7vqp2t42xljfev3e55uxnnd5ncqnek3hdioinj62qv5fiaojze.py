...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/vj/cvjz4achwsowohhdixbc6dmzpllprtymzd4sr5d77tlytxj3hmiv.py
...
#   sum_1 => sum_1
# Graph fragment:
#   %arg0_1 : Tensor "i64[350, 1000, 12][12000, 12, 1]cuda:1" = PlaceHolder[target=arg0_1]
...
#   %embedding : Tensor "bf16[350, 1000, 12, 128][1536000, 1536, 128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%arg1_1, %arg0_1), kwargs = {})
...
#   %mul : Tensor "f32[350, 1000, 128][128000, 128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.28867513459481287), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(1):
            ...
            # Topologically Sorted Source Nodes: [embedding, sum_1, mul, linear], Original ATen: [aten.embedding, aten.sum, aten.mul, aten._to_copy]
            stream1 = get_raw_stream(1)
            triton_per_fused__to_copy_embedding_mul_sum_2.run(arg0_1, arg1_1, buf1, 44800000, 12, stream=stream1)
            del arg0_1
            del arg1_1
...
def get_args():
    ...
    arg0_1 = rand_strided((350, 1000, 12), (12000, 12, 1), device='cuda:1', dtype=torch.int64)
