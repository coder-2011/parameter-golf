...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wv/cwvifan3hn73c5om4vaxihw5k3ptsz6bncdxs5qijdh4vcfxwyfh.py
...
#   %mul : Tensor "i64[128, 1023, 8][8184, 8, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze, %lift_fresh_copy), kwargs = {})
...
#   %mul_1 : Tensor "i64[128, 1023, 8][8184, 8, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %lift_fresh_copy_1), kwargs = {})
#   %bitwise_xor : Tensor "i64[128, 1023, 8][8184, 8, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.bitwise_xor.Tensor](args = (%mul, %mul_1), kwargs = {})
#   return %bitwise_xor
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/cx/ccxmtfjxehp677sopm37522bzfdiknafr5vhwrm6rpjjvylhkekr.py
...
# Graph fragment:
#   %bitwise_xor : Tensor "i64[128, 1023, 8][8192, 8, 1]cuda:5" = PlaceHolder[target=bitwise_xor]
...
#   %select : Tensor "i64[128, 8][8192, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%empty, 1, 0), kwargs = {})
#   %copy : Tensor "i64[128, 8][8192, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%select, %full_default), kwargs = {})
#   %select_scatter_default : Tensor "i64[128, 1024, 8][8192, 8, 1]cuda:5"[num_users=2] = call_function[target=torch.ops.aten.select_scatter.default](args = (%empty, %copy, 1, 0), kwargs = {})
#   %remainder : Tensor "i64[128, 1023, 8][8184, 8, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 8191), kwargs = {})
#   %add : Tensor "i64[128, 1023, 8][8184, 8, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%remainder, 1), kwargs = {})
#   %slice_4 : Tensor "i64[128, 1023, 8][8192, 8, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%select_scatter_default, 1, 1, 9223372036854775807), kwargs = {})
#   %copy_1 : Tensor "i64[128, 1023, 8][8192, 8, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_4, %add), kwargs = {})
#   %slice_scatter_default : Tensor "i64[128, 1024, 8][8192, 8, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%select_scatter_default, %copy_1, 1, 1, 9223372036854775807), kwargs = {})
...
#   %add_1 : Tensor "i64[128, 1024, 8][8192, 8, 1]cuda:5"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %mul_2), kwargs = {})
#   return %add_1
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gm/cgmi4ge5nkglv6u3d6x6crdiyokeoc5b3wi6lof6xh6i7vjvy3gh.py
...
#   %primals_7 : Tensor "bf16[65536, 116][116, 1]cuda:5" = PlaceHolder[target=primals_7]
#   %sum_1 : Tensor "f32[128, 1024, 116][118784, 116, 1]cuda:5" = PlaceHolder[target=sum_1]
#   %embedding_1 : Tensor "bf16[128, 1024, 8, 116][950272, 928, 116, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%primals_7, %add_1), kwargs = {})
#   %sum_1 : Tensor "f32[128, 1024, 116][118784, 116, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%embedding_1, [-2]), kwargs = {dtype: torch.float32})
#   %mul_3 : Tensor "f32[128, 1024, 116][118784, 116, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.3535533905932738), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[128, 1024, 116][118784, 116, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_3, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ja/cjaicutnhzon3tqkq476wijuooydki46k37xknvaik4nlhhx7rdc.py
# Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   linear => convert_element_type_default_7
# Graph fragment:
#   %primals_8 : Tensor "bf16[384, 116][116, 1]cuda:5" = PlaceHolder[target=primals_8]
#   %convert_element_type_default_7 : Tensor "bf16[384, 116][116, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_8, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xc/cxcul2jccw5y5i3c2gkxsddssvmnwctuzvclcirr67m745nirrs6.py
...
#   mul_3 => mul_3
# Graph fragment:
#   %convert_element_type_2 : Tensor "bf16[128, 1024, 116][118784, 116, 1]cuda:5" = PlaceHolder[target=convert_element_type_2]
#   %mul_3 : Tensor "f32[128, 1024, 116][118784, 116, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.3535533905932738), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[128, 1024, 116][118784, 116, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_3, torch.bfloat16), kwargs = {})
#   %view : Tensor "bf16[131072, 116][116, 1]cuda:5"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_2, [131072, 116]), kwargs = {})
#   %constant_pad_nd_default_2 : Tensor "bf16[131072, 120][120, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view, [0, 4, 0, 0]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/l6/cl6w2bbvr3lekskartq4c7aqiwuens34lqqygllgs4tot6jwueb5.py
...
# Graph fragment:
#   %convert_element_type_default_7 : Tensor "bf16[384, 116][116, 1]cuda:5" = PlaceHolder[target=convert_element_type_default_7]
#   %convert_element_type_default_7 : Tensor "bf16[384, 116][116, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_8, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[116, 384][1, 116]cuda:5"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_7, [1, 0]), kwargs = {})
#   %constant_pad_nd_default_3 : Tensor "bf16[120, 384][384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%permute, [0, 0, 0, 4]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dc/cdcpj5reir4au2q3izvpkgyjty7anpwk5bybr6hbspxivqs6ssrj.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2i/c2iseqom4rbrrbtmohkxndl2ja6x6mb5kuwwanpuy3yme3qicpgm.py
...
#   %buf15 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:5" = PlaceHolder[target=buf15]
...
#   %view_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_default_2, [128, 1024, 384]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/jp/cjpuwimrq6gtjqndplk55klhgjhrrzafyoc7xgg536zovg6z2eyh.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ix/cixgf57oqpybzhf3klopbrtrssdwmybv6zmt5rhtermom535t6va.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xt/cxt3kbg3zskngtlytvakttxgls6ue7krenmmtj2keeskg6wdmw5n.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/so/csohzc2jfdbbzgs7zqzgm7ez3ayh2vukwsyshjbz3bzu65iyo23w.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ii/ciiynjerk7qdoqwndahqrd5by5o3cng4xqu5xv7obykwerpajozx.py
...
#   %buf36 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:5" = PlaceHolder[target=buf36]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(5):
            ...
            # Topologically Sorted Source Nodes: [getitem_4, getitem_5, tensor, tensor_1, getitem_6, mul, getitem_7, mul_1, bitwise_xor], Original ATen: [aten.slice, aten.lift_fresh, aten.unsqueeze, aten.mul, aten.bitwise_xor]
            stream5 = get_raw_stream(5)
            triton_poi_fused_bitwise_xor_lift_fresh_mul_slice_unsqueeze_1.run(primals_5, buf2, 130944, 8, stream=stream5)
            buf3 = empty_strided_cuda((128, 1024, 8), (8192, 8, 1), torch.int64)
            # Topologically Sorted Source Nodes: [setitem, remainder, add, setitem_1, arange, mul_2, add_1], Original ATen: [aten.lift_fresh, aten.select, aten.fill, aten.remainder, aten.add, aten.slice, aten.copy, aten.arange, aten.mul]
            stream5 = get_raw_stream(5)
            triton_poi_fused_add_arange_copy_fill_lift_fresh_mul_remainder_select_slice_2.run(buf2, buf3, 1048576, stream=stream5)
            del buf2
            buf5 = empty_strided_cuda((128, 1024, 116), (118784, 116, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [embedding_1, sum_1, mul_3, linear], Original ATen: [aten.embedding, aten.sum, aten.mul, aten._to_copy]
            stream5 = get_raw_stream(5)
            triton_per_fused__to_copy_embedding_mul_sum_3.run(buf3, primals_7, buf5, 15204352, 8, stream=stream5)
            del primals_7
            buf6 = empty_strided_cuda((384, 116), (116, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_4.run(primals_8, buf6, 44544, stream=stream5)
            del primals_8
            buf7 = empty_strided_cuda((131072, 120), (120, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [mul_3, linear], Original ATen: [aten.mul, aten._to_copy, aten.view, aten.mm]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_mm_mul_view_5.run(buf5, buf7, 15728640, stream=stream5)
            buf8 = empty_strided_cuda((120, 384), (1, 120), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy, aten.t, aten.mm]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_mm_t_6.run(buf6, buf8, 46080, stream=stream5)
            ...
            # Topologically Sorted Source Nodes: [to_2], Original ATen: [aten._to_copy]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_7.run(primals_9, buf10, 384, stream=stream5)
            del primals_9
            ...
            # Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_4, to_5, mul_5, add_2, to_6, sigmoid_1, getitem_8, zeros_like, getitem_10, cat, ne, to_7, unsqueeze, mul_6, sub, mul_7, mul_8, add_3, to_8, rms_norm], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten._to_copy, aten.add, aten.unsqueeze, aten.zeros_like, aten.slice, aten.cat, aten.ne, aten.rsub, aten._fused_rms_norm]
            stream5 = get_raw_stream(5)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_cat_mul_ne_rsub_sigmoid_slice_unsqueeze_view_zeros_like_8.run(buf16, primals_5, buf0, buf9, buf11, primals_11, primals_12, primals_13, buf13, buf12, buf14, buf17, 131072, 384, stream=stream5)
            ...
            stream5 = get_raw_stream(5)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf18, (128, 1024, 16, 48), (786432, 768, 48, 1), 0), buf19, buf20, reinterpret_tensor(primals_1, (1024, 24), (24, 1), 0), reinterpret_tensor(primals_2, (1024, 24), (24, 1), 0), 1572864, 1, 1, stream=stream5)
            buf23 = empty_strided_cuda((128, 1024, 4, 48), (196608, 192, 48, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_2, view, getitem, v], Original ATen: [aten._unsafe_view, aten.view, aten.slice, aten.clone]
            stream5 = get_raw_stream(5)
            triton_poi_fused__unsafe_view_clone_slice_view_9.run(buf18, buf23, 25165824, stream=stream5)
            ...
            # Topologically Sorted Source Nodes: [to_10, linear_3], Original ATen: [aten._to_copy, aten.t]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_t_10.run(primals_15, buf30, 96, stream=stream5)
            del primals_15
            buf31 = empty_strided_cuda((128, 1024, 12), (12288, 12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_3], Original ATen: [aten.slice, aten.clone]
            stream5 = get_raw_stream(5)
            triton_poi_fused_clone_slice_11.run(buf17, buf31, 1572864, stream=stream5)
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_3, mul_9, sigmoid_2, getitem_15, mul_10], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream5 = get_raw_stream(5)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_12.run(buf25, buf32, buf33, 50331648, stream=stream5)
            ...
            # Topologically Sorted Source Nodes: [linear_4, add_4, to_12, rms_norm_1], Original ATen: [aten._unsafe_view, aten.add, aten._to_copy, aten._fused_rms_norm]
            stream5 = get_raw_stream(5)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_13.run(buf35, buf37, buf14, primals_17, buf38, 131072, 384, stream=stream5)
...
def get_args():
    ...
    primals_7 = rand_strided((65536, 116), (116, 1), device='cuda:5', dtype=torch.bfloat16)
    primals_8 = rand_strided((384, 116), (116, 1), device='cuda:5', dtype=torch.bfloat16)
