...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gr/cgr7b3yoyz6jgujf544subadzm3g5hua4uzokcmqxshvsesoelgi.py
...
#   %mul_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg2_1, %exp_2), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(5):
            ...
            triton_poi_fused__unsafe_view_add_exp_mul_neg_softplus_0.run(arg2_1, arg0_1, arg1_1, buf0, buf1, 50331648, stream=stream5)
            del arg0_1
            del arg1_1
            del arg2_1
            del buf0
