...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/id/cidn77qk6rmqdzech4ox7af6lj6laixawbph7lec53tlllgklklj.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/v4/cv4t2iv3bdto43cmweh2dnjul3zb64xk3msxvpahpt3kyi6hnaw2.py
...
#   %convert_element_type_default_21 : Tensor "bf16[1152, 384][384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_5, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[384, 1152][1, 384]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_21, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xi/cxia7qkg3hykgef7fdholyd2stiw73ibfmowm6nsof6trvwxfjzo.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/nv/cnvg6dzja42a2fvacqmncduo4l2gfmpduzjzi6wwoptw4id7lxwh.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/6h/c6hgkg7altigzkcj3vh3xeyu6v4dcpks4o67oztvonxbv3twdb7k.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2q/c2qdeqzdcqwuaoypeifstu2x535kkzbhg4ph3b6qcaqgsura2tgs.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2p/c2psysqgzeujczzthw444skefijpzqt43triffjdckyssjs7tuaz.py
...
# Graph fragment:
#   %primals_13 : Tensor "bf16[1536, 384][384, 1]cuda:2" = PlaceHolder[target=primals_13]
#   %convert_element_type_default_20 : Tensor "bf16[1536, 384][384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_13, torch.bfloat16), kwargs = {})
#   %permute_9 : Tensor "bf16[384, 1536][1, 384]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_20, [1, 0]), kwargs = {})
#   return %permute_9
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/32/c32xc5pycnufnszremvycs5kehz5lkihtcjw5tc5gqdxihxnzres.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/6b/c6b4jjg5x4ta4qexftkdndwc67wnw66b2m3rfeli7jzmspafvefz.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sa/csaoss7nozz6zro5q7urk55s4hs37pypgori4u3mivp4ogaud6fm.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ft/cftsc6s72pq5nr6z3znoqlsqdbxks4mtqawgw6ls6mdujecmrhb5.py
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*bf16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=2, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xn/cxnps2q56by27p66obmai4g4o6ed3peuugzivnmnj5ei6qj6djyf.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ai/caicpyzyuzwjfah6o6ciwfbfpsfhcp2lofbdfixljrodqmqv7nxp.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_13, buf22, 589824, stream=stream2)
            del primals_13
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_14, buf25, 589824, stream=stream2)
            del primals_14
            buf26 = empty_strided_cuda((128, 1024, 1536), (1572864, 1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf24, buf26, 201326592, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_23, buf51, 589824, stream=stream2)
            del primals_23
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_24, buf54, 589824, stream=stream2)
            del primals_24
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf53, buf55, 201326592, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, linear_7, getitem_20, getitem_21, linear_9, mul_14, add_4, mul_15, add_5, getitem_22, getitem_23, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21, linear_13], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_10.run(buf60, primals_15, buf28, primals_3, primals_20, buf50, primals_21, buf56, primals_25, primals_26, primals_32, buf57, buf58, buf62, buf81, 131072, 384, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_33, buf80, 589824, stream=stream2)
            del primals_33
            ...
            # Topologically Sorted Source Nodes: [linear_13, leaky_relu_2, square_2], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow]
            stream2 = get_raw_stream(2)
            triton_poi_fused__unsafe_view_leaky_relu_pow_12.run(buf82, buf83, 201326592, stream=stream2)
...
def get_args():
    ...
    primals_13 = rand_strided((1536, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_14 = rand_strided((384, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    primals_23 = rand_strided((1536, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_24 = rand_strided((384, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    primals_33 = rand_strided((1536, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
