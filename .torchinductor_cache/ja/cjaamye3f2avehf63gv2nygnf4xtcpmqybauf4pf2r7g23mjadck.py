...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/bm/cbmhqcmxz6o37rw3enm34sagzqddibgpbj6pzhenksbzurq6xfbc.py
# Topologically Sorted Source Nodes: [mul], Original ATen: [aten.mul]
# Source node to ATen node mapping:
#   mul => mul
# Graph fragment:
#   %arg0_1 : Tensor "bf16[8192, 384][384, 1]cuda:2" = PlaceHolder[target=arg0_1]
#   %mul : Tensor "bf16[8192, 384][384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg0_1, 1.0), kwargs = {})
#   return %mul
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/6g/c6gymeo4kdzlm42iaha6ibpmwkjoh3k3sno7wwjodtmy6cvc4wnz.py
...
#   truediv => div
# Graph fragment:
#   %mm : Tensor "bf16[512000, 8192][8192, 1]cuda:2" = PlaceHolder[target=mm]
#   %amax_default : Tensor "f32[512000, 1][1, 512000]cuda:2" = PlaceHolder[target=amax_default]
#   %convert_element_type_2 : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm, torch.float32), kwargs = {})
#   %div : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_2, 30.0), kwargs = {})
#   %tanh : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.tanh.default](args = (%div,), kwargs = {})
#   %mul_tensor : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tanh, 1), kwargs = {})
#   %amax_default : Tensor "f32[512000, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.amax.default](args = (%mul_tensor, [1], True), kwargs = {})
#   %sub_tensor : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_tensor, %amax_default), kwargs = {})
#   %mul_tensor_1 : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_tensor, 30.0), kwargs = {})
#   %exp : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%mul_tensor_1,), kwargs = {})
#   %sum_1 : Tensor "f32[512000, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%exp, [1], True), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pe/cpezanq57vadiav5whcfhmdq6aoqm6d3dik6ijnwoqm6bpxuptd6.py
...
#   truediv => div
# Graph fragment:
#   %arg2_1 : Tensor "i64[512000][1]cuda:2" = PlaceHolder[target=arg2_1]
#   %mm : Tensor "bf16[512000, 8192][8192, 1]cuda:2" = PlaceHolder[target=mm]
#   %amax_default : Tensor "f32[512000, 1][1, 512000]cuda:2" = PlaceHolder[target=amax_default]
#   %sum_1 : Tensor "f32[512000, 1][1, 512000]cuda:2" = PlaceHolder[target=sum_1]
#   %ne_1 : Tensor "b8[512000][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%arg2_1, -100), kwargs = {})
#   %convert_element_type_2 : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm, torch.float32), kwargs = {})
#   %div : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_2, 30.0), kwargs = {})
#   %tanh : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.tanh.default](args = (%div,), kwargs = {})
#   %mul_tensor : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tanh, 1), kwargs = {})
#   %sub_tensor : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_tensor, %amax_default), kwargs = {})
#   %mul_tensor_1 : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_tensor, 30.0), kwargs = {})
#   %log : Tensor "f32[512000, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.log.default](args = (%sum_1,), kwargs = {})
#   %sub_1 : Tensor "f32[512000, 8192][8192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_tensor_1, %log), kwargs = {})
#   %ne : Tensor "b8[512000][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%arg2_1, -100), kwargs = {})
...
#   %where : Tensor "i64[512000][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ne, %arg2_1, %full_default), kwargs = {})
#   %unsqueeze : Tensor "i64[512000, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%where, 1), kwargs = {})
#   %gather : Tensor "f32[512000, 1][1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.gather.default](args = (%sub_1, 1, %unsqueeze), kwargs = {})
#   %squeeze : Tensor "f32[512000][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%gather, 1), kwargs = {})
#   %neg : Tensor "f32[512000][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.neg.default](args = (%squeeze,), kwargs = {})
...
#   %where_1 : Tensor "f32[512000][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ne_1, %neg, %full_default_1), kwargs = {})
#   %sum_3 : Tensor "f32[][]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.default](args = (%where_1,), kwargs = {})
#   %ne_2 : Tensor "b8[512000][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%arg2_1, -100), kwargs = {})
#   %sum_2 : Tensor "i64[][]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.default](args = (%ne_2,), kwargs = {})
#   return %buf5,%buf8
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ub/cubbtxk6zlskqc2pulhamldcesufgmmv4hpb7kj5h2rptgt5zl4d.py
# Topologically Sorted Source Nodes: [cross_entropy, float_1, truediv, tanh], Original ATen: [aten.nll_loss_forward, aten._to_copy, aten.div, aten.tanh, aten.mul, aten.sub, aten._log_softmax]
# Source node to ATen node mapping:
...
#   truediv => div
# Graph fragment:
#   %buf5 : Tensor "f32[63][1]cuda:2" = PlaceHolder[target=buf5]
#   %buf8 : Tensor "i64[63][1]cuda:2" = PlaceHolder[target=buf8]
...
#   %ne_2 : Tensor "b8[512000][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%arg2_1, -100), kwargs = {})
#   %sum_2 : Tensor "i64[][]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.default](args = (%ne_2,), kwargs = {})
#   %convert_element_type_3 : Tensor "f32[][]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sum_2, torch.float32), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            triton_poi_fused_mul_0.run(arg0_1, buf0, 3145728, stream=stream2)
            del arg0_1
            ...
            # Topologically Sorted Source Nodes: [float_1, truediv, tanh, cross_entropy], Original ATen: [aten._to_copy, aten.div, aten.tanh, aten.mul, aten.amax, aten.sub, aten._log_softmax]
            stream2 = get_raw_stream(2)
            triton_red_fused__log_softmax__to_copy_amax_div_mul_sub_tanh_1.run(buf1, buf2, buf3, 512000, 8192, stream=stream2)
            buf5 = empty_strided_cuda((63, ), (1, ), torch.float32)
            buf8 = empty_strided_cuda((63, ), (1, ), torch.int64)
            # Topologically Sorted Source Nodes: [cross_entropy, float_1, truediv, tanh], Original ATen: [aten.nll_loss_forward, aten._to_copy, aten.div, aten.tanh, aten.mul, aten.sub, aten._log_softmax]
            stream2 = get_raw_stream(2)
            triton_red_fused__log_softmax__to_copy_div_mul_nll_loss_forward_sub_tanh_2.run(arg2_1, buf1, buf2, buf3, buf5, buf8, 63, 8127, stream=stream2)
            del arg2_1
            del buf1
            del buf2
            del buf3
            ...
            # Topologically Sorted Source Nodes: [cross_entropy, float_1, truediv, tanh], Original ATen: [aten.nll_loss_forward, aten._to_copy, aten.div, aten.tanh, aten.mul, aten.sub, aten._log_softmax]
            stream2 = get_raw_stream(2)
            triton_per_fused__log_softmax__to_copy_div_mul_nll_loss_forward_sub_tanh_3.run(buf10, buf5, buf8, 1, 63, stream=stream2)
            del buf5
            del buf8
        return (buf10, )
...
def get_args():
    ...
    arg0_1 = rand_strided((8192, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    arg1_1 = rand_strided((512000, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    arg2_1 = rand_strided((512000, ), (1, ), device='cuda:2', dtype=torch.int64)
