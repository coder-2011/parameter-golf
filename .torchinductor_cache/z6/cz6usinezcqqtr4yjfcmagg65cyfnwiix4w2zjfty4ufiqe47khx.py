...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/an/canqg56n5bedhmrqdp44534uc4fhcqqu7chzfaj35gl5x7kwceol.py
...
#   %mm_1 : Tensor "bf16[131072, 384][384, 1]cuda:5" = PlaceHolder[target=mm_1]
#   %primals_5 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:5" = PlaceHolder[target=primals_5]
#   %view_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_1, [128, 1024, 384]), kwargs = {})
#   %mul_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %view_3), kwargs = {})
...
#   %mul_6 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %primals_5), kwargs = {})
#   %sum_2 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_6, [0, 1], True), kwargs = {dtype: torch.float32})
#   return %buf0,%buf2
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/5s/c5splsmayudnjtyrt5ivdw37xsyeevk7ulfcwyv5koovfietd5dq.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/bx/cbx7denp4ziii7srwxh5kigjgf6qtr7iz4bf4cewdk72jjqkj3s4.py
...
# Graph fragment:
#   %tangents_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:5" = PlaceHolder[target=tangents_1]
#   %primals_4 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:5" = PlaceHolder[target=primals_4]
#   %primals_7 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:5" = PlaceHolder[target=primals_7]
#   %mul_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %primals_7), kwargs = {})
#   %convert_element_type_13 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_3, torch.bfloat16), kwargs = {})
#   %mul_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %primals_4), kwargs = {})
#   %convert_element_type_14 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_5, torch.bfloat16), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'out_ptr0': '*bf16', 'out_ptr1': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=5, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/fb/cfbmadq5bkbpemwlilwb2rttmqegopnyh5xys452fqxg2amdziav.py
...
#   where_1 => where_1
# Graph fragment:
#   %mm : Tensor "bf16[131072, 1024][1024, 1]cuda:5" = PlaceHolder[target=mm]
#   %mm_3 : Tensor "bf16[131072, 1024][1024, 1]cuda:5" = PlaceHolder[target=mm_3]
#   %view_5 : Tensor "bf16[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_3, [128, 1024, 1024]), kwargs = {})
#   %convert_element_type_19 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_5, torch.float32), kwargs = {})
#   %view_1 : Tensor "bf16[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm, [128, 1024, 1024]), kwargs = {})
#   %convert_element_type_5 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_1, torch.float32), kwargs = {})
#   %gt : Tensor "b8[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=2] = call_function[target=torch.ops.aten.gt.Scalar](args = (%convert_element_type_5, 0), kwargs = {})
#   %mul : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_5, 0.5), kwargs = {})
#   %where : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt, %convert_element_type_5, %mul), kwargs = {})
#   %pow_2 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%where, 1.0), kwargs = {})
#   %mul_7 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%pow_2, 2.0), kwargs = {})
#   %mul_8 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_19, %mul_7), kwargs = {})
#   %mul_9 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_8, 0.5), kwargs = {})
#   %where_1 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt, %mul_8, %mul_9), kwargs = {})
#   %convert_element_type_25 : Tensor "bf16[128, 1024, 1024][1048576, 1024, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_1, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tu/ctuapsd24prfmz2w6h45g72wi2jhcun44uc3twhsvrp45tk2ove4.py
...
#   %view_7 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_5, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_30 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_7, torch.float32), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(5):
            ...
            triton_red_fused__unsafe_view_mul_sum_0.run(tangents_1, mm_1, primals_5, buf0, buf2, 134016, 376, stream=stream5)
            del mm_1
            del primals_5
            ...
            stream5 = get_raw_stream(5)
            triton_red_fused__unsafe_view_mul_sum_1.run(buf2, buf3, 384, 349, stream=stream5)
            del buf2
            ...
            # Topologically Sorted Source Nodes: [mul_3, convert_element_type_13, mul_5, convert_element_type_14], Original ATen: [aten.mul, aten._to_copy]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_mul_2.run(tangents_1, primals_4, primals_7, buf4, buf5, 50331648, stream=stream5)
            del primals_4
            del primals_7
            ...
            # Topologically Sorted Source Nodes: [view_5, convert_element_type_19, linear, leaky_relu, pow_2, mul_7, mul_8, mul_9, where_1, convert_element_type_25], Original ATen: [aten.view, aten._to_copy, aten._unsafe_view, aten.leaky_relu, aten.pow, aten.mul, aten.leaky_relu_backward]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_leaky_relu_backward_mul_pow_view_3.run(buf8, buf7, 134217728, stream=stream5)
            del buf7
            ...
            # Topologically Sorted Source Nodes: [view_7, convert_element_type_30], Original ATen: [aten.view, aten._to_copy]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_view_4.run(buf10, buf11, 50331648, stream=stream5)
            del buf10
...
def get_args():
    ...
    primals_4 = rand_strided((1, 1, 384), (384, 384, 1), device='cuda:5', dtype=torch.float32)
    primals_5 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:5', dtype=torch.bfloat16)
    primals_7 = rand_strided((1, 1, 384), (384, 384, 1), device='cuda:5', dtype=torch.float32)
    view = rand_strided((131072, 384), (384, 1), device='cuda:5', dtype=torch.bfloat16)
    mm = rand_strided((131072, 1024), (1024, 1), device='cuda:5', dtype=torch.bfloat16)
    view_2 = rand_strided((131072, 1024), (1024, 1), device='cuda:5', dtype=torch.bfloat16)
    mm_1 = rand_strided((131072, 384), (384, 1), device='cuda:5', dtype=torch.bfloat16)
    permute_4 = rand_strided((384, 1024), (1024, 1), device='cuda:5', dtype=torch.bfloat16)
    permute_8 = rand_strided((1024, 384), (384, 1), device='cuda:5', dtype=torch.bfloat16)
