...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qy/cqydrptsiv4ppcclok6pjqrcfdzglw6vyr32ps3lbhcmsze6h5g6.py
...
# Graph fragment:
#   %view_27 : Tensor "bf16[131072, 12][12, 1]cuda:6" = PlaceHolder[target=view_27]
#   %constant_pad_nd_default_2 : Tensor "bf16[131072, 16][16, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view_27, [0, 4, 0, 0]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/z5/cz5vi3pv27jdj6zjaezuj6ayh3o6lnakg7gmkmzt4i3ptua2252m.py
...
#   view_38 => view_38
# Graph fragment:
#   %mm_17 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_17]
#   %getitem_24 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:6" = PlaceHolder[target=getitem_24]
#   %mm_11 : Tensor "bf16[131072, 8][8, 1]cuda:6" = PlaceHolder[target=mm_11]
#   %sum_3 : Tensor "f32[128, 1024, 8, 1][8192, 8, 1, 1048576]cuda:6" = PlaceHolder[target=sum_3]
#   %view_37 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_17, [128, 1024, 384]), kwargs = {})
#   %view_38 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%view_37, [128, 1024, 8, 48]), kwargs = {})
#   %permute_28 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_24, [0, 2, 1, 3]), kwargs = {})
#   %mul_47 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_38, %permute_28), kwargs = {})
#   %view_28 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_11, [128, 1024, 8]), kwargs = {})
#   %mul_31 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_28, 0.5), kwargs = {})
#   %sigmoid_2 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_31,), kwargs = {})
#   %unsqueeze_22 : Tensor "bf16[128, 1024, 8, 1][8192, 8, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sigmoid_2, 3), kwargs = {})
#   %mul_48 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_38, %unsqueeze_22), kwargs = {})
#   %sum_3 : Tensor "f32[128, 1024, 8, 1][8192, 8, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_47, [3], True), kwargs = {dtype: torch.float32})
#   %convert_element_type_82 : Tensor "bf16[128, 1024, 8, 1][8192, 8, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sum_3, torch.bfloat16), kwargs = {})
#   %squeeze : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%convert_element_type_82, 3), kwargs = {})
#   %convert_element_type_83 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%squeeze, torch.float32), kwargs = {})
#   %convert_element_type_84 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sigmoid_2, torch.float32), kwargs = {})
#   %sub_1 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (1, %convert_element_type_84), kwargs = {})
#   %mul_49 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_84, %sub_1), kwargs = {})
#   %mul_50 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_83, %mul_49), kwargs = {})
#   %convert_element_type_85 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_50, torch.bfloat16), kwargs = {})
#   %mul_51 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_85, 0.5), kwargs = {})
#   %permute_44 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%mul_48, [0, 2, 1, 3]), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'in_ptr2': '*bf16', 'out_ptr1': '*bf16', 'out_ptr2': '*bf16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pz/cpz3jfpkt6jruveufb6x5bynfvvk7oxuyo6mcn4rl2e7mgh5sbar.py
...
# Graph fragment:
#   %mm_default_2 : Tensor "bf16[8, 16][16, 1]cuda:6" = PlaceHolder[target=mm_default_2]
#   %slice_tensor_2 : Tensor "bf16[8, 12][16, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_default_2, 1, 0, -4), kwargs = {})
#   %convert_element_type_91 : Tensor "f32[8, 12][12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_tensor_2, torch.float32), kwargs = {})
...
@triton_heuristics.pointwise(
    size_hints={'x': 128}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/3j/c3juyil2zriehueqzygfoxvme5fv4oiagpxxrj5p2cvvyae4wr6s.py
...
#   where_3 => where_3
# Graph fragment:
#   %mm_13 : Tensor "bf16[131072, 1536][1536, 1]cuda:6" = PlaceHolder[target=mm_13]
#   %tangents_1 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6" = PlaceHolder[target=tangents_1]
#   %view_33 : Tensor "bf16[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_13, [128, 1024, 1536]), kwargs = {})
#   %convert_element_type_64 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_33, torch.float32), kwargs = {})
#   %gt_2 : Tensor "b8[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.gt.Scalar](args = (%convert_element_type_64, 0), kwargs = {})
#   %mul_36 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_64, 0.5), kwargs = {})
#   %where_2 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt_2, %convert_element_type_64, %mul_36), kwargs = {})
#   %pow_10 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%where_2, 1.0), kwargs = {})
#   %mul_37 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%pow_10, 2.0), kwargs = {})
#   %mul_38 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, %mul_37), kwargs = {})
#   %mul_39 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_38, 0.5), kwargs = {})
#   %where_3 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt_2, %mul_38, %mul_39), kwargs = {})
#   %convert_element_type_70 : Tensor "bf16[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_3, torch.bfloat16), kwargs = {})
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/yx/cyxuqkrsja3fmo3lkxhm3dzidygouype5lp2q3yliyq5qw5orily.py
...
# Graph fragment:
#   %getitem_35 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:6" = PlaceHolder[target=getitem_35]
#   %permute_45 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_35, [0, 2, 1, 3]), kwargs = {})
#   %permute_46 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_34, [0, 2, 1, 3]), kwargs = {})
#   %permute_47 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_33, [0, 2, 1, 3]), kwargs = {})
#   %slice_7 : Tensor "bf16[128, 1024, 8, 48][1179648, 1152, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%empty_6, 2, 16, 9223372036854775807), kwargs = {})
#   %copy : Tensor "bf16[128, 1024, 8, 48][1179648, 1152, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_7, %permute_45), kwargs = {})
#   %slice_scatter_default_1 : Tensor "bf16[128, 1024, 24, 48][1179648, 1152, 48, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%empty_6, %copy, 2, 16, 9223372036854775807), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rl/crlxeemgttwkxd6lu6kbjw5ikktmyuogiy3resl7rvf43n4eujx4.py
...
#   view_48 => view_48
# Graph fragment:
#   %add_10 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_10]
#   %rsqrt_4 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6" = PlaceHolder[target=rsqrt_4]
#   %mm_15 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_15]
#   %primals_32 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_32]
#   %mm_19 : Tensor "bf16[131072, 12][12, 1]cuda:6" = PlaceHolder[target=mm_19]
#   %mm_21 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_21]
#   %primals_26 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_26]
#   %tangents_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=tangents_3]
#   %sum_1 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:6" = PlaceHolder[target=sum_1]
#   %sum_4 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:6" = PlaceHolder[target=sum_4]
#   %add_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_15]
#   %primals_25 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_25]
#   %primals_21 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_21]
#   %primals_20 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_20]
#   %view_35 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_15, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_75 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_35, torch.float32), kwargs = {})
#   %mul_40 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_75, 0.5), kwargs = {})
#   %mul_41 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_40, %primals_32), kwargs = {})
#   %mul_28 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %rsqrt_4), kwargs = {})
#   %mul_43 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %mul_41), kwargs = {})
#   %sum_1 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_43, [2], True), kwargs = {})
#   %div : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_28, 384), kwargs = {})
#   %mul_44 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %sum_1), kwargs = {})
#   %sub : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_41, %mul_44), kwargs = {})
#   %mul_45 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %rsqrt_4), kwargs = {})
#   %mul_46 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_40, %mul_28), kwargs = {})
#   %sum_2 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_46, [0, 1]), kwargs = {})
#   %add_13 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%tangents_3, %mul_45), kwargs = {})
#   %view_40 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_19, [128, 1024, 12]), kwargs = {})
#   %convert_element_type_90 : Tensor "f32[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_40, torch.float32), kwargs = {})
#   %full_default : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024, 384], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %slice_scatter_default : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default, %convert_element_type_90, 2, 0, 12), kwargs = {})
#   %view_48 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_21, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_96 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_48, torch.float32), kwargs = {})
#   %add_14 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %convert_element_type_96), kwargs = {})
#   %mul_52 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_14, 0.5), kwargs = {})
#   %mul_53 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_52, %primals_26), kwargs = {})
#   %mul_55 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %mul_53), kwargs = {})
#   %sum_4 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_55, [2], True), kwargs = {})
#   %mul_56 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %sum_4), kwargs = {})
#   %sub_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_53, %mul_56), kwargs = {})
#   %mul_57 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_2, %rsqrt_4), kwargs = {})
#   %mul_58 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_52, %mul_28), kwargs = {})
#   %sum_5 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_58, [0, 1]), kwargs = {})
#   %add_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_13, %mul_57), kwargs = {})
#   %select_12 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_25, 0, 0), kwargs = {})
#   %unsqueeze_18 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_12, 0), kwargs = {})
#   %unsqueeze_19 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_18, 1), kwargs = {})
#   %mul_60 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %unsqueeze_19), kwargs = {})
#   %unsqueeze_16 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_21, 0), kwargs = {})
#   %unsqueeze_17 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_16, 1), kwargs = {})
#   %mul_62 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_60, %unsqueeze_17), kwargs = {})
#   %convert_element_type_99 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_62, torch.bfloat16), kwargs = {})
#   %unsqueeze_14 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_20, 0), kwargs = {})
#   %unsqueeze_15 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_14, 1), kwargs = {})
#   %mul_64 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_60, %unsqueeze_15), kwargs = {})
#   %convert_element_type_100 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_64, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/6g/c6gd6idssfv5cfnq535fxatzbvpcmmnx4phqkwv66qrnda2476dx.py
...
#   where_4 => where_4
# Graph fragment:
#   %mm_8 : Tensor "bf16[131072, 1536][1536, 1]cuda:6" = PlaceHolder[target=mm_8]
#   %mm_23 : Tensor "bf16[131072, 1536][1536, 1]cuda:6" = PlaceHolder[target=mm_23]
#   %view_50 : Tensor "bf16[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_23, [128, 1024, 1536]), kwargs = {})
#   %convert_element_type_105 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_50, torch.float32), kwargs = {})
#   %view_21 : Tensor "bf16[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_8, [128, 1024, 1536]), kwargs = {})
#   %convert_element_type_40 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_21, torch.float32), kwargs = {})
#   %gt_1 : Tensor "b8[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.gt.Scalar](args = (%convert_element_type_40, 0), kwargs = {})
#   %mul_23 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_40, 0.5), kwargs = {})
#   %where_1 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt_1, %convert_element_type_40, %mul_23), kwargs = {})
#   %pow_11 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%where_1, 1.0), kwargs = {})
#   %mul_66 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%pow_11, 2.0), kwargs = {})
#   %mul_67 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_105, %mul_66), kwargs = {})
#   %mul_68 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_67, 0.5), kwargs = {})
#   %where_4 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt_1, %mul_67, %mul_68), kwargs = {})
#   %convert_element_type_111 : Tensor "bf16[128, 1024, 1536][1572864, 1536, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_4, torch.bfloat16), kwargs = {})
...
@triton_heuristics.pointwise(
    size_hints={'x': 268435456}, 
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*bf16', 'in_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qd/cqd5tfxhhf6crtvdkuiqmoy2pwkll4ml45x2mxy6gtvswf2hbw5i.py
...
#   rms_norm_2 => mul_15
# Graph fragment:
#   %primals_15 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_15]
#   %add_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_4]
#   %primals_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=primals_3]
#   %rsqrt_2 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6" = PlaceHolder[target=rsqrt_2]
#   %primals_1 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_1]
#   %primals_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=primals_2]
#   %rsqrt : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6" = PlaceHolder[target=rsqrt]
#   %select_6 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_15, 0, 0), kwargs = {})
#   %unsqueeze_9 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_6, 0), kwargs = {})
#   %unsqueeze_10 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_9, 1), kwargs = {})
#   %mul_13 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_10, %add_4), kwargs = {})
#   %select_7 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_15, 0, 1), kwargs = {})
#   %unsqueeze_11 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_7, 0), kwargs = {})
#   %unsqueeze_12 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_11, 1), kwargs = {})
#   %mul_14 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_12, %primals_3), kwargs = {})
#   %add_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_13, %mul_14), kwargs = {})
#   %mul_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_5, %rsqrt_2), kwargs = {})
#   %select : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_1, 0, 0), kwargs = {})
#   %unsqueeze : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select, 0), kwargs = {})
#   %unsqueeze_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze, 1), kwargs = {})
#   %mul : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %primals_2), kwargs = {})
#   %select_1 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_1, 0, 1), kwargs = {})
#   %unsqueeze_2 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_1, 0), kwargs = {})
#   %unsqueeze_3 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_2, 1), kwargs = {})
#   %mul_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_3, %primals_3), kwargs = {})
#   %add : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %mul_1), kwargs = {})
#   %mul_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add, %rsqrt), kwargs = {})
#   return %mul_15,%mul_2
...
@triton_heuristics.pointwise(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*fp32', 'in_ptr5': '*fp32', 'in_ptr6': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/7e/c7eln7esibvzof6a5rrvsqmyrs77evbvvi2dnvdgtj3dxwfjxbur.py
...
#   view_65 => view_65
# Graph fragment:
#   %mul_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=mul_15]
#   %mm_25 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_25]
#   %primals_22 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_22]
#   %mm_29 : Tensor "bf16[131072, 12][12, 1]cuda:6" = PlaceHolder[target=mm_29]
#   %mm_31 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_31]
#   %primals_16 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_16]
#   %add_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_15]
#   %primals_25 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_25]
#   %sum_10 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:6" = PlaceHolder[target=sum_10]
#   %rsqrt_2 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6" = PlaceHolder[target=rsqrt_2]
#   %sum_13 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:6" = PlaceHolder[target=sum_13]
#   %add_19 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_19]
#   %primals_15 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_15]
#   %primals_11 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_11]
#   %primals_10 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_10]
#   %full_default : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024, 384], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %select_12 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_25, 0, 0), kwargs = {})
#   %unsqueeze_18 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_12, 0), kwargs = {})
#   %unsqueeze_19 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_18, 1), kwargs = {})
#   %mul_60 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %unsqueeze_19), kwargs = {})
#   %view_52 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_25, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_116 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_52, torch.float32), kwargs = {})
#   %mul_69 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_116, 0.5773502691896258), kwargs = {})
#   %mul_70 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_69, %primals_22), kwargs = {})
#   %select_6 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_15, 0, 0), kwargs = {})
#   %unsqueeze_9 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_6, 0), kwargs = {})
#   %unsqueeze_10 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_9, 1), kwargs = {})
#   %mul_72 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %mul_70), kwargs = {})
#   %sum_10 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_72, [2], True), kwargs = {})
#   %div_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_15, 384), kwargs = {})
#   %mul_73 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_2, %sum_10), kwargs = {})
#   %sub_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_70, %mul_73), kwargs = {})
#   %mul_74 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_3, %rsqrt_2), kwargs = {})
#   %mul_75 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_69, %mul_15), kwargs = {})
#   %sum_11 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_75, [0, 1]), kwargs = {})
#   %add_17 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_60, %mul_74), kwargs = {})
#   %view_57 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_29, [128, 1024, 12]), kwargs = {})
#   %convert_element_type_131 : Tensor "f32[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_57, torch.float32), kwargs = {})
#   %slice_scatter_default_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default, %convert_element_type_131, 2, 0, 12), kwargs = {})
#   %view_65 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_31, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_137 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_65, torch.float32), kwargs = {})
#   %add_18 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default_2, %convert_element_type_137), kwargs = {})
#   %mul_81 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_18, 0.5773502691896258), kwargs = {})
#   %mul_82 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_81, %primals_16), kwargs = {})
#   %mul_84 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %mul_82), kwargs = {})
#   %sum_13 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_84, [2], True), kwargs = {})
#   %mul_85 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_2, %sum_13), kwargs = {})
#   %sub_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_82, %mul_85), kwargs = {})
#   %mul_86 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_5, %rsqrt_2), kwargs = {})
#   %mul_87 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_81, %mul_15), kwargs = {})
#   %sum_14 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_87, [0, 1]), kwargs = {})
#   %add_19 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_17, %mul_86), kwargs = {})
#   %mul_89 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %unsqueeze_10), kwargs = {})
#   %unsqueeze_7 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_11, 0), kwargs = {})
#   %unsqueeze_8 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_7, 1), kwargs = {})
#   %mul_91 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_89, %unsqueeze_8), kwargs = {})
#   %convert_element_type_140 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_91, torch.bfloat16), kwargs = {})
#   %unsqueeze_5 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_10, 0), kwargs = {})
#   %unsqueeze_6 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_5, 1), kwargs = {})
#   %mul_93 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_89, %unsqueeze_6), kwargs = {})
#   %convert_element_type_141 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_93, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qm/cqmeen5hhxebz66mwqm56lmdqozje27ktirmqmd5e6kau2borybz.py
...
#   %add_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_15]
#   %primals_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=primals_3]
#   %add_9 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_9]
#   %primals_25 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_25]
#   %mm_9 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_9]
#   %mm_7 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_7]
#   %add_19 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_19]
#   %add_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_4]
#   %primals_15 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_15]
#   %mm_4 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_4]
#   %mm_2 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_2]
#   %mul_59 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %primals_3), kwargs = {})
#   %sum_6 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_59, [0, 1], True), kwargs = {dtype: torch.float32})
#   %select_12 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_25, 0, 0), kwargs = {})
#   %unsqueeze_18 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_12, 0), kwargs = {})
#   %unsqueeze_19 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_18, 1), kwargs = {})
#   %mul_60 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %unsqueeze_19), kwargs = {})
#   %mul_61 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %add_9), kwargs = {})
#   %sum_7 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_61, [0, 1], True), kwargs = {dtype: torch.float32})
#   %view_23 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_9, [128, 1024, 384]), kwargs = {})
#   %mul_63 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_60, %view_23), kwargs = {})
#   %sum_8 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_63, [0, 1], True), kwargs = {dtype: torch.float32})
#   %view_19 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_7, [128, 1024, 384]), kwargs = {})
#   %mul_65 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_60, %view_19), kwargs = {})
#   %sum_9 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_65, [0, 1], True), kwargs = {dtype: torch.float32})
#   %select_6 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_15, 0, 0), kwargs = {})
#   %unsqueeze_9 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_6, 0), kwargs = {})
#   %unsqueeze_10 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_9, 1), kwargs = {})
#   %mul_88 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %primals_3), kwargs = {})
#   %sum_15 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_88, [0, 1], True), kwargs = {dtype: torch.float32})
#   %mul_89 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %unsqueeze_10), kwargs = {})
#   %mul_90 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %add_4), kwargs = {})
#   %sum_16 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_90, [0, 1], True), kwargs = {dtype: torch.float32})
#   %view_11 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_4, [128, 1024, 384]), kwargs = {})
#   %mul_92 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_89, %view_11), kwargs = {})
#   %sum_17 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_92, [0, 1], True), kwargs = {dtype: torch.float32})
#   %view_7 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_2, [128, 1024, 384]), kwargs = {})
#   %mul_94 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_89, %view_7), kwargs = {})
#   %sum_18 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_94, [0, 1], True), kwargs = {dtype: torch.float32})
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*bf16', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*bf16', 'in_ptr6': '*fp32', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*bf16', 'in_ptr10': '*bf16', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*fp32', 'out_ptr3': '*fp32', 'out_ptr4': '*fp32', 'out_ptr5': '*fp32', 'out_ptr6': '*fp32', 'out_ptr7': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]], (17,): [['tt.divisibility', 16]], (18,): [['tt.divisibility', 16]], (19,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/a5/ca52jea5amql6rvgla3b67dc3nt37bdvnsc3b2eo65qosjjbnphi.py
# Topologically Sorted Source Nodes: [mul_59, sum_6], Original ATen: [aten.mul, aten.sum]
# Source node to ATen node mapping:
#   mul_59 => mul_59
#   sum_6 => sum_6
# Graph fragment:
#   %buf28 : Tensor "f32[1, 1, 384, 349][134016, 134016, 1, 384]cuda:6" = PlaceHolder[target=buf28]
#   %mul_59 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %primals_3), kwargs = {})
#   %sum_6 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_59, [0, 1], True), kwargs = {dtype: torch.float32})
#   return %sum_6
...
@triton_heuristics.reduction(
    ...
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/cb/ccb2horrppyuywafgt2gvt55l4pgyuutxybbtmtfh5qtya7rvzin.py
...
#   squeeze_4 => squeeze_4
# Graph fragment:
#   %sum_6 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6" = PlaceHolder[target=sum_6]
#   %sum_7 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6" = PlaceHolder[target=sum_7]
#   %squeeze_1 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%sum_6, 1), kwargs = {})
#   %squeeze_2 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%squeeze_1, 0), kwargs = {})
#   %full_default_1 : Tensor "f32[2, 384][384, 1]cuda:6"[num_users=6] = call_function[target=torch.ops.aten.full.default](args = ([2, 384], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %select_scatter_default : Tensor "f32[2, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select_scatter.default](args = (%full_default_1, %squeeze_2, 0, 1), kwargs = {})
#   %squeeze_3 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%sum_7, 1), kwargs = {})
#   %squeeze_4 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%squeeze_3, 0), kwargs = {})
#   %select_scatter_default_1 : Tensor "f32[2, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select_scatter.default](args = (%full_default_1, %squeeze_4, 0, 0), kwargs = {})
#   %add_16 : Tensor "f32[2, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%select_scatter_default, %select_scatter_default_1), kwargs = {})
#   return %add_16
...
@triton_heuristics.pointwise(
    size_hints={'x': 1024}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'out_ptr0': '*fp32', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ys/cyszauvewlycj3e4qwbraauorrvfjgmvvralzuhrgg3tdysg3d66.py
...
#   view_82 => view_82
# Graph fragment:
#   %mul_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=mul_2]
#   %mm_35 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_35]
#   %primals_12 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_12]
#   %mm_39 : Tensor "bf16[131072, 12][12, 1]cuda:6" = PlaceHolder[target=mm_39]
#   %mm_41 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_41]
#   %primals_4 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_4]
#   %add_19 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_19]
#   %primals_15 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_15]
#   %sum_19 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:6" = PlaceHolder[target=sum_19]
#   %rsqrt : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6" = PlaceHolder[target=rsqrt]
#   %sum_22 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:6" = PlaceHolder[target=sum_22]
#   %add_23 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=add_23]
#   %primals_1 : Tensor "f32[2, 384][384, 1]cuda:6" = PlaceHolder[target=primals_1]
#   %full_default : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024, 384], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:6, pin_memory: False})
#   %select_6 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_15, 0, 0), kwargs = {})
#   %unsqueeze_9 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_6, 0), kwargs = {})
#   %unsqueeze_10 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_9, 1), kwargs = {})
#   %mul_89 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %unsqueeze_10), kwargs = {})
#   %view_69 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_35, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_157 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_69, torch.float32), kwargs = {})
#   %mul_98 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_157, 0.7071067811865475), kwargs = {})
#   %mul_99 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_98, %primals_12), kwargs = {})
#   %select : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_1, 0, 0), kwargs = {})
#   %unsqueeze : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select, 0), kwargs = {})
#   %unsqueeze_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze, 1), kwargs = {})
#   %mul_101 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_2, %mul_99), kwargs = {})
#   %sum_19 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_101, [2], True), kwargs = {})
#   %div_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_2, 384), kwargs = {})
#   %mul_102 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_4, %sum_19), kwargs = {})
#   %sub_6 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_99, %mul_102), kwargs = {})
#   %mul_103 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_6, %rsqrt), kwargs = {})
#   %mul_104 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_98, %mul_2), kwargs = {})
#   %sum_20 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_104, [0, 1]), kwargs = {})
#   %add_21 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_89, %mul_103), kwargs = {})
#   %view_74 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_39, [128, 1024, 12]), kwargs = {})
#   %convert_element_type_172 : Tensor "f32[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_74, torch.float32), kwargs = {})
#   %slice_scatter_default_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default, %convert_element_type_172, 2, 0, 12), kwargs = {})
#   %view_82 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_41, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_178 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_82, torch.float32), kwargs = {})
#   %add_22 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default_4, %convert_element_type_178), kwargs = {})
#   %mul_110 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_22, 0.7071067811865475), kwargs = {})
#   %mul_111 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_110, %primals_4), kwargs = {})
#   %mul_113 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_2, %mul_111), kwargs = {})
#   %sum_22 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_113, [2], True), kwargs = {})
#   %mul_114 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_4, %sum_22), kwargs = {})
#   %sub_8 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_111, %mul_114), kwargs = {})
#   %mul_115 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_8, %rsqrt), kwargs = {})
#   %mul_116 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_110, %mul_2), kwargs = {})
#   %sum_23 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_116, [0, 1]), kwargs = {})
#   %add_23 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_21, %mul_115), kwargs = {})
#   %mul_118 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_23, %unsqueeze_1), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sj/csjtzyvwjvdgd3ziyzoezrxrgrvqrbgwyn7lezz64j3qfsitaqwp.py
...
#   %primals_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=primals_3]
#   %primals_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=primals_2]
#   %mul_117 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_23, %primals_3), kwargs = {})
#   %sum_24 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_117, [0, 1], True), kwargs = {dtype: torch.float32})
#   %mul_119 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_23, %primals_2), kwargs = {})
#   %sum_25 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_119, [0, 1], True), kwargs = {dtype: torch.float32})
...
@triton_heuristics.reduction(
    ...
    reduction_hint=ReductionHint.OUTER,
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*bf16', 'in_ptr2': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=6, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]]}]},
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(6):
            ...
            triton_poi_fused_mm_0.run(view_27, buf10, 2097152, stream=stream6)
            del view_27
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_mm_0.run(view_15, buf52, 2097152, stream=stream6)
            del view_15
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_mm_0.run(view_3, buf94, 2097152, stream=stream6)
            del view_3
            ...
            # Topologically Sorted Source Nodes: [view_37, view_38, transpose_11, mul_47, linear_11, mul_19, sigmoid_2, getitem_30, mul_48, sum_3, convert_element_type_82, squeeze, convert_element_type_83, convert_element_type_84, sub_1, mul_49, mul_50, convert_element_type_85, mul_51, permute_44, _scaled_dot_product_flash_attention_backward], Original ATen: [aten.view, aten.transpose, aten.mul, aten._unsafe_view, aten.sigmoid, aten.unsqueeze, aten.sum, aten._to_copy, aten.squeeze, aten.sigmoid_backward, aten._scaled_dot_product_flash_attention_backward]
            stream6 = get_raw_stream(6)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_mul_sigmoid_sigmoid_backward_squeeze_sum_transpose_unsqueeze_view_1.run(buf7, getitem_24, mm_11, buf14, buf9, 1048576, 48, stream=stream6)
            del buf7
            del mm_11
            ...
            # Topologically Sorted Source Nodes: [slice_tensor_2, convert_element_type_91], Original ATen: [aten.mm, aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_mm_2.run(buf11, buf13, 96, stream=stream6)
            del buf11
            ...
            # Topologically Sorted Source Nodes: [linear_13, leaky_relu_2, pow_10, mul_37, mul_38, mul_39, where_3, convert_element_type_70], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten.mul, aten.leaky_relu_backward]
            stream6 = get_raw_stream(6)
            triton_poi_fused__unsafe_view_leaky_relu_leaky_relu_backward_mul_pow_3.run(buf0, tangents_1, 201326592, stream=stream6)
            del tangents_1
            ...
            # Topologically Sorted Source Nodes: [permute_45, permute_46, permute_47, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused_copy_slice_transpose_4.run(buf18, buf20, 150994944, stream=stream6)
            # Topologically Sorted Source Nodes: [permute_45, permute_46, permute_47, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_bwd_kernel_0.run(reinterpret_tensor(buf16, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf17, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), view_26, buf20, select_3, select_5, 2097152, 1, 1, stream=stream6)
            del view_26
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_mul_select_slice_backward_unsqueeze_view_5.run(add_10, rsqrt_4, buf2, primals_32, buf12, buf23, primals_26, tangents_3, primals_25, primals_21, primals_20, buf27, buf37, buf47, workspace_0, 131072, 384, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_mul_sigmoid_sigmoid_backward_squeeze_sum_transpose_unsqueeze_view_1.run(buf49, getitem_13, mm_6, buf56, buf51, 1048576, 48, stream=stream6)
            del buf49
            del mm_6
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_mm_2.run(buf53, buf55, 96, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_copy_slice_transpose_4.run(buf60, buf62, 150994944, stream=stream6)
            # Topologically Sorted Source Nodes: [permute_70, permute_71, permute_72, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_bwd_kernel_0.run(reinterpret_tensor(buf58, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf59, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), view_14, buf62, select_3, select_5, 2097152, 1, 1, stream=stream6)
            del view_14
            ...
            # Topologically Sorted Source Nodes: [view_50, convert_element_type_105, linear_8, leaky_relu_1, pow_11, mul_66, mul_67, mul_68, where_4, convert_element_type_111], Original ATen: [aten.view, aten._to_copy, aten._unsafe_view, aten.leaky_relu, aten.pow, aten.mul, aten.leaky_relu_backward]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_leaky_relu_backward_mul_pow_view_6.run(buf40, buf39, 201326592, stream=stream6)
            del buf39
            ...
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, rms_norm_2, getitem, getitem_1, mul, getitem_2, getitem_3, mul_1, add, rms_norm], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._fused_rms_norm]
            stream6 = get_raw_stream(6)
            triton_poi_fused__fused_rms_norm_add_mul_select_unsqueeze_7.run(primals_15, add_4, primals_3, rsqrt_2, primals_1, primals_2, rsqrt, buf43, buf85, 50331648, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm_backward__to_copy_add_mul_select_slice_backward_unsqueeze_view_8.run(buf43, buf42, primals_22, buf54, buf65, primals_16, buf27, primals_25, rsqrt_2, primals_15, primals_11, primals_10, buf69, buf79, buf89, workspace_1, 131072, 384, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [mul_59, sum_6, getitem_22, getitem_23, mul_60, mul_61, sum_7, linear_9, mul_63, sum_8, linear_7, mul_65, sum_9, getitem_11, getitem_12, mul_88, sum_15, mul_89, mul_90, sum_16, linear_4, mul_92, sum_17, linear_2, mul_94, sum_18], Original ATen: [aten.mul, aten.sum, aten.select, aten.unsqueeze, aten._unsafe_view]
            stream6 = get_raw_stream(6)
            triton_red_fused__unsafe_view_mul_select_sum_unsqueeze_9.run(buf27, primals_3, add_9, primals_25, mm_9, mm_7, buf69, add_4, primals_15, mm_4, mm_2, buf28, buf30, buf33, buf35, buf70, buf72, buf75, buf77, 134016, 376, stream=stream6)
            del add_4
            del add_9
            del mm_2
            del mm_4
            ...
            # Topologically Sorted Source Nodes: [mul_59, sum_6], Original ATen: [aten.mul, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf28, buf29, 384, 349, stream=stream6)
            del buf28
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf30, buf31, 384, 349, stream=stream6)
            del buf30
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf33, buf34, 384, 349, stream=stream6)
            del buf33
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf35, buf36, 384, 349, stream=stream6)
            del buf35
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf70, buf71, 384, 349, stream=stream6)
            del buf70
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf72, buf73, 384, 349, stream=stream6)
            del buf72
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf75, buf76, 384, 349, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf77, buf78, 384, 349, stream=stream6)
            buf32 = empty_strided_cuda((2, 384), (384, 1), torch.float32)
            # Topologically Sorted Source Nodes: [squeeze_1, squeeze_2, full_default_1, squeeze_3, squeeze_4, add_16], Original ATen: [aten.squeeze, aten.select_backward, aten.add]
            stream6 = get_raw_stream(6)
            triton_poi_fused_add_select_backward_squeeze_11.run(buf29, buf31, buf32, 768, stream=stream6)
            del buf29
            del buf31
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_add_select_backward_squeeze_11.run(buf71, buf73, buf74, 768, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_mul_sigmoid_sigmoid_backward_squeeze_sum_transpose_unsqueeze_view_1.run(buf91, getitem_2, mm_1, buf98, buf93, 1048576, 48, stream=stream6)
            del buf91
            del mm_1
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_mm_2.run(buf95, buf97, 96, stream=stream6)
            del buf95
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_copy_slice_transpose_4.run(buf102, buf104, 150994944, stream=stream6)
            del buf102
            # Topologically Sorted Source Nodes: [permute_95, permute_96, permute_97, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_bwd_kernel_0.run(reinterpret_tensor(buf100, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf101, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), view_2, buf104, select_3, select_5, 2097152, 1, 1, stream=stream6)
            del buf100
            del select_3
            del select_5
            del view_2
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_leaky_relu_backward_mul_pow_view_6.run(buf82, buf81, 201326592, stream=stream6)
            del buf81
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm_backward__to_copy_add_mul_select_slice_backward_unsqueeze_view_12.run(buf111, buf85, buf84, primals_12, buf96, buf107, primals_4, primals_15, rsqrt, primals_1, buf114, workspace_2, 131072, 384, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [mul_117, sum_24, mul_119, sum_25], Original ATen: [aten.mul, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_13.run(buf111, primals_3, primals_2, buf112, buf115, 134016, 376, stream=stream6)
            del buf111
            del primals_2
            del primals_3
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf112, buf113, 384, 349, stream=stream6)
            del buf112
            buf116 = buf71; del buf71  # reuse
            # Topologically Sorted Source Nodes: [mul_119, sum_25], Original ATen: [aten.mul, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_10.run(buf115, buf116, 384, 349, stream=stream6)
            del buf115
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_add_select_backward_squeeze_11.run(buf113, buf116, buf117, 768, stream=stream6)
            del buf113
            del buf116
...
def get_args():
    ...
    primals_1 = rand_strided((2, 384), (384, 1), device='cuda:6', dtype=torch.float32)
    primals_2 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.float32)
    primals_3 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_4 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_9 = rand_strided((384, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_10 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_11 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_12 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_15 = rand_strided((2, 384), (384, 1), device='cuda:6', dtype=torch.float32)
    primals_16 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_19 = rand_strided((384, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_20 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_21 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_22 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_25 = rand_strided((2, 384), (384, 1), device='cuda:6', dtype=torch.float32)
    primals_26 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    primals_29 = rand_strided((384, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    primals_32 = rand_strided((384, ), (1, ), device='cuda:6', dtype=torch.float32)
    rsqrt = rand_strided((128, 1024, 1), (1024, 1, 1), device='cuda:6', dtype=torch.float32)
    view = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    view_2 = rand_strided((128, 1024, 24, 48), (1179648, 1152, 48, 1), device='cuda:6', dtype=torch.bfloat16)
    select_3 = rand_strided((1024, 24), (24, 1), device='cuda:6', dtype=torch.bfloat16)
    select_5 = rand_strided((1024, 24), (24, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_3 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_4 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_5 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    getitem_2 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    getitem_3 = rand_strided((128, 8, 1024), (8192, 1024, 1), device='cuda:6', dtype=torch.float32)
    getitem_8 = rand_strided((2, ), (1, ), device='cuda:6', dtype=torch.uint64)
    getitem_9 = rand_strided((), (), device='cuda:6', dtype=torch.uint64)
    view_3 = rand_strided((131072, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_1 = rand_strided((131072, 8), (8, 1), device='cuda:6', dtype=torch.bfloat16)
    view_6 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_2 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    view_8 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_3 = rand_strided((131072, 1536), (1536, 1), device='cuda:6', dtype=torch.bfloat16)
    view_10 = rand_strided((131072, 1536), (1536, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_4 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    add_4 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.float32)
    rsqrt_2 = rand_strided((128, 1024, 1), (1024, 1, 1), device='cuda:6', dtype=torch.float32)
    view_12 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    view_14 = rand_strided((128, 1024, 24, 48), (1179648, 1152, 48, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_14 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_15 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_16 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    getitem_13 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    getitem_14 = rand_strided((128, 8, 1024), (8192, 1024, 1), device='cuda:6', dtype=torch.float32)
    getitem_19 = rand_strided((2, ), (1, ), device='cuda:6', dtype=torch.uint64)
    getitem_20 = rand_strided((), (), device='cuda:6', dtype=torch.uint64)
    view_15 = rand_strided((131072, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_6 = rand_strided((131072, 8), (8, 1), device='cuda:6', dtype=torch.bfloat16)
    view_18 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_7 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    view_20 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_8 = rand_strided((131072, 1536), (1536, 1), device='cuda:6', dtype=torch.bfloat16)
    view_22 = rand_strided((131072, 1536), (1536, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_9 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    add_9 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.float32)
    add_10 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.float32)
    rsqrt_4 = rand_strided((128, 1024, 1), (1024, 1, 1), device='cuda:6', dtype=torch.float32)
    view_24 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    view_26 = rand_strided((128, 1024, 24, 48), (1179648, 1152, 48, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_25 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_26 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_27 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    getitem_24 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    getitem_25 = rand_strided((128, 8, 1024), (8192, 1024, 1), device='cuda:6', dtype=torch.float32)
    getitem_30 = rand_strided((2, ), (1, ), device='cuda:6', dtype=torch.uint64)
    getitem_31 = rand_strided((), (), device='cuda:6', dtype=torch.uint64)
    view_27 = rand_strided((131072, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_11 = rand_strided((131072, 8), (8, 1), device='cuda:6', dtype=torch.bfloat16)
    view_30 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    view_32 = rand_strided((131072, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    mm_13 = rand_strided((131072, 1536), (1536, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_34 = rand_strided((1536, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_42 = rand_strided((8, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_51 = rand_strided((1152, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_55 = rand_strided((384, 1536), (1536, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_59 = rand_strided((1536, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_67 = rand_strided((8, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_76 = rand_strided((1152, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_80 = rand_strided((384, 1536), (1536, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_84 = rand_strided((1536, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_92 = rand_strided((8, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_101 = rand_strided((1152, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    tangents_1 = rand_strided((128, 1024, 1536), (1572864, 1536, 1), device='cuda:6', dtype=torch.float32)
    tangents_2 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.bfloat16)
    tangents_3 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.float32)
