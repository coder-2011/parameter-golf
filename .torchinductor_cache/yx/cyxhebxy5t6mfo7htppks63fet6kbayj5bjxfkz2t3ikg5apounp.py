...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pe/cpefa3s7gbbgc5erzkbb7w5vmyqrvzemkic4qmpot7dlbsdvpmml.py
...
#   %primals_2 : Tensor "bf16[196608, 128][128, 1]cuda:6" = PlaceHolder[target=primals_2]
...
def get_args():
    ...
    primals_2 = rand_strided((196608, 128), (128, 1), device='cuda:6', dtype=torch.bfloat16)
