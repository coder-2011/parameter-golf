...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2w/c2wfc57cgld57psbfysdlqgg7z2hrzims5vehjow46n773bblby5.py
...
#   %mul : Tensor "i64[512, 999, 8][7992, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze, %lift_fresh_copy), kwargs = {})
...
#   %mul_1 : Tensor "i64[512, 999, 8][7992, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %lift_fresh_copy_1), kwargs = {})
#   %bitwise_xor : Tensor "i64[512, 999, 8][7992, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.bitwise_xor.Tensor](args = (%mul, %mul_1), kwargs = {})
#   return %bitwise_xor
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/uf/cufafadc4l2vsq7x5mn2zsrlyisd7xsqtyvgsdkpzyx5r74aszlp.py
...
#   sum_1 => sum_1
# Graph fragment:
#   %bitwise_xor : Tensor "i64[512, 999, 8][8000, 8, 1]cuda:6" = PlaceHolder[target=bitwise_xor]
#   %arg6_1 : Tensor "bf16[65536, 128][128, 1]cuda:6" = PlaceHolder[target=arg6_1]
#   %sum_1 : Tensor "f32[512, 1000, 128][128000, 128, 1]cuda:6" = PlaceHolder[target=sum_1]
#   %select : Tensor "i64[512, 8][8000, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%empty, 1, 0), kwargs = {})
...
#   %copy : Tensor "i64[512, 8][8000, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%select, %full_default), kwargs = {})
#   %select_scatter_default : Tensor "i64[512, 1000, 8][8000, 8, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.select_scatter.default](args = (%empty, %copy, 1, 0), kwargs = {})
#   %slice_8 : Tensor "i64[512, 999, 8][8000, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%select_scatter_default, 1, 1, 9223372036854775807), kwargs = {})
#   %remainder : Tensor "i64[512, 999, 8][7992, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 8191), kwargs = {})
#   %add : Tensor "i64[512, 999, 8][7992, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%remainder, 1), kwargs = {})
#   %copy_1 : Tensor "i64[512, 999, 8][8000, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_8, %add), kwargs = {})
#   %slice_scatter_default : Tensor "i64[512, 1000, 8][8000, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%select_scatter_default, %copy_1, 1, 1, 9223372036854775807), kwargs = {})
...
#   %add_1 : Tensor "i64[512, 1000, 8][8000, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %mul_2), kwargs = {})
#   %embedding_1 : Tensor "bf16[512, 1000, 8, 128][1024000, 1024, 128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%arg6_1, %add_1), kwargs = {})
...
#   %mul_3 : Tensor "f32[512, 1000, 128][128000, 128, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.3535533905932738), kwargs = {})
...
def triton_per_fused__to_copy_add_arange_copy_embedding_fill_lift_fresh_mul_remainder_select_slice_sum_1(in_ptr0, in_ptr1, out_ptr1, xnumel, r0_numel, XBLOCK : tl.constexpr):
    ...
    tmp30 = tl.load(in_ptr1 + (x0 + 128*tmp28), None).to(tl.float32)
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2j/c2jo4nmis2pgcjrszeevb5qjw2vih74hstuqoc6ullpxtq3kx3gj.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ut/cutv76n6ktttcbalol53bxwwotqik5mdwdolqoyuvvauwdbcxbb6.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/p2/cp26xrxpufyxsgu3gnxxd3v5gybxn5pvyhrjff4yuhz5dffuyjap.py
...
#   %buf9 : Tensor "f32[512, 1000, 1][1000, 1, 512000]cuda:6" = PlaceHolder[target=buf9]
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tt/cttrv6al42lhh6bnigq4r4v6wm2tkfte5pihmlrqp2fe3vbrq4i6.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/m5/cm5unadyx42eansocy3pt2lmglmtvndalng6rezl337wvdsmiux7.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wx/cwx26rhkgekmbvfhhs6q23p3k7w5mzxsq6bq74mu4xc4asqnhpvl.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/su/csuvsozrm7wcpd4uj5cbck7qj7wmrklo25tcjfmvsbcv6hd7rg22.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/zm/czm2ugwdxpwbquon42u3m4otusquyi63yxuby3pgd55hjh4nwefn.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/fw/cfwdqlgb52rih2uy7d42lhgqn7driyvfktrkqllfg2o6nilgxid4.py
...
#   %buf30 : Tensor "f32[512, 1000, 1][1000, 1, 512000]cuda:6" = PlaceHolder[target=buf30]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(6):
            ...
            triton_poi_fused_bitwise_xor_lift_fresh_mul_slice_unsqueeze_0.run(arg4_1, buf1, 511488, 8, stream=stream6)
            buf3 = empty_strided_cuda((512, 1000, 128), (128000, 128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [setitem, setitem_1, remainder, add, arange, mul_2, add_1, embedding_1, sum_1, mul_3, linear], Original ATen: [aten.select, aten.lift_fresh, aten.fill, aten.slice, aten.remainder, aten.add, aten.copy, aten.arange, aten.mul, aten.embedding, aten.sum, aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_per_fused__to_copy_add_arange_copy_embedding_fill_lift_fresh_mul_remainder_select_slice_sum_1.run(buf1, arg6_1, buf3, 65536000, 8, stream=stream6)
            del arg6_1
            del buf1
            ...
            extern_kernels.mm(reinterpret_tensor(buf3, (512000, 128), (128, 1), 0), reinterpret_tensor(arg7_1, (128, 384), (1, 128), 0), out=buf4)
            del arg7_1
            del buf3
            buf5 = empty_strided_cuda((512, 1000, 384), (384000, 384, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [embedding], Original ATen: [aten.embedding]
            stream6 = get_raw_stream(6)
            triton_poi_fused_embedding_2.run(arg4_1, arg5_1, buf5, 512000, 384, stream=stream6)
            del arg5_1
            buf6 = empty_strided_cuda((384, ), (1, ), torch.bfloat16)
            # Topologically Sorted Source Nodes: [to_2], Original ATen: [aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_3.run(arg8_1, buf6, 384, stream=stream6)
            del arg8_1
            ...
            # Topologically Sorted Source Nodes: [to_6, sigmoid_1, getitem_8, sub, linear, linear_1, sigmoid, mul_4, to_5, mul_5, add_2, mul_7, zeros_like, getitem_10, cat, ne, to_7, unsqueeze, mul_6, mul_8, add_3, rms_norm, to_8], Original ATen: [aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.rsub, aten._unsafe_view, aten.view, aten.mul, aten.add, aten.zeros_like, aten.slice, aten.cat, aten.ne, aten._fused_rms_norm]
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_cat_mul_ne_rsub_sigmoid_slice_unsqueeze_view_zeros_like_4.run(arg11_1, buf5, buf4, buf7, arg10_1, arg4_1, arg12_1, buf8, buf10, 512000, 384, stream=stream6)
            del arg10_1
            del arg11_1
            del arg12_1
            del arg4_1
            ...
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf11, (512, 1000, 16, 48), (768000, 768, 48, 1), 0), buf12, buf13, reinterpret_tensor(arg0_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg1_1, (1000, 24), (24, 1), 0), 6144000, 1, 1, stream=stream6)
            buf16 = empty_strided_cuda((512, 4, 1000, 48), (192000, 48, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_11, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            stream6 = get_raw_stream(6)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_5.run(buf11, buf16, 98304000, stream=stream6)
            del buf11
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_11, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_6], Original ATen: [aten.slice, aten.clone]
            stream6 = get_raw_stream(6)
            triton_poi_fused_clone_slice_6.run(buf10, buf23, 6144000, stream=stream6)
            buf24 = empty_strided_cuda((512000, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_6, linear_3, to_10], Original ATen: [aten.slice, aten.clone, aten.view, aten._to_copy, aten.t, aten.mm]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_7.run(buf23, buf24, 6144000, stream=stream6)
            del buf23
            buf25 = empty_strided_cuda((8, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [to_10], Original ATen: [aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_8.run(arg14_1, buf25, 96, stream=stream6)
            del arg14_1
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_3, mul_9, sigmoid_2, getitem_15, mul_10], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream6 = get_raw_stream(6)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_9.run(buf27, buf26, 196608000, stream=stream6)
            del buf26
            ...
            # Topologically Sorted Source Nodes: [linear_4, add_4, rms_norm_1, to_12], Original ATen: [aten._unsafe_view, aten.add, aten._fused_rms_norm, aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_10.run(buf29, buf8, arg16_1, buf31, 512000, 384, stream=stream6)
            del arg16_1
...
def get_args():
    ...
    arg6_1 = rand_strided((65536, 128), (128, 1), device='cuda:6', dtype=torch.bfloat16)
