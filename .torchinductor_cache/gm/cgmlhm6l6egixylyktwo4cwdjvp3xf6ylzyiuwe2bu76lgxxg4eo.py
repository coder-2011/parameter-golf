...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/iy/ciyd3fvz3s6fyd3f6fdctt4xqnun4c45glaiweuo3kzivbqk5z2v.py
...
#   %add : Tensor "bf16[349, 1000, 384][384000, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_1, %arg3_1), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(5):
            ...
            buf0 = empty_strided_cuda((349000, 1536), (1536, 1), torch.bfloat16)
            buf1 = empty_strided_cuda((349000, 1536), (1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [reshape, triton_kernel_wrapper_mutation], Original ATen: [aten.view]
            stream5 = get_raw_stream(5)
            _leaky_relu_sq_matmul_kernel_0.run(reinterpret_tensor(arg1_1, (349000, 384), (384, 1), 0), arg2_1, buf0, buf1, 65448, 1, 1, stream=stream5)
            del arg1_1
            del arg2_1
            del buf0
            ...
            del arg0_1
            del buf1
            buf5 = reinterpret_tensor(buf4, (349, 1000, 384), (384000, 384, 1), 0); del buf4  # reuse
            # Topologically Sorted Source Nodes: [reshape_1, add], Original ATen: [aten.view, aten.add]
            stream5 = get_raw_stream(5)
            triton_poi_fused_add_view_0.run(buf5, arg3_1, 134016000, stream=stream5)
            del arg3_1
        return (buf5, )
...
def get_args():
    ...
    arg1_1 = rand_strided((349, 1000, 384), (384000, 384, 1), device='cuda:5', dtype=torch.bfloat16)
    arg2_1 = rand_strided((1536, 384), (384, 1), device='cuda:5', dtype=torch.bfloat16)
