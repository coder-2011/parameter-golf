...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wm/cwmtbts3ysiecqq2in3bgvggmy4odd5ws5lxsoeuggiyu7t6cutu.py
...
#   %add : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %mul_1), kwargs = {})
...
#   %rsqrt : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_1,), kwargs = {})
#   %mul_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add, %rsqrt), kwargs = {})
#   %mul_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_2, %primals_4), kwargs = {})
...
#   %mul_8 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_2, %primals_12), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tc/ctc3isu2tmnpnl62l6fyxf6viy6gvv726lr4uopm4xqgjdgsiv3p.py
...
# Graph fragment:
#   %primals_5 : Tensor "bf16[1152, 384][384, 1]cuda:2" = PlaceHolder[target=primals_5]
#   %convert_element_type_default_17 : Tensor "bf16[1152, 384][384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_5, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[384, 1152][1, 384]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_17, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/54/c54nm4ugnxkqka7dny6vcbwjuowzqjf7sowmmcy2xthzunyhdhgw.py
...
#   %view_2 : Tensor "bf16[128, 1024, 24, 48][1179648, 1152, 48, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.reshape.default](args = (%view_1, [128, 1024, 24, 48]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wr/cwrnwxmo6lqa4ohx5p5lyi3txkghmecjqdvctwiourh3xhc5x4nt.py
# Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten._to_copy, aten.t]
# Source node to ATen node mapping:
#   linear_1 => convert_element_type_5, permute_7
# Graph fragment:
#   %primals_8 : Tensor "f32[8, 12][12, 1]cuda:2" = PlaceHolder[target=primals_8]
#   %convert_element_type_5 : Tensor "bf16[8, 12][12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_8, torch.bfloat16), kwargs = {})
#   %permute_7 : Tensor "bf16[12, 8][1, 12]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_5, [1, 0]), kwargs = {})
#   return %permute_7
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dw/cdwjbamzyl5vrzv5xmedvk5ostefzi6hasm4fp5ovgys6laxickn.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gt/cgtnbxzst3o7234hhsusgytpg5u2xsrz5bx74kbqphfkpqa62dc6.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/x4/cx4koclj466mumuvaens33l4mswor7jqnoinhe6uhccwtlnmrpvz.py
...
# Graph fragment:
#   %primals_13 : Tensor "bf16[1024, 384][384, 1]cuda:2" = PlaceHolder[target=primals_13]
#   %convert_element_type_default_16 : Tensor "bf16[1024, 384][384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_13, torch.bfloat16), kwargs = {})
#   %permute_9 : Tensor "bf16[384, 1024][1, 384]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_16, [1, 0]), kwargs = {})
#   return %permute_9
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/lm/clmrjhp5w7om7owacmx4s6xbdecl276ymk2h4vyce3uq37zkjusg.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ea/ceawh3qvhujfzsrnbbgtvjvoh2beoatfmeknktkwaxmsagn3u7aw.py
...
#   %buf29 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:2" = PlaceHolder[target=buf29]
...
#   %add_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_3, %mul_12), kwargs = {})
...
#   %add_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_13, %mul_14), kwargs = {})
...
#   %rsqrt_2 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_6,), kwargs = {})
#   %mul_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_5, %rsqrt_2), kwargs = {})
#   %mul_16 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %primals_16), kwargs = {})
...
#   %mul_21 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %primals_22), kwargs = {})
...
@triton_heuristics.reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*bf16', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr', 'R0_BLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=2, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/er/cerqj4kvrbp53l6h2py33kcyh26d3vefk62mahuabzlnwkacei24.py
...
#   %mul_16 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %primals_16), kwargs = {})
#   %mul_17 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_16, 0.5773502691896258), kwargs = {})
#   %slice_4 : Tensor "f32[128, 1024, 12][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mul_17, 2, 0, 12), kwargs = {})
#   %clone_3 : Tensor "f32[128, 1024, 12][12288, 12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_4,), kwargs = {memory_format: torch.contiguous_format})
#   %convert_element_type_30 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%clone_3, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sl/csluhg5nf3vyvu5bepq35uxjrt2xgult3cbggz7qqeh5xqaf2zmp.py
...
#   %buf59 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:2" = PlaceHolder[target=buf59]
...
#   %add_9 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_8, %mul_25), kwargs = {})
...
#   %select_13 : Tensor "f32[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_25, 0, 1), kwargs = {})
...
#   %mul_27 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_21, %primals_3), kwargs = {})
#   %add_10 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_26, %mul_27), kwargs = {})
...
#   %rsqrt_4 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_11,), kwargs = {})
#   %mul_28 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %rsqrt_4), kwargs = {})
#   %mul_29 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %primals_26), kwargs = {})
...
#   %mul_34 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %primals_32), kwargs = {})
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=2, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qh/cqhoflvyglkavjwxvtmrpcccm4pam5n5hyvtm7r5v3yt46dr5ih6.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            triton_red_fused__fused_rms_norm__to_copy_add_mul_select_unsqueeze_0.run(buf1, primals_1, primals_2, primals_3, primals_4, primals_12, buf2, buf4, buf23, 131072, 384, stream=stream2)
            buf3 = empty_strided_cuda((384, 1152), (1, 384), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy, aten.t]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_1.run(primals_5, buf3, 442368, stream=stream2)
            del primals_5
            ...
            stream2 = get_raw_stream(2)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf5, (128, 1024, 24, 48), (1179648, 1152, 48, 1), 0), buf6, buf7, reinterpret_tensor(primals_6, (1024, 24), (24, 1), 0), reinterpret_tensor(primals_7, (1024, 24), (24, 1), 0), 2097152, 1, 1, stream=stream2)
            buf10 = empty_strided_cuda((128, 1024, 8, 48), (393216, 384, 48, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear, view, getitem, v], Original ATen: [aten._unsafe_view, aten.view, aten.slice, aten.clone]
            stream2 = get_raw_stream(2)
            triton_poi_fused__unsafe_view_clone_slice_view_2.run(buf5, buf10, 50331648, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [linear_1], Original ATen: [aten._to_copy, aten.t]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_3.run(primals_8, buf17, 96, stream=stream2)
            del primals_8
            buf18 = empty_strided_cuda((128, 1024, 12), (12288, 12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [rms_norm, mul_2, getitem_7, contiguous_3, linear_1], Original ATen: [aten._fused_rms_norm, aten.mul, aten.slice, aten.clone, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__fused_rms_norm__to_copy_clone_mul_slice_4.run(buf2, primals_4, buf18, 1572864, stream=stream2)
            del buf2
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_1, mul_3, sigmoid, getitem_8, mul_4], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream2 = get_raw_stream(2)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_5.run(buf12, buf19, buf20, 50331648, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_13, buf22, 393216, stream=stream2)
            del primals_13
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_14, buf25, 393216, stream=stream2)
            del primals_14
            buf26 = empty_strided_cuda((128, 1024, 1024), (1048576, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf24, buf26, 134217728, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [getitem, getitem_1, mul, getitem_2, getitem_3, mul_1, add, linear_2, getitem_9, getitem_10, linear_4, mul_6, add_1, mul_7, add_2, getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, rms_norm_2, mul_10, linear_5, rms_norm_3, mul_13, linear_8], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_red_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_8.run(buf30, primals_1, primals_2, primals_3, primals_10, buf21, primals_11, buf27, primals_15, primals_16, primals_22, buf28, buf31, buf33, buf52, 131072, 384, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_1.run(primals_17, buf32, 442368, stream=stream2)
            del primals_17
            ...
            stream2 = get_raw_stream(2)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf34, (128, 1024, 24, 48), (1179648, 1152, 48, 1), 0), buf35, buf36, reinterpret_tensor(primals_6, (1024, 24), (24, 1), 0), reinterpret_tensor(primals_7, (1024, 24), (24, 1), 0), 2097152, 1, 1, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__unsafe_view_clone_slice_view_2.run(buf34, buf39, 50331648, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_3.run(primals_18, buf46, 96, stream=stream2)
            del primals_18
            buf47 = empty_strided_cuda((128, 1024, 12), (12288, 12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [rms_norm_2, mul_10, getitem_18, contiguous_8, linear_6], Original ATen: [aten._fused_rms_norm, aten.mul, aten.slice, aten.clone, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__fused_rms_norm__to_copy_clone_mul_slice_9.run(buf31, primals_16, buf47, 1572864, stream=stream2)
            del buf31
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_5.run(buf41, buf48, buf49, 50331648, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_23, buf51, 393216, stream=stream2)
            del primals_23
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_6.run(primals_24, buf54, 393216, stream=stream2)
            del primals_24
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf53, buf55, 134217728, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, linear_7, getitem_20, getitem_21, linear_9, mul_14, add_4, mul_15, add_5, getitem_22, getitem_23, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_10.run(buf60, primals_15, buf28, primals_3, primals_20, buf50, primals_21, buf56, primals_25, primals_26, primals_32, buf57, buf58, buf62, buf80, 131072, 384, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_1.run(primals_27, buf61, 442368, stream=stream2)
            del primals_27
            ...
            stream2 = get_raw_stream(2)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf63, (128, 1024, 24, 48), (1179648, 1152, 48, 1), 0), buf64, buf65, reinterpret_tensor(primals_6, (1024, 24), (24, 1), 0), reinterpret_tensor(primals_7, (1024, 24), (24, 1), 0), 2097152, 1, 1, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__unsafe_view_clone_slice_view_2.run(buf63, buf68, 50331648, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_t_3.run(primals_28, buf75, 96, stream=stream2)
            del primals_28
            buf76 = empty_strided_cuda((128, 1024, 12), (12288, 12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [rms_norm_4, mul_18, getitem_29, contiguous_13, linear_11], Original ATen: [aten._fused_rms_norm, aten.mul, aten.slice, aten.clone, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__fused_rms_norm__to_copy_clone_mul_slice_11.run(buf58, buf60, primals_26, buf76, 131072, 12, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_5.run(buf70, buf77, buf78, 50331648, stream=stream2)
...
def get_args():
    ...
    primals_5 = rand_strided((1152, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_6 = rand_strided((1, 1024, 1, 24), (24576, 24, 24, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_7 = rand_strided((1, 1024, 1, 24), (24576, 24, 24, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_8 = rand_strided((8, 12), (12, 1), device='cuda:2', dtype=torch.float32)
    ...
    primals_13 = rand_strided((1024, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_14 = rand_strided((384, 1024), (1024, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    primals_17 = rand_strided((1152, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_18 = rand_strided((8, 12), (12, 1), device='cuda:2', dtype=torch.float32)
    ...
    primals_23 = rand_strided((1024, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_24 = rand_strided((384, 1024), (1024, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    primals_27 = rand_strided((1152, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_28 = rand_strided((8, 12), (12, 1), device='cuda:2', dtype=torch.float32)
    primals_29 = rand_strided((384, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_30 = rand_strided((384, ), (1, ), device='cuda:2', dtype=torch.float32)
    primals_31 = rand_strided((384, ), (1, ), device='cuda:2', dtype=torch.float32)
