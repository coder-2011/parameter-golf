...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/kl/cklbp37y65qgszrpduarj2mwft6czclpcq2vvvdxn6rmfos3gakq.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/z2/cz22yyqkouokutzltbw2pnvykudzk6zyohdwba3nhl64d4qopmhn.py
# Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy, aten.t]
# Source node to ATen node mapping:
#   linear => convert_element_type_default_17, permute
# Graph fragment:
#   %primals_5 : Tensor "bf16[1152, 384][384, 1]cuda:3" = PlaceHolder[target=primals_5]
#   %convert_element_type_default_17 : Tensor "bf16[1152, 384][384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_5, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[384, 1152][1, 384]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_17, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qj/cqjufftq7s6evkgqryn6uudrxd2g6uwmyijeuqcxkqnu4igml5rh.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gy/cgypzu4jym3hocxpidb6hzc65dy7afhj2xt3r7d35zo6bltdoec5.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/o5/co5tpww5u6a3zao2zm6ncbjvoq3l6ltsuuu7xw62sqdmsia4otky.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/cv/ccva3jy3hrkiylxvevm3chtvdrqhsi6jyovvk7suuoqv5fbh4krt.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ru/cruqruxrs2bds4v4mk27jebonyvahr56mzflmtr2a4wnhobmf4jd.py
# Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
# Source node to ATen node mapping:
#   linear_3 => convert_element_type_default_16, permute_9
# Graph fragment:
#   %primals_13 : Tensor "bf16[1024, 384][384, 1]cuda:3" = PlaceHolder[target=primals_13]
#   %convert_element_type_default_16 : Tensor "bf16[1024, 384][384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_13, torch.bfloat16), kwargs = {})
#   %permute_9 : Tensor "bf16[384, 1024][1, 384]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_16, [1, 0]), kwargs = {})
#   return %permute_9
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/44/c44hecd7kom4p742pw3l23vs4es3syoyysrldt37a3byaerwy7o5.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/7x/c7xjbetosn74k2joeziootyqi7ldzt26q6xik32pugl6trl4y3co.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/vc/cvcbeiqhzum2etefjsscj4keea5nnf4rlnjf5vyxpd5ztj6zxc7l.py
...
#   return %add_9,%add_10,%buf59,%rsqrt_4,%convert_element_type_50,%mul_35
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=3, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/j5/cj5rknn2fauia5rdofgtn5wrmarmsmgvnmrhcxyvm3gcgfqtoosh.py
...
class Runner:
    ...
    def call(self, args):
        ...
        assert_size_stride(primals_13, (1024, 384), (384, 1))
        assert_size_stride(primals_14, (384, 1024), (1024, 1))
        ...
        assert_size_stride(primals_23, (1024, 384), (384, 1))
        assert_size_stride(primals_24, (384, 1024), (1024, 1))
        ...
        with torch.cuda._DeviceGuard(3):
            ...
            buf22 = empty_strided_cuda((384, 1024), (1, 384), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_t_6.run(primals_13, buf22, 393216, stream=stream3)
            del primals_13
            buf24 = empty_strided_cuda((131072, 1024), (1024, 1), torch.bfloat16)
            ...
            buf25 = empty_strided_cuda((1024, 384), (1, 1024), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_4], Original ATen: [aten._to_copy, aten.t]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_t_6.run(primals_14, buf25, 393216, stream=stream3)
            del primals_14
            buf26 = empty_strided_cuda((128, 1024, 1024), (1048576, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf24, buf26, 134217728, stream=stream3)
            ...
            extern_kernels.mm(reinterpret_tensor(buf26, (131072, 1024), (1024, 1), 0), buf25, out=buf27)
            ...
            buf51 = empty_strided_cuda((384, 1024), (1, 384), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_8], Original ATen: [aten._to_copy, aten.t]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_t_6.run(primals_23, buf51, 393216, stream=stream3)
            del primals_23
            buf53 = empty_strided_cuda((131072, 1024), (1024, 1), torch.bfloat16)
            ...
            buf54 = empty_strided_cuda((1024, 384), (1, 1024), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_9], Original ATen: [aten._to_copy, aten.t]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_t_6.run(primals_24, buf54, 393216, stream=stream3)
            del primals_24
            buf55 = empty_strided_cuda((128, 1024, 1024), (1048576, 1024, 1), torch.bfloat16)
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf53, buf55, 134217728, stream=stream3)
            ...
            extern_kernels.mm(reinterpret_tensor(buf55, (131072, 1024), (1024, 1), 0), buf54, out=buf56)
            ...
            buf80 = empty_strided_cuda((128, 1024, 384), (393216, 384, 1), torch.float32)
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, linear_7, getitem_20, getitem_21, linear_9, mul_14, add_4, mul_15, add_5, getitem_22, getitem_23, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_10.run(buf60, primals_15, buf28, primals_3, primals_20, buf50, primals_21, buf56, primals_25, primals_26, primals_32, buf57, buf58, buf62, buf80, 131072, 384, stream=stream3)
...
def get_args():
    ...
    primals_13 = rand_strided((1024, 384), (384, 1), device='cuda:3', dtype=torch.bfloat16)
    primals_14 = rand_strided((384, 1024), (1024, 1), device='cuda:3', dtype=torch.bfloat16)
    ...
    primals_23 = rand_strided((1024, 384), (384, 1), device='cuda:3', dtype=torch.bfloat16)
    primals_24 = rand_strided((384, 1024), (1024, 1), device='cuda:3', dtype=torch.bfloat16)
