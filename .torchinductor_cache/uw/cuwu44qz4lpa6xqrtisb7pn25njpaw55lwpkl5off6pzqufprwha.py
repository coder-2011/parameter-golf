...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/zw/czwprff4gv7g2erjer2av4gm5laoonvkvkach2j4nohlfrkgi6pa.py
...
#   %convert_element_type_2 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg1_1, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/33/c33se4b3gx7aglsldaar3uecflp6hgbqwggojinjof6ovs33nkow.py
...
#   %buf2 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf2]
#   %arg2_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg2_1]
#   %view_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%mm, [350, 1000, 384]), kwargs = {})
#   %convert_element_type_6 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_1, torch.float32), kwargs = {})
#   %pow_1 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_6, 2), kwargs = {})
...
#   %add : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean, 1e-06), kwargs = {})
#   %rsqrt : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add,), kwargs = {})
#   %mul : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_6, %rsqrt), kwargs = {})
...
#   %mul_1 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul, %convert_element_type_5), kwargs = {})
#   %convert_element_type_7 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_1, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/p3/cp3unribvlgiemakonj566pwcbr6zqhaafg7nz35ong7hvxp2wdz.py
...
#   %view_3 : Tensor "bf16[350, 1000, 768][768000, 768, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_1, [350, 1000, 768]), kwargs = {})
#   %view_4 : Tensor "bf16[350, 1000, 16, 48][768000, 768, 48, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%view_3, [350, 1000, 16, 48]), kwargs = {})
#   %permute_5 : Tensor "bf16[350, 8, 1000, 48][384000, 48, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty, [0, 2, 1, 3]), kwargs = {})
#   %permute_6 : Tensor "bf16[350, 4, 1000, 48][192000, 48, 192, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty_1, [0, 2, 1, 3]), kwargs = {})
#   %slice_1 : Tensor "bf16[350, 1000, 4, 48][768000, 768, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_4, 2, 12, 9223372036854775807), kwargs = {})
#   %clone : Tensor "bf16[350, 1000, 4, 48][192000, 192, 48, 1]cuda:3"[num_users=3] = call_function[target=torch.ops.aten.clone.default](args = (%slice_1,), kwargs = {memory_format: torch.contiguous_format})
#   %permute_4 : Tensor "bf16[350, 4, 1000, 48][192000, 48, 192, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%clone, [0, 2, 1, 3]), kwargs = {})
...
#   %convert_element_type_10 : Tensor "f32[350, 1000, 4, 48][192000, 192, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%clone, torch.float32), kwargs = {})
#   %pow_2 : Tensor "f32[350, 1000, 4, 48][192000, 192, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_10, 2.0), kwargs = {})
#   %sum_1 : Tensor "f32[350, 1000, 4, 1][4000, 4, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%pow_2, [-1], True), kwargs = {})
#   return %buf9,%sum_1
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/7q/c7qpqqccwbjxajvgigttnqtwp7ennu2xmxg2yvicm2hbtk5m25a4.py
...
#   %mm_1 : Tensor "bf16[350000, 768][768, 1]cuda:3" = PlaceHolder[target=mm_1]
#   %sum_1 : Tensor "f32[350, 1000, 4, 1][4000, 4, 1, 1400000]cuda:3" = PlaceHolder[target=sum_1]
#   %view_3 : Tensor "bf16[350, 1000, 768][768000, 768, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_1, [350, 1000, 768]), kwargs = {})
#   %view_4 : Tensor "bf16[350, 1000, 16, 48][768000, 768, 48, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%view_3, [350, 1000, 16, 48]), kwargs = {})
#   %slice_1 : Tensor "bf16[350, 1000, 4, 48][768000, 768, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_4, 2, 12, 9223372036854775807), kwargs = {})
#   %clone : Tensor "bf16[350, 1000, 4, 48][192000, 192, 48, 1]cuda:3"[num_users=3] = call_function[target=torch.ops.aten.clone.default](args = (%slice_1,), kwargs = {memory_format: torch.contiguous_format})
#   %permute_7 : Tensor "bf16[350, 1000, 8, 48][384000, 384, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_2, [0, 2, 1, 3]), kwargs = {})
#   %view_5 : Tensor "bf16[350, 1000, 4, 2, 48][384000, 384, 96, 48, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_7, [350, 1000, 4, 2, 48]), kwargs = {})
#   %pow_3 : Tensor "f32[350, 1000, 4, 1][4000, 4, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%sum_1, 0.5), kwargs = {})
#   %clamp_min : Tensor "f32[350, 1000, 4, 1][4000, 4, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%pow_3, 1e-12), kwargs = {})
#   %expand : Tensor "f32[350, 1000, 4, 48][4000, 4, 1, 0]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%clamp_min, [350, 1000, 4, 48]), kwargs = {})
#   %div : Tensor "f32[350, 1000, 4, 48][192000, 192, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%clone, %expand), kwargs = {})
#   %unsqueeze : Tensor "f32[350, 1000, 4, 1, 48][192000, 192, 48, 48, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%div, -2), kwargs = {})
#   %mul_2 : Tensor "f32[350, 1000, 4, 2, 48][384000, 384, 96, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_5, %unsqueeze), kwargs = {})
#   %sum_2 : Tensor "f32[350, 1000, 4, 2, 1][8000, 8, 2, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_2, [-1], True), kwargs = {dtype: torch.float32})
#   return %sum_2
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/cr/ccrjhye7qja7blbnrphwaosubkvfbtlnqzanquycp5o4to5ngo2r.py
# Topologically Sorted Source Nodes: [getitem_3, contiguous_7], Original ATen: [aten.slice, aten.clone]
# Source node to ATen node mapping:
#   contiguous_7 => clone_1
#   getitem_3 => slice_2
# Graph fragment:
#   %convert_element_type_7 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=convert_element_type_7]
#   %slice_2 : Tensor "bf16[350, 1000, 12][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%convert_element_type_7, 2, 0, 12), kwargs = {})
#   %clone_1 : Tensor "bf16[350, 1000, 12][12000, 12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_2,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_1
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/kw/ckwaqfxdkyobroujw2w7svmkb7xtikng6t7zahltimtruncc7cmj.py
...
#   %mm_2 : Tensor "bf16[350000, 8][8, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mm.default](args = (%view_7, %permute_8), kwargs = {})
#   return %buf19
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ee/ceefyfcpbhcnebhaahgl65v3okpydx6nenj72l2d7b3dll2extcz.py
...
# Graph fragment:
#   %getitem_2 : Tensor "bf16[350, 8, 1000, 48][384000, 48, 384, 1]cuda:3" = PlaceHolder[target=getitem_2]
#   %sum_2 : Tensor "f32[350, 1000, 4, 2, 1][8000, 8, 2, 1, 2800000]cuda:3" = PlaceHolder[target=sum_2]
#   %mm_1 : Tensor "bf16[350000, 768][768, 1]cuda:3" = PlaceHolder[target=mm_1]
#   %sum_1 : Tensor "f32[350, 1000, 4, 1][4000, 4, 1, 1400000]cuda:3" = PlaceHolder[target=sum_1]
...
#   %div : Tensor "f32[350, 1000, 4, 48][192000, 192, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%clone, %expand), kwargs = {})
#   %unsqueeze : Tensor "f32[350, 1000, 4, 1, 48][192000, 192, 48, 48, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%div, -2), kwargs = {})
#   %mul_3 : Tensor "f32[350, 1000, 4, 2, 48][384000, 384, 96, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_2, %unsqueeze), kwargs = {})
#   %sub : Tensor "f32[350, 1000, 4, 2, 48][384000, 384, 96, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_5, %mul_3), kwargs = {})
#   %view_6 : Tensor "f32[350, 1000, 8, 48][384000, 384, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%sub, [350, 1000, 8, 48]), kwargs = {})
...
#   %mul_4 : Tensor "bf16[350, 1000, 8][8000, 8, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_8, 0.5), kwargs = {})
#   %sigmoid : Tensor "bf16[350, 1000, 8][8000, 8, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_4,), kwargs = {})
#   %unsqueeze_1 : Tensor "bf16[350, 1000, 8, 1][8000, 8, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sigmoid, 3), kwargs = {})
#   %mul_5 : Tensor "f32[350, 1000, 8, 48][384000, 384, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_6, %unsqueeze_1), kwargs = {})
#   %view_9 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_5, [350, 1000, 384]), kwargs = {})
#   %convert_element_type_16 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_9, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rp/crp7ypp7lsq2umcq4ufzfbmjbkvfaefnzl4ulgemkcbsvdvajiyq.py
...
#   %mm : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm]
#   %buf24 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf24]
...
#   %add_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_11, %view_1), kwargs = {})
#   %convert_element_type_20 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.float32), kwargs = {})
#   %pow_4 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_20, 2), kwargs = {})
#   %mean_1 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_4, [2], True), kwargs = {})
...
#   %mul_6 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_20, %rsqrt_1), kwargs = {})
...
#   %mul_7 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_6, %convert_element_type_19), kwargs = {})
#   %convert_element_type_21 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_7, torch.bfloat16), kwargs = {})
#   %view_13 : Tensor "bf16[350000, 384][384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_21, [-1, 384]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/nm/cnmk25d53gw2rp4363j5vgzpelrksxl3ti64fzj5n2hyk2scvydx.py
...
#   %mm_3 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_3]
#   %mm : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm]
#   %buf31 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf31]
#   %arg11_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg11_1]
#   %view_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%mm, [350, 1000, 384]), kwargs = {})
#   %view_11 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_3, [350, 1000, 384]), kwargs = {})
#   %add_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_11, %view_1), kwargs = {})
#   %view_14 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_4, [350, 1000, 384]), kwargs = {})
#   %add_3 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_14, %add_1), kwargs = {})
#   %convert_element_type_25 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_3, torch.float32), kwargs = {})
#   %pow_5 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_25, 2), kwargs = {})
#   %mean_2 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_5, [2], True), kwargs = {})
#   %add_4 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_2, 1e-06), kwargs = {})
#   %rsqrt_2 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_4,), kwargs = {})
#   %mul_8 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_25, %rsqrt_2), kwargs = {})
...
#   %mul_9 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_8, %convert_element_type_24), kwargs = {})
#   %convert_element_type_26 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_9, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/h3/ch3fbsg7smi2afb3rh7peral762nhczbkrfcsjbdp2nzutjsttub.py
...
#   %mm_3 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_3]
#   %mm : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm]
#   %buf53 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf53]
...
#   %view_14 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_4, [350, 1000, 384]), kwargs = {})
#   %add_3 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_14, %add_1), kwargs = {})
#   %view_24 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_7, [350, 1000, 384]), kwargs = {})
#   %add_5 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_24, %add_3), kwargs = {})
#   %convert_element_type_39 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_5, torch.float32), kwargs = {})
#   %pow_8 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_39, 2), kwargs = {})
#   %mean_3 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_8, [2], True), kwargs = {})
#   %add_6 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_3, 1e-06), kwargs = {})
#   %rsqrt_3 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_6,), kwargs = {})
#   %mul_14 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_39, %rsqrt_3), kwargs = {})
...
#   %mul_15 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_14, %convert_element_type_38), kwargs = {})
#   %convert_element_type_40 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_15, torch.bfloat16), kwargs = {})
#   %view_26 : Tensor "bf16[350000, 384][384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_40, [-1, 384]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/zq/czqx3ksgnau7q7iqgyl6wprrz67ueomyt3il7ejaszdvkqqe2w6g.py
...
# Graph fragment:
#   %mm_8 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_8]
#   %mm_7 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_7]
#   %mm_4 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_4]
#   %mm_3 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_3]
#   %mm : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm]
#   %add_7 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=add_7]
#   %buf61 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf61]
...
#   %view_24 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_7, [350, 1000, 384]), kwargs = {})
#   %add_5 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_24, %add_3), kwargs = {})
#   %view_27 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_8, [350, 1000, 384]), kwargs = {})
#   %add_7 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_27, %add_5), kwargs = {})
#   %convert_element_type_44 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_7, torch.float32), kwargs = {})
#   %pow_9 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_44, 2), kwargs = {})
#   %mean_4 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_9, [2], True), kwargs = {})
#   %add_8 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_4, 1e-06), kwargs = {})
#   %rsqrt_4 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_8,), kwargs = {})
#   %mul_16 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_44, %rsqrt_4), kwargs = {})
...
#   %mul_17 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_16, %convert_element_type_43), kwargs = {})
#   %convert_element_type_45 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_17, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/35/c35rq3bnnudzfegnjfzubtvzm2uxksozpj4ezooygaus74xhgdgm.py
...
# Graph fragment:
#   %mm_12 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_12]
#   %mm_11 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_11]
#   %add_7 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=add_7]
#   %buf90 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf90]
#   %arg25_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg25_1]
#   %view_37 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_11, [350, 1000, 384]), kwargs = {})
#   %add_9 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_37, %add_7), kwargs = {})
#   %view_40 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_12, [350, 1000, 384]), kwargs = {})
#   %add_11 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_40, %add_9), kwargs = {})
#   %convert_element_type_63 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_11, torch.float32), kwargs = {})
#   %pow_13 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_63, 2), kwargs = {})
#   %mean_6 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_13, [2], True), kwargs = {})
#   %add_12 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_6, 1e-06), kwargs = {})
#   %rsqrt_6 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_12,), kwargs = {})
#   %mul_24 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_63, %rsqrt_6), kwargs = {})
...
#   %mul_25 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_24, %convert_element_type_62), kwargs = {})
#   %convert_element_type_64 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_25, torch.bfloat16), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(3):
            ...
            triton_poi_fused__to_copy_0.run(arg1_1, buf0, 134400000, stream=stream3)
            del arg1_1
            ...
            # Topologically Sorted Source Nodes: [linear, rms_norm, to_1], Original ATen: [aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_1.run(buf1, arg2_1, buf3, 350000, 384, stream=stream3)
            del arg2_1
            ...
            stream3 = get_raw_stream(3)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf4, (350, 1000, 16, 48), (768000, 768, 48, 1), 0), buf5, buf6, reinterpret_tensor(arg4_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg5_1, (1000, 24), (24, 1), 0), 4200000, 1, 1, stream=stream3)
            ...
            # Topologically Sorted Source Nodes: [linear_1, view, scaled_dot_product_attention, getitem, contiguous, transpose_2, normalize], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention, aten.linalg_vector_norm]
            stream3 = get_raw_stream(3)
            triton_per_fused__scaled_dot_product_flash_attention__unsafe_view_clone_linalg_vector_norm_slice_transpose_view_2.run(buf4, buf9, buf16, 1400000, 48, stream=stream3)
            ...
            # Topologically Sorted Source Nodes: [linear_1, view, getitem, contiguous, transpose_3, view_1, normalize, unsqueeze, mul, sum_1], Original ATen: [aten._unsafe_view, aten.view, aten.slice, aten.clone, aten.transpose, aten.linalg_vector_norm, aten.clamp_min, aten.expand, aten.div, aten.unsqueeze, aten.mul, aten.sum]
            stream3 = get_raw_stream(3)
            triton_per_fused__unsafe_view_clamp_min_clone_div_expand_linalg_vector_norm_mul_slice_sum_transpose_unsqueeze_view_3.run(buf11, buf4, buf16, buf17, 2800000, 48, stream=stream3)
            buf18 = empty_strided_cuda((350, 1000, 12), (12032, 12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_3, contiguous_7], Original ATen: [aten.slice, aten.clone]
            stream3 = get_raw_stream(3)
            triton_poi_fused_clone_slice_4.run(buf3, buf18, 4200000, stream=stream3)
            buf19 = empty_strided_cuda((350000, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_3, contiguous_7, linear_2, to_3], Original ATen: [aten.slice, aten.clone, aten.view, aten._to_copy, aten.t, aten.mm]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_5.run(buf18, buf19, 4200000, stream=stream3)
            del buf18
            ...
            # Topologically Sorted Source Nodes: [linear_1, view, getitem, contiguous, transpose_3, view_1, normalize, unsqueeze, mul_1, sub, reshape, linear_2, mul_2, sigmoid, getitem_4, mul_3, reshape_1, linear_3], Original ATen: [aten._unsafe_view, aten.view, aten.slice, aten.clone, aten.transpose, aten.linalg_vector_norm, aten.clamp_min, aten.expand, aten.div, aten.unsqueeze, aten.mul, aten.sub, aten.sigmoid, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy__unsafe_view_clamp_min_clone_div_expand_linalg_vector_norm_mul_sigmoid_slice_sub_transpose_unsqueeze_view_7.run(buf22, buf17, buf4, buf16, buf21, 134400000, stream=stream3)
            del buf16
            del buf17
            del buf21
            del buf4
            ...
            # Topologically Sorted Source Nodes: [linear, linear_3, add, rms_norm_1, to_5, reshape_3, triton_kernel_wrapper_mutation_1], Original ATen: [aten._unsafe_view, aten.add, aten._fused_rms_norm, aten._to_copy, aten.view]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_view_8.run(buf23, buf1, arg8_1, buf27, 350000, 384, stream=stream3)
            del arg8_1
            buf25 = empty_strided_cuda((350000, 1536), (1536, 1), torch.bfloat16)
            buf26 = empty_strided_cuda((350000, 1536), (1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear, linear_3, add, rms_norm_1, to_5, reshape_3, triton_kernel_wrapper_mutation_1], Original ATen: [aten._unsafe_view, aten.add, aten._fused_rms_norm, aten._to_copy, aten.view]
            stream3 = get_raw_stream(3)
            _leaky_relu_sq_matmul_kernel_1.run(buf27, arg9_1, buf25, buf26, 65628, 1, 1, stream=stream3)
            del arg9_1
            del buf25
            ...
            # Topologically Sorted Source Nodes: [linear, linear_3, add, reshape_4, add_1, rms_norm_2, to_8], Original ATen: [aten._unsafe_view, aten.add, aten.view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_view_9.run(buf30, buf23, buf1, arg11_1, buf32, 350000, 384, stream=stream3)
            del arg11_1
            ...
            stream3 = get_raw_stream(3)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf33, (350, 1000, 16, 48), (768000, 768, 48, 1), 0), buf34, buf35, reinterpret_tensor(arg4_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg5_1, (1000, 24), (24, 1), 0), 4200000, 1, 1, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_per_fused__scaled_dot_product_flash_attention__unsafe_view_clone_linalg_vector_norm_slice_transpose_view_2.run(buf33, buf38, buf45, 1400000, 48, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_per_fused__unsafe_view_clamp_min_clone_div_expand_linalg_vector_norm_mul_slice_sum_transpose_unsqueeze_view_3.run(buf40, buf33, buf45, buf46, 2800000, 48, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused_clone_slice_4.run(buf32, buf47, 4200000, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_5.run(buf47, buf48, 4200000, stream=stream3)
            del buf47
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy__unsafe_view_clamp_min_clone_div_expand_linalg_vector_norm_mul_sigmoid_slice_sub_transpose_unsqueeze_view_7.run(buf51, buf46, buf33, buf45, buf50, 134400000, stream=stream3)
            del buf33
            del buf45
            del buf46
            del buf50
            ...
            # Topologically Sorted Source Nodes: [linear, linear_3, add, reshape_4, add_1, linear_7, add_2, rms_norm_3, to_12, reshape_8, triton_kernel_wrapper_mutation_3], Original ATen: [aten._unsafe_view, aten.add, aten.view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_view_10.run(buf52, buf30, buf23, buf1, arg15_1, buf56, 350000, 384, stream=stream3)
            del arg15_1
            buf54 = empty_strided_cuda((350000, 1536), (1536, 1), torch.bfloat16)
            buf55 = empty_strided_cuda((350000, 1536), (1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear, linear_3, add, reshape_4, add_1, linear_7, add_2, rms_norm_3, to_12, reshape_8, triton_kernel_wrapper_mutation_3], Original ATen: [aten._unsafe_view, aten.add, aten.view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            _leaky_relu_sq_matmul_kernel_1.run(buf56, arg16_1, buf54, buf55, 65628, 1, 1, stream=stream3)
            del arg16_1
            del buf54
            ...
            # Topologically Sorted Source Nodes: [linear, linear_3, add, reshape_4, add_1, linear_7, add_2, reshape_9, add_3, rms_norm_4, to_15], Original ATen: [aten._unsafe_view, aten.add, aten.view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_view_11.run(buf60, buf52, buf30, buf23, buf1, arg18_1, buf62, 350000, 384, stream=stream3)
            del arg18_1
            del buf1
            del buf23
            del buf30
            ...
            stream3 = get_raw_stream(3)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf63, (350, 1000, 16, 48), (768000, 768, 48, 1), 0), buf64, buf65, reinterpret_tensor(arg4_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg5_1, (1000, 24), (24, 1), 0), 4200000, 1, 1, stream=stream3)
            del arg4_1
            del arg5_1
            ...
            stream3 = get_raw_stream(3)
            triton_per_fused__scaled_dot_product_flash_attention__unsafe_view_clone_linalg_vector_norm_slice_transpose_view_2.run(buf63, buf68, buf75, 1400000, 48, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_per_fused__unsafe_view_clamp_min_clone_div_expand_linalg_vector_norm_mul_slice_sum_transpose_unsqueeze_view_3.run(buf70, buf63, buf75, buf76, 2800000, 48, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused_clone_slice_4.run(buf62, buf77, 4200000, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_5.run(buf77, buf78, 4200000, stream=stream3)
            del buf77
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy__unsafe_view_clamp_min_clone_div_expand_linalg_vector_norm_mul_sigmoid_slice_sub_transpose_unsqueeze_view_7.run(buf81, buf76, buf63, buf75, buf80, 134400000, stream=stream3)
            del buf63
            del buf75
            del buf76
            del buf80
            ...
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_view_8.run(buf82, buf60, arg22_1, buf86, 350000, 384, stream=stream3)
            del arg22_1
            buf84 = buf55; del buf55  # reuse
            buf85 = empty_strided_cuda((350000, 1536), (1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_11, add_4, rms_norm_5, to_19, reshape_13, triton_kernel_wrapper_mutation_5], Original ATen: [aten._unsafe_view, aten.add, aten._fused_rms_norm, aten._to_copy, aten.view]
            stream3 = get_raw_stream(3)
            _leaky_relu_sq_matmul_kernel_1.run(buf86, arg23_1, buf84, buf85, 65628, 1, 1, stream=stream3)
            del arg23_1
            del buf84
            ...
            # Topologically Sorted Source Nodes: [linear_11, add_4, reshape_14, add_5, rms_norm_6, to_22], Original ATen: [aten._unsafe_view, aten.add, aten.view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_view_12.run(buf91, buf82, buf60, arg25_1, 350000, 384, stream=stream3)
            del arg25_1
            del buf60
            del buf82
...
def get_args():
    ...
    arg26_1 = rand_strided((350, 1000), (1000, 1), device='cuda:3', dtype=torch.int64)
