...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xx/cxxi24mxawf3xhzpwbi4t5wz7hsol35odnb3zv5obrpjxf5u5ud4.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/l2/cl2deqs236yc4ifl6scn6pe7hvnis3sgu3gzk64mp66zyempvt73.py
...
#   %convert_element_type_default_17 : Tensor "bf16[1152, 384][384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_5, torch.bfloat16), kwargs = {})
#   %permute : Tensor "bf16[384, 1152][1, 384]cuda:4"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_17, [1, 0]), kwargs = {})
#   return %permute
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/hn/chnsv2y2sdmbiprrdwgucdb6qao7podhgi6afwybgpuir64ne5oo.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/z7/cz7dbigpiltfs2jb5xidiyxrdhvzsd5xp4xy24hcfm5y47qvokf7.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2o/c2ora776odshkj7mbce2nxfhlo46izxbbiiqonk3zdcl7bx3bfam.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/fh/cfhmpcaui6rmo3m7zwyi3x4hb6xqqloddukrq4wytnhqqxn6cznl.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rt/crtg3n4goyoporqcqqazbdqleuvqchn35dikwyzba4h34dll4jsb.py
...
# Graph fragment:
#   %primals_13 : Tensor "bf16[1024, 384][384, 1]cuda:4" = PlaceHolder[target=primals_13]
#   %convert_element_type_default_16 : Tensor "bf16[1024, 384][384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_13, torch.bfloat16), kwargs = {})
#   %permute_9 : Tensor "bf16[384, 1024][1, 384]cuda:4"[num_users=2] = call_function[target=torch.ops.aten.permute.default](args = (%convert_element_type_default_16, [1, 0]), kwargs = {})
#   return %permute_9
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gx/cgxuq43gn6ygskmvm24ej3ksnounlsvnaxjcryxacs5qjlw3hjmr.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ti/ctih3ew7boohtuynaq3bsqxryor6nskxzoomekyxfbhnnavvildr.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/kw/ckw4bejq5gudpbmcuezuu6d6dohedonttvj3nthax6dv322rpqvs.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/p3/cp3sdejbktg475ji4qcizggmntczhcd6t7vwskunztwesjwbsbjq.py
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_out_ptr0': '*fp32', 'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*bf16', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*bf16', 'in_ptr7': '*fp32', 'in_ptr8': '*fp32', 'in_ptr9': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'out_ptr2': '*bf16', 'out_ptr3': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=4, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]], (11,): [['tt.divisibility', 16]], (12,): [['tt.divisibility', 16]], (13,): [['tt.divisibility', 16]], (14,): [['tt.divisibility', 16]], (15,): [['tt.divisibility', 16]], (16,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/be/cbeyqear3ldbhdv46od2rqcisdf2hqzvucsap4zcvrmzuiedoru4.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(4):
            ...
            # Topologically Sorted Source Nodes: [linear_3], Original ATen: [aten._to_copy, aten.t]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_t_6.run(primals_13, buf22, 393216, stream=stream4)
            del primals_13
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_t_6.run(primals_14, buf25, 393216, stream=stream4)
            del primals_14
            buf26 = empty_strided_cuda((128, 1024, 1024), (1048576, 1024, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf24, buf26, 134217728, stream=stream4)
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_t_6.run(primals_23, buf51, 393216, stream=stream4)
            del primals_23
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_t_6.run(primals_24, buf54, 393216, stream=stream4)
            del primals_24
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_7.run(buf53, buf55, 134217728, stream=stream4)
            ...
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, linear_7, getitem_20, getitem_21, linear_9, mul_14, add_4, mul_15, add_5, getitem_22, getitem_23, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_10.run(buf60, primals_15, buf28, primals_3, primals_20, buf50, primals_21, buf56, primals_25, primals_26, primals_32, buf57, buf58, buf62, buf80, 131072, 384, stream=stream4)
...
def get_args():
    ...
    primals_13 = rand_strided((1024, 384), (384, 1), device='cuda:4', dtype=torch.bfloat16)
    primals_14 = rand_strided((384, 1024), (1024, 1), device='cuda:4', dtype=torch.bfloat16)
    ...
    primals_23 = rand_strided((1024, 384), (384, 1), device='cuda:4', dtype=torch.bfloat16)
    primals_24 = rand_strided((384, 1024), (1024, 1), device='cuda:4', dtype=torch.bfloat16)
