...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/j4/cj4d6aplenmgpkeuwncda4cgdqdu3z7avyjcky7vcpnekcg6nuno.py
...
#   %select : Tensor "i64[512, 4][4000, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%empty, 1, 0), kwargs = {})
...
#   %copy : Tensor "i64[512, 4][4000, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%select, %full_default), kwargs = {})
#   %select_scatter_default : Tensor "i64[512, 1000, 4][4000, 4, 1]cuda:5"[num_users=2] = call_function[target=torch.ops.aten.select_scatter.default](args = (%empty, %copy, 1, 0), kwargs = {})
#   %slice_8 : Tensor "i64[512, 999, 4][4000, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%select_scatter_default, 1, 1, 9223372036854775807), kwargs = {})
...
#   %mul : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze, %lift_fresh_copy), kwargs = {})
...
#   %mul_1 : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %lift_fresh_copy_1), kwargs = {})
#   %bitwise_xor : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.bitwise_xor.Tensor](args = (%mul, %mul_1), kwargs = {})
#   %remainder : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 8191), kwargs = {})
#   %add : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%remainder, 1), kwargs = {})
#   %copy_1 : Tensor "i64[512, 999, 4][4000, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_8, %add), kwargs = {})
#   %slice_scatter_default : Tensor "i64[512, 1000, 4][4000, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%select_scatter_default, %copy_1, 1, 1, 9223372036854775807), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/nx/cnxpvk5hvkgef4whpis2rq6ysdabjklwhnzuf6mmrc5l6obqtc32.py
...
#   sum_1 => sum_1
# Graph fragment:
#   %slice_scatter_default : Tensor "i64[512, 1000, 4][4000, 4, 1]cuda:5" = PlaceHolder[target=slice_scatter_default]
...
#   %add_1 : Tensor "i64[512, 1000, 4][4000, 4, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %mul_2), kwargs = {})
#   %embedding_1 : Tensor "bf16[512, 1000, 4, 128][512000, 512, 128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%arg6_1, %add_1), kwargs = {})
#   %sum_1 : Tensor "f32[512, 1000, 128][128000, 128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%embedding_1, [-2]), kwargs = {dtype: torch.float32})
#   %mul_3 : Tensor "f32[512, 1000, 128][128000, 128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.5), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[512, 1000, 128][128000, 128, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_3, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/un/cunl45nnxqtlj53wezdttfxzzhuaasvfl36wxlmcnbweudydkmyl.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/3s/c3suuwhqdzvgqd3xipgcy2nbstvvgdytkccv7bs55b4idqqt3qmk.py
...
#   %buf8 : Tensor "f32[512, 1000, 1][1000, 1, 512000]cuda:5" = PlaceHolder[target=buf8]
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/od/cod5iz2kff5utcdhpr4yk7q6snv63gqnx6deaszikdlnlcntdb6q.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tt/cttlrfolipw2mezdmzhnkfsygdgkuodffzyr5nptshzwyeigx6sq.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/vo/cvoaif4724d245se6tqwr6cp2jyd7apdgpqjp3iv6irfcvz4kwci.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/5x/c5xrd2xdsdpsj2r2jsacfllehvowro5h7q6w4nxiifra7ywv4qxx.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sy/csy3ge2u35oilfsoxin3fh4vh7bfbsgfxfrki3d4zdpidugugxgi.py
...
#   %buf29 : Tensor "f32[512, 1000, 1][1000, 1, 512000]cuda:5" = PlaceHolder[target=buf29]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(5):
            ...
            triton_poi_fused_add_bitwise_xor_copy_fill_lift_fresh_mul_remainder_select_slice_unsqueeze_0.run(arg4_1, buf1, 2048000, stream=stream5)
            buf2 = empty_strided_cuda((512, 1000, 128), (128000, 128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [arange, mul_2, add_1, embedding_1, sum_1, mul_3, linear], Original ATen: [aten.arange, aten.mul, aten.add, aten.embedding, aten.sum, aten._to_copy]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_add_arange_embedding_mul_sum_1.run(buf1, arg6_1, buf2, 65536000, stream=stream5)
            del arg6_1
            del buf1
            ...
            # Topologically Sorted Source Nodes: [embedding], Original ATen: [aten.embedding]
            stream5 = get_raw_stream(5)
            triton_poi_fused_embedding_2.run(arg4_1, arg5_1, buf4, 512000, 384, stream=stream5)
            del arg5_1
            ...
            # Topologically Sorted Source Nodes: [to_6, sigmoid_1, getitem_8, sub, linear, linear_1, sigmoid, mul_4, to_5, mul_5, add_2, mul_7, zeros_like, getitem_10, cat, ne, to_7, unsqueeze, mul_6, mul_8, add_3, rms_norm, to_8], Original ATen: [aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.rsub, aten._unsafe_view, aten.view, aten.mul, aten.add, aten.zeros_like, aten.slice, aten.cat, aten.ne, aten._fused_rms_norm]
            stream5 = get_raw_stream(5)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_cat_mul_ne_rsub_sigmoid_slice_unsqueeze_view_zeros_like_4.run(arg11_1, buf4, buf3, buf6, arg10_1, arg4_1, arg12_1, buf7, buf9, 512000, 384, stream=stream5)
            del arg10_1
            del arg11_1
            del arg12_1
            del arg4_1
            ...
            stream5 = get_raw_stream(5)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf10, (512, 1000, 16, 48), (768000, 768, 48, 1), 0), buf11, buf12, reinterpret_tensor(arg0_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg1_1, (1000, 24), (24, 1), 0), 6144000, 1, 1, stream=stream5)
            buf15 = empty_strided_cuda((512, 4, 1000, 48), (192000, 48, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_11, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            stream5 = get_raw_stream(5)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_5.run(buf10, buf15, 98304000, stream=stream5)
            del buf10
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_11, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_6], Original ATen: [aten.slice, aten.clone]
            stream5 = get_raw_stream(5)
            triton_poi_fused_clone_slice_6.run(buf9, buf22, 6144000, stream=stream5)
            buf23 = empty_strided_cuda((512000, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_6, linear_3, to_10], Original ATen: [aten.slice, aten.clone, aten.view, aten._to_copy, aten.t, aten.mm]
            stream5 = get_raw_stream(5)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_7.run(buf22, buf23, 6144000, stream=stream5)
            del buf22
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_3, mul_9, sigmoid_2, getitem_15, mul_10], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream5 = get_raw_stream(5)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_9.run(buf26, buf25, 196608000, stream=stream5)
            del buf25
            ...
            # Topologically Sorted Source Nodes: [linear_4, add_4, rms_norm_1, to_12], Original ATen: [aten._unsafe_view, aten.add, aten._fused_rms_norm, aten._to_copy]
            stream5 = get_raw_stream(5)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_10.run(buf28, buf7, arg16_1, buf30, 512000, 384, stream=stream5)
            del arg16_1
