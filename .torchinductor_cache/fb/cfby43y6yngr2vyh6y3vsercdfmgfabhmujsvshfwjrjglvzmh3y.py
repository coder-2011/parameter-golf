...
_tensor_constant0 = None  # device(type='cuda', index=3) torch.int64 (12,) (1,) 7352129b0280
_tensor_constant1 = None  # device(type='cuda', index=3) torch.int64 (12,) (1,) 7352129b2ee0
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xx/cxxxj3xxxzu5wabr3pmshhignhvlzd2zasiaxg5ukmjfeibw22dw.py
...
#   %remainder : Tensor "i64[128, 1023, 12][12276, 12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 32767), kwargs = {})
