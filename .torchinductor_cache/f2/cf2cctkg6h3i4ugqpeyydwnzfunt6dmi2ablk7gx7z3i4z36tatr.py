...
_tensor_constant0 = None  # device(type='cuda', index=5) torch.int64 (12,) (1,) 7b1d17e51400
_tensor_constant1 = None  # device(type='cuda', index=5) torch.int64 (12,) (1,) 7b1d17e04140
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dp/cdpy2ancr3rmfmsbayuu7j5e35ifd5n6ofrtbithiblgfosiaj6j.py
...
#   %remainder : Tensor "i64[128, 1023, 12][12276, 12, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 16383), kwargs = {})
...
#   %mul_2 : Tensor "i64[12][1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%iota, 16384), kwargs = {})
