...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ei/ceivzxpmoe2hd2boewq27zwxzsq2ruufmtmttwcgf22cbvxnlj4l.py
# Topologically Sorted Source Nodes: [zeros], Original ATen: [aten.zeros]
# Source node to ATen node mapping:
#   zeros => full_default
# Graph fragment:
#   %full_default : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([350, 1000, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:1, pin_memory: False})
#   return %full_default
...
class Runner:
    ...
    def call(self, args):
        with torch.cuda._DeviceGuard(1):
            ...
            triton_poi_fused_zeros_0.run(buf0, 134400000, stream=stream1)
        return (buf0, )
