...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ob/cobfdf63yoh2godvadcpj7ja6nmq7clfdsrfhypmbimffxuj6bmf.py
...
#   x => add
# Graph fragment:
#   %arg2_1 : Tensor "f32[349, 1000, 384][384000, 384, 1]cuda:5" = PlaceHolder[target=arg2_1]
...
#   %mul_1 : Tensor "f32[349, 1000, 384][384000, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg2_1, %exp_2), kwargs = {})
...
#   %mul_2 : Tensor "f32[349, 1000, 384][384000, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where, %view_1), kwargs = {})
#   %add : Tensor "f32[349, 1000, 384][384000, 384, 1]cuda:5"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_1, %mul_2), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(5):
            ...
            triton_poi_fused__unsafe_view_add_exp_mul_neg_softplus_0.run(arg2_1, arg0_1, arg1_1, buf0, buf1, 134016000, stream=stream5)
            del arg0_1
            del arg1_1
            del arg2_1
            del buf0
...
def get_args():
    ...
    arg2_1 = rand_strided((349, 1000, 384), (384000, 384, 1), device='cuda:5', dtype=torch.float32)
    arg3_1 = rand_strided((384, 384), (384, 1), device='cuda:5', dtype=torch.bfloat16)
    arg4_1 = rand_strided((349, 1000, 384), (384000, 384, 1), device='cuda:5', dtype=torch.bfloat16)
