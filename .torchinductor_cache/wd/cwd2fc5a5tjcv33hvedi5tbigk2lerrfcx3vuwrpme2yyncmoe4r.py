...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wa/cwao3x7l5eojw33jghnycbiaarme3tb43yrxslgkpqx45mtogbyk.py
...
#   %remainder : Tensor "i64[350, 999, 8][7992, 8, 1]cuda:7"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 16383), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(7):
            ...
            # Topologically Sorted Source Nodes: [setitem, setitem_1, remainder, add, arange, mul_2, add_1], Original ATen: [aten.select, aten.lift_fresh, aten.fill, aten.slice, aten.remainder, aten.add, aten.copy, aten.arange, aten.mul]
            stream7 = get_raw_stream(7)
            triton_poi_fused_add_arange_copy_fill_lift_fresh_mul_remainder_select_slice_1.run(buf1, buf2, 2800000, stream=stream7)
            del buf1
            buf3 = empty_strided_cuda((350, 1000, 384), (384000, 384, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [embedding], Original ATen: [aten.embedding]
            stream7 = get_raw_stream(7)
            triton_poi_fused_embedding_2.run(arg4_1, arg5_1, buf3, 134400000, stream=stream7)
            del arg4_1
            del arg5_1
