...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/as/cas5dgmo5i4qjb2xvngfvqbav4q76ze2t7xeb333wizpo7qhoc57.py
# Topologically Sorted Source Nodes: [linear], Original ATen: [aten._to_copy]
# Source node to ATen node mapping:
#   linear => convert_element_type_2
# Graph fragment:
#   %arg1_1 : Tensor "f32[128, 1024, 1536][1572864, 1536, 1]cuda:3" = PlaceHolder[target=arg1_1]
#   %convert_element_type_2 : Tensor "bf16[128, 1024, 1536][1572864, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg1_1, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/aw/caw7zeanldhb444u7aw3v7uvswtqwnunoc3x6npzqae5jovyk3na.py
...
#   mul_1 => mul_1
# Graph fragment:
#   %arg4_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:3" = PlaceHolder[target=arg4_1]
#   %arg2_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:3" = PlaceHolder[target=arg2_1]
#   %arg3_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:3" = PlaceHolder[target=arg3_1]
...
#   %mul : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg2_1, %arg3_1), kwargs = {})
#   %add : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg4_1, %mul), kwargs = {})
...
#   %mul_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%arg5_1, %view_1), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(3):
            ...
            triton_poi_fused__to_copy_0.run(arg1_1, buf0, 201326592, stream=stream3)
            del arg1_1
            ...
            # Topologically Sorted Source Nodes: [mul, add, linear, mul_1, add_1], Original ATen: [aten.mul, aten.add, aten._unsafe_view]
            stream3 = get_raw_stream(3)
            triton_poi_fused__unsafe_view_add_mul_1.run(arg4_1, arg2_1, arg3_1, arg5_1, buf1, buf2, 50331648, stream=stream3)
            del arg2_1
            del arg3_1
            del arg4_1
            del arg5_1
...
def get_args():
    ...
    arg1_1 = rand_strided((128, 1024, 1536), (1572864, 1536, 1), device='cuda:3', dtype=torch.float32)
    arg2_1 = rand_strided((1, 1, 384), (384, 384, 1), device='cuda:3', dtype=torch.float32)
    arg3_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:3', dtype=torch.bfloat16)
    arg4_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:3', dtype=torch.float32)
