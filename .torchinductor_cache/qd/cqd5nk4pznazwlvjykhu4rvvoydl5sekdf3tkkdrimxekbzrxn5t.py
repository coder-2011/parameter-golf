...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/kn/cknmervpji32x6smb7kh3yabjexfyuy6wx6ykiwry376afeyiclw.py
...
#   %primals_2 : Tensor "bf16[196608, 128][128, 1]cuda:1" = PlaceHolder[target=primals_2]
...
def get_args():
    ...
    primals_2 = rand_strided((196608, 128), (128, 1), device='cuda:1', dtype=torch.bfloat16)
