...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ze/czefx72f3gyrajg47vjymoz4bbhinwfwcs2t6mxxdmghpvo6hppc.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/y7/cy7nhgwnurlkxgxhy3dfvchgyoykrsyqoo2qss62huv5v2pchdms.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/zh/czhgcrzpyyqf5x3gxgx6sysxlyvodpr3b6fdnanuqgujubkjzrk7.py
...
# Graph fragment:
#   %view_7 : Tensor "bf16[131072, 12][12, 1]cuda:2" = PlaceHolder[target=view_7]
#   %constant_pad_nd_default : Tensor "bf16[131072, 16][16, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view_7, [0, 4, 0, 0]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/hs/chsriiizoevprpyajwxz23ortr5rarvvat6dpefjdl7jf5x4dxl7.py
...
# Graph fragment:
#   %mm_default : Tensor "bf16[8, 16][16, 1]cuda:2" = PlaceHolder[target=mm_default]
#   %slice_tensor : Tensor "bf16[8, 12][16, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_default, 1, 0, -4), kwargs = {})
#   %convert_element_type_43 : Tensor "f32[8, 12][12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_tensor, torch.float32), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/jg/cjgivotgooqfbi7vwaslbxiast26odlwqudablk7o3kbzy2jjlno.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/y3/cy3r5tvlagihgimvljdost76cyn3hpv6zywlamueig6rxdmqpnhh.py
...
#   %mm_7 : Tensor "bf16[131072, 12][12, 1]cuda:2" = PlaceHolder[target=mm_7]
...
#   %view_17 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_7, [128, 1024, 12]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/oz/cozlln5bddsapjc42pfhpunyg2hashqd3fwvaaqkczo52pw5tvxj.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/be/cbezvssbfkdjcofuoqgfot6lvxmbmg5772y7iwhnzbhccetxa4xq.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/vj/cvjtd2fweqxi6olvilxx3jhvfowrp7a2yugibclsiyjvisyaqnsn.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/uz/cuzqkhsibq6quxwr6w4u5g5li5xc2nsahgn2z5bgao4stengwkmd.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qb/cqbb44pr3xzta55vjf7jc4kzskmobq4o4iteosgz6u24wxrym3mv.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sb/csbo2zmzgpvekrywuqi3jrpuzjnm5svqf7v6r5dhrnz4g63qfq7u.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/my/cmyutx4sldpnc4meagantyqramyttjo3suntdzjzxklbmn6fbuhs.py
# Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_41, convert_element_type_62, convert_element_type_63, sub_5, mul_43, mul_44, convert_element_type_64, view_26, sum_10], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten.sigmoid_backward, aten.sum]
# Source node to ATen node mapping:
#   convert_element_type_62 => convert_element_type_62
#   convert_element_type_63 => convert_element_type_63
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ji/cjicbonwhhnst74otprr36gb54twvw7tamt5k5bewuqqg5ohahta.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/s6/cs6nbvxzfaqp3rzxze22ozux7viigigfwnuvqbj26s2se7hr7fxf.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/6c/c6ctp3jyqxdvbedqihjmiytvozvab3cu5dtwlorfd3rghyu55alo.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qm/cqmenwryvgif2wswwtmum4kyviqxchva4bjwphnqek4i2oitvgg4.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            # Topologically Sorted Source Nodes: [constant_pad_nd_default], Original ATen: [aten.mm]
            stream2 = get_raw_stream(2)
            triton_poi_fused_mm_2.run(view_7, buf8, 2097152, stream=stream2)
            del view_7
            ...
            # Topologically Sorted Source Nodes: [slice_tensor, convert_element_type_43], Original ATen: [aten.mm, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_mm_3.run(buf9, buf11, 96, stream=stream2)
            del buf9
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_slice_backward_view_5.run(buf25, add_3, rsqrt, buf10, buf21, primals_13, tangents_3, workspace_1, 131072, 384, stream=stream2)
