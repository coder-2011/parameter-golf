...
#   %constant_pad_nd_default_1 : Tensor "bf16[131072, 16][16, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view_7, [0, 4, 0, 0]), kwargs = {})
...
# Graph fragment:
#   %mm_default_1 : Tensor "bf16[8, 16][16, 1]cuda:4" = PlaceHolder[target=mm_default_1]
#   %slice_tensor_1 : Tensor "bf16[8, 12][16, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_default_1, 1, 0, -4), kwargs = {})
#   %convert_element_type_43 : Tensor "f32[8, 12][12, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_tensor_1, torch.float32), kwargs = {})
...
#   %mm_default_2 : Tensor "bf16[131072, 384][384, 1]cuda:4" = PlaceHolder[target=mm_default_2]
...
#   %view_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:4"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_default_2, [128, 1024, 384]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2b/c2bdaxceg4ul36dtazt25f7qhgi4xoncbf6mrehy5vnh2ktyqo2i.py
...
# Graph fragment:
#   %permute_34 : Tensor "bf16[384, 116][116, 1]cuda:4" = PlaceHolder[target=permute_34]
#   %constant_pad_nd_default : Tensor "bf16[384, 120][120, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%permute_34, [0, 4, 0, 0]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/iu/ciujqv4hgyzold7xutdrfcqyzdymjlwqlmrx37z5k2rs74c73k3j.py
...
# Graph fragment:
#   %full_default_5 : Tensor "f32[65536, 116][116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([65536, 116], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:4, pin_memory: False})
#   return %index_put
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/bw/cbwkfxqaqshahd5thu2hkxraqr7k7pxtra4fols6zhufj5o6shne.py
...
#   %mm_default : Tensor "bf16[131072, 120][120, 1]cuda:4" = PlaceHolder[target=mm_default]
#   %index_put : Tensor "f32[65536, 116][116, 1]cuda:4" = PlaceHolder[target=index_put]
#   %slice_tensor : Tensor "bf16[131072, 116][120, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_default, 1, 0, -4), kwargs = {})
#   %view_30 : Tensor "bf16[128, 1024, 116][122880, 120, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%slice_tensor, [128, 1024, 116]), kwargs = {})
#   %convert_element_type_75 : Tensor "f32[128, 1024, 116][118784, 116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_30, torch.float32), kwargs = {})
#   %mul_45 : Tensor "f32[128, 1024, 116][118784, 116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_75, 0.3535533905932738), kwargs = {})
#   %unsqueeze_6 : Tensor "f32[128, 1024, 1, 116][118784, 116, 116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_45, -2), kwargs = {})
#   %expand : Tensor "f32[128, 1024, 8, 116][118784, 116, 0, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze_6, [128, 1024, 8, 116]), kwargs = {})
#   %convert_element_type_default : Tensor "f32[128, 1024, 8, 116][950272, 928, 116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%expand, torch.float32), kwargs = {})
...
#   %full_default_4 : Tensor "f32[][]cuda:4"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:4, pin_memory: False})
#   %where : Tensor "f32[128, 1024, 8, 116][950272, 928, 116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%unsqueeze_7, %full_default_4, %convert_element_type_default), kwargs = {})
#   %full_default_5 : Tensor "f32[65536, 116][116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([65536, 116], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:4, pin_memory: False})
#   %index_put : Tensor "f32[65536, 116][116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_5, [%add_1], %where, True), kwargs = {})
#   return %buf44
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/nn/cnn7vfoh7jnumxo5ltljlfhexh36s5ehfuf7fupj5dcb6yrrsk62.py
...
# Graph fragment:
#   %buf44 : Tensor "f32[65536, 116][116, 1]cuda:4" = PlaceHolder[target=buf44]
#   %convert_element_type_80 : Tensor "bf16[65536, 116][116, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%index_put, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/4b/c4bldftrcblymttwtzw2c77zkfd77nh67qaq53rosv5nf3xk2nkg.py
...
# Graph fragment:
#   %buf47 : Tensor "f32[8192, 384][384, 1]cuda:4" = PlaceHolder[target=buf47]
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(4):
            ...
            # Topologically Sorted Source Nodes: [full_default_2, to_6, sigmoid_1, getitem_8, mul_32, to_7, unsqueeze, sub, mul_34, linear, linear_1, sigmoid, to_5, mul_36, slice_13, add_12, mul_40, mul_41, mul_42, convert_element_type_62, convert_element_type_63, sub_5, mul_43, mul_44, convert_element_type_64], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.rsub, aten._unsafe_view, aten.view, aten.slice, aten.add, aten.sigmoid_backward]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy__unsafe_view_add_mul_rsub_sigmoid_sigmoid_backward_slice_slice_backward_unsqueeze_view_6.run(buf25, primals_12, ne, primals_11, mm_default_2, addmm, buf34, buf39, 50331648, stream=stream4)
            ...
            # Topologically Sorted Source Nodes: [full_default_7], Original ATen: [aten.embedding_dense_backward]
            stream4 = get_raw_stream(4)
            triton_poi_fused_embedding_dense_backward_7.run(buf46, 3145728, stream=stream4)
            buf32 = empty_strided_cuda((128, 1024, 1), (1024, 1, 131072), torch.float32)
            # Call mix order reduction kernel
            # Topologically Sorted Source Nodes: [full_default_2, to_6, sigmoid_1, getitem_8, mul_32, to_7, unsqueeze, mul_6, mul_33, sum_7, sub, mul_34, linear, linear_1, sigmoid, mul_4, to_5, mul_5, add_2, mul_35, sum_8, mul_36, slice_13, add_12, mul_39, sum_9, view_28, add_13, full_default_4, convert_element_type_81, eq_1, unsqueeze_8, where_1, full_default_7, index_put_1], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.sum, aten.rsub, aten._unsafe_view, aten.view, aten.add, aten.slice, aten.embedding_dense_backward]
            workspace_2 = empty_strided_cuda((1572864, ), (1, ), torch.float32)
            stream4 = get_raw_stream(4)
            triton_per_fused__to_copy__unsafe_view_add_embedding_dense_backward_mul_rsub_sigmoid_slice_slice_backward_sum_unsqueeze_view_8.run(buf25, primals_12, ne, mm_default_2, addmm, primals_5, buf35, cat, embedding, primals_11, buf32, buf46, workspace_2, 131072, 384, stream=stream4)
            ...
            # Topologically Sorted Source Nodes: [constant_pad_nd_default], Original ATen: [aten.mm]
            stream4 = get_raw_stream(4)
            triton_poi_fused_mm_13.run(permute_34, buf41, 46080, stream=stream4)
            del permute_34
            ...
            # Topologically Sorted Source Nodes: [full_default_5], Original ATen: [aten.embedding_dense_backward]
            stream4 = get_raw_stream(4)
            triton_poi_fused_embedding_dense_backward_14.run(buf43, 7602176, stream=stream4)
            # Topologically Sorted Source Nodes: [slice_tensor, view_30, convert_element_type_75, mul_45, unsqueeze_6, expand, convert_element_type_default, eq, unsqueeze_7, full_default_4, where, full_default_5, index_put], Original ATen: [aten.mm, aten.view, aten._to_copy, aten.mul, aten.unsqueeze, aten.expand, aten.embedding_dense_backward]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_embedding_dense_backward_expand_mm_mul_unsqueeze_view_15.run(add_1, buf42, buf43, 1048576, 116, stream=stream4)
            del add_1
            del buf42
            buf45 = empty_strided_cuda((65536, 116), (116, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [convert_element_type_80], Original ATen: [aten.embedding_dense_backward]
            stream4 = get_raw_stream(4)
            triton_poi_fused_embedding_dense_backward_16.run(buf43, buf45, 7602176, stream=stream4)
            del buf43
            buf48 = empty_strided_cuda((8192, 384), (384, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [convert_element_type_82], Original ATen: [aten.embedding_dense_backward]
            stream4 = get_raw_stream(4)
            triton_poi_fused_embedding_dense_backward_17.run(buf46, buf48, 3145728, stream=stream4)
            del buf46
...
def get_args():
    ...
    view = rand_strided((131072, 116), (116, 1), device='cuda:4', dtype=torch.bfloat16)
    mm_default_2 = rand_strided((131072, 384), (384, 1), device='cuda:4', dtype=torch.bfloat16)
    ...
    permute_34 = rand_strided((384, 116), (116, 1), device='cuda:4', dtype=torch.bfloat16)
