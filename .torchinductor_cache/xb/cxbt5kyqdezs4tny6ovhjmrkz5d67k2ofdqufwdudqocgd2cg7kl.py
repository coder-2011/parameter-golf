...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/m7/cm7yycyvpaxde7red57spqkm3y7vsw3dm7psqakyetscm4tvzfq4.py
...
#   %add : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:7"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_1, %arg3_1), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(7):
            ...
            buf0 = empty_strided_cuda((350000, 1536), (1536, 1), torch.bfloat16)
            buf1 = empty_strided_cuda((350000, 1536), (1536, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [reshape, triton_kernel_wrapper_mutation], Original ATen: [aten.view]
            stream7 = get_raw_stream(7)
            _leaky_relu_sq_matmul_kernel_0.run(reinterpret_tensor(arg1_1, (350000, 384), (384, 1), 0), arg2_1, buf0, buf1, 65628, 1, 1, stream=stream7)
            del arg1_1
            del arg2_1
            del buf0
            ...
            del arg0_1
            del buf1
            buf5 = reinterpret_tensor(buf4, (350, 1000, 384), (384000, 384, 1), 0); del buf4  # reuse
            # Topologically Sorted Source Nodes: [reshape_1, add], Original ATen: [aten.view, aten.add]
            stream7 = get_raw_stream(7)
            triton_poi_fused_add_view_0.run(buf5, arg3_1, 134400000, stream=stream7)
            del arg3_1
        return (buf5, )
...
def get_args():
    ...
    arg1_1 = rand_strided((350, 1000, 384), (384000, 384, 1), device='cuda:7', dtype=torch.bfloat16)
