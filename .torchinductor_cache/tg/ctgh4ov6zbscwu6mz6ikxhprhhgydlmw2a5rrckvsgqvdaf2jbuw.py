...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/sr/csrbvjxfxhgovjcble7mnb6euxizdpgw3l6vxsqcfeyyij2r65vd.py
...
#   where_3 => where_3
# Graph fragment:
#   %primals_3 : Tensor "i64[131072][1]cuda:0" = PlaceHolder[target=primals_3]
#   %tangents_1 : Tensor "f32[][]cuda:0" = PlaceHolder[target=tangents_1]
#   %convert_element_type_3 : Tensor "f32[][]cuda:0" = PlaceHolder[target=convert_element_type_3]
#   %mm : Tensor "bf16[131072, 8192][8192, 1]cuda:0" = PlaceHolder[target=mm]
#   %amax_default : Tensor "f32[131072, 1][1, 1]cuda:0" = PlaceHolder[target=amax_default]
#   %log : Tensor "f32[131072, 1][1, 1]cuda:0" = PlaceHolder[target=log]
#   %sum_4 : Tensor "f32[131072, 1][1, 131072]cuda:0" = PlaceHolder[target=sum_4]
#   %sub_2 : Tensor "f32[131072, 8192][8192, 1]cuda:0" = PlaceHolder[target=sub_2]
#   %div_2 : Tensor "f32[][]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%tangents_1, %convert_element_type_3), kwargs = {})
#   %unsqueeze_1 : Tensor "i64[131072, 1][1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%primals_3, 1), kwargs = {})
#   %ne_3 : Tensor "b8[131072, 1][1, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.ne.Scalar](args = (%unsqueeze_1, -100), kwargs = {})
...
#   %where_2 : Tensor "i64[131072, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ne_3, %unsqueeze_1, %full_default), kwargs = {})
#   %iota_default : Tensor "i64[8192][1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.iota.default](args = (8192,), kwargs = {start: 0, step: 1, dtype: torch.int64, device: cuda:0, requires_grad: False})
#   %view_default : Tensor "i64[1, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%iota_default, [1, 8192]), kwargs = {})
#   %expand_default : Tensor "i64[131072, 8192][1, 0]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%where_2, [131072, 8192]), kwargs = {})
#   %eq_tensor : Tensor "b8[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.eq.Tensor](args = (%expand_default, %view_default), kwargs = {})
...
#   %where_self : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%eq_tensor, %scalar_tensor_default_1, %scalar_tensor_default), kwargs = {})
...
#   %where_3 : Tensor "f32[131072, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ne_3, %div_2, %full_default_1), kwargs = {})
#   %mul_2 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where_self, %where_3), kwargs = {})
#   %convert_element_type_2 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm, torch.float32), kwargs = {})
#   %div : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%convert_element_type_2, 30.0), kwargs = {})
#   %tanh : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.aten.tanh.default](args = (%div,), kwargs = {})
#   %mul_tensor : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tanh, 1), kwargs = {})
#   %sub_tensor : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_tensor, %amax_default), kwargs = {})
#   %mul_tensor_1 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_tensor, 30.0), kwargs = {})
#   %sub_1 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_tensor_1, %log), kwargs = {})
#   %exp_1 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.exp.default](args = (%sub_1,), kwargs = {})
#   %sum_4 : Tensor "f32[131072, 1][1, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_2, [1], True), kwargs = {})
#   %mul_3 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%exp_1, %sum_4), kwargs = {})
#   %sub_2 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_2, %mul_3), kwargs = {})
#   %mul_4 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_2, 30.0), kwargs = {})
#   %mul_5 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tanh, %tanh), kwargs = {})
#   %sub_3 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (1, %mul_5), kwargs = {})
#   %mul_6 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_4, %sub_3), kwargs = {})
#   %div_3 : Tensor "f32[131072, 8192][8192, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_6, 30.0), kwargs = {})
#   %convert_element_type_4 : Tensor "bf16[131072, 8192][8192, 1]cuda:0"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%div_3, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/jo/cjovzcn7kvjzeak6lojsksrgai2mjp75tucwlvtqf3t3vqa6gx3u.py
# Topologically Sorted Source Nodes: [mul_7], Original ATen: [aten.mul]
# Source node to ATen node mapping:
#   mul_7 => mul_7
# Graph fragment:
#   %mm_1 : Tensor "bf16[8192, 384][384, 1]cuda:0" = PlaceHolder[target=mm_1]
#   %mul_7 : Tensor "bf16[8192, 384][384, 1]cuda:0"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mm_1, 1.0), kwargs = {})
#   return %mul_7
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(0):
            ...
            triton_red_fused__log_softmax__log_softmax_backward_data__to_copy_arange_div_eq_expand_mul_nll_loss_backward_nll_loss_forward_scalar_tensor_sub_tanh_tanh_backward_view_where_0.run(buf2, primals_3, tangents_1, convert_element_type_3, amax_default, log, 131072, 8192, stream=stream0)
            del amax_default
            ...
            # Topologically Sorted Source Nodes: [mul_7], Original ATen: [aten.mul]
            stream0 = get_raw_stream(0)
            triton_poi_fused_mul_1.run(buf5, 3145728, stream=stream0)
...
def get_args():
    ...
    primals_2 = rand_strided((131072, 384), (384, 1), device='cuda:0', dtype=torch.bfloat16)
    primals_3 = rand_strided((131072, ), (1, ), device='cuda:0', dtype=torch.int64)
    mm = rand_strided((131072, 8192), (8192, 1), device='cuda:0', dtype=torch.bfloat16)
    amax_default = rand_strided((131072, 1), (1, 1), device='cuda:0', dtype=torch.float32)
    ...
    permute_3 = rand_strided((8192, 384), (384, 1), device='cuda:0', dtype=torch.bfloat16)
