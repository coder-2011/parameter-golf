...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xt/cxtsndesl3s46ktdtv3rzzu4s3fioixxsnj23bmfbei7pbu3rrvk.py
...
#   view_46 => view_46
# Graph fragment:
#   %add_11 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2" = PlaceHolder[target=add_11]
#   %rsqrt_6 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:2" = PlaceHolder[target=rsqrt_6]
#   %tangents_1 : Tensor "bf16[131072, 384][384, 1]cuda:2" = PlaceHolder[target=tangents_1]
#   %primals_26 : Tensor "f32[384][1]cuda:2" = PlaceHolder[target=primals_26]
#   %sum_7 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:2" = PlaceHolder[target=sum_7]
#   %view_46 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%tangents_1, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_65 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_46, torch.float32), kwargs = {})
#   %convert_element_type_62 : Tensor "bf16[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_26, torch.bfloat16), kwargs = {})
#   %convert_element_type_67 : Tensor "f32[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type_62, torch.float32), kwargs = {})
#   %mul_26 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_65, %convert_element_type_67), kwargs = {})
#   %convert_element_type_63 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_11, torch.float32), kwargs = {})
#   %mul_24 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_63, %rsqrt_6), kwargs = {})
#   %mul_28 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_24, %mul_26), kwargs = {})
#   %sum_7 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_28, [2], True), kwargs = {})
#   %div_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_24, 384), kwargs = {})
#   %mul_29 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_3, %sum_7), kwargs = {})
...
#   %mul_30 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_3, %rsqrt_6), kwargs = {})
#   %mul_31 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_65, %mul_24), kwargs = {})
#   %sum_8 : Tensor "f32[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_31, [0, 1]), kwargs = {})
#   %convert_element_type_68 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_30, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/y6/cy6ljbmptrtt4u5q5irq6g2mpwlvsoq3mip2sw4afmafoeqk4czm.py
...
# Graph fragment:
#   %primals_25 : Tensor "bf16[384, 1536][1536, 1]cuda:2" = PlaceHolder[target=primals_25]
#   %view_47 : Tensor "bf16[131072, 384][384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_68, [-1, 384]), kwargs = {})
#   %permute_35 : Tensor "bf16[1536, 384][1, 1536]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%primals_25, [1, 0]), kwargs = {})
#   %clone_9 : Tensor "bf16[1536, 384][384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%permute_35,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/4l/c4lrudjagdia6ttevfiiugbmtxdypwi7t5z2iveexqkfau4h7kqh.py
...
# Graph fragment:
#   %add_9 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2" = PlaceHolder[target=add_9]
#   %rsqrt_5 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:2" = PlaceHolder[target=rsqrt_5]
#   %mm_15 : Tensor "bf16[131072, 384][384, 1]cuda:2" = PlaceHolder[target=mm_15]
#   %primals_23 : Tensor "f32[384][1]cuda:2" = PlaceHolder[target=primals_23]
#   %convert_element_type_68 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2" = PlaceHolder[target=convert_element_type_68]
#   %sum_9 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:2" = PlaceHolder[target=sum_9]
#   %view_48 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_15, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_77 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_48, torch.float32), kwargs = {})
#   %convert_element_type_57 : Tensor "bf16[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_23, torch.bfloat16), kwargs = {})
#   %convert_element_type_79 : Tensor "f32[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type_57, torch.float32), kwargs = {})
#   %mul_32 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_77, %convert_element_type_79), kwargs = {})
#   %convert_element_type_58 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_9, torch.float32), kwargs = {})
#   %mul_22 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_58, %rsqrt_5), kwargs = {})
#   %mul_34 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_22, %mul_32), kwargs = {})
#   %sum_9 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_34, [2], True), kwargs = {})
#   %div_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_22, 384), kwargs = {})
#   %mul_35 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_4, %sum_9), kwargs = {})
#   %sub_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_32, %mul_35), kwargs = {})
#   %mul_36 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_4, %rsqrt_5), kwargs = {})
#   %mul_37 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_77, %mul_22), kwargs = {})
#   %sum_10 : Tensor "f32[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_37, [0, 1]), kwargs = {})
#   %convert_element_type_80 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_36, torch.bfloat16), kwargs = {})
#   %add_13 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_68, %convert_element_type_80), kwargs = {})
#   return %sum_9,%add_13
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/bo/cbop6ymalk3foxahrk5mm4dpgarq273k7x27t2avd4uadlaer2on.py
...
#   %mm_10 : Tensor "bf16[131072, 8][8, 1]cuda:2" = PlaceHolder[target=mm_10]
#   %div_2 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2" = PlaceHolder[target=div_2]
#   %getitem_28 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:2" = PlaceHolder[target=getitem_28]
#   %sum_6 : Tensor "f32[128, 1024, 4, 2, 1][8192, 8, 2, 1, 1]cuda:2" = PlaceHolder[target=sum_6]
#   %sum_12 : Tensor "f32[128, 1024, 4, 2, 1][8192, 8, 2, 1, 1048576]cuda:2" = PlaceHolder[target=sum_12]
#   %sum_11 : Tensor "f32[128, 1024, 8, 1][8192, 8, 1, 1048576]cuda:2" = PlaceHolder[target=sum_11]
#   %view_50 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_17, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_87 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_50, torch.float32), kwargs = {})
#   %view_51 : Tensor "f32[128, 1024, 8, 48][393216, 384, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_87, [128, 1024, 8, 48]), kwargs = {})
#   %permute_31 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_28, [0, 2, 1, 3]), kwargs = {})
#   %view_33 : Tensor "bf16[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%permute_31, [128, 1024, 4, 2, 48]), kwargs = {})
#   %unsqueeze_4 : Tensor "f32[128, 1024, 4, 1, 48][196608, 192, 48, 48, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%div_2, -2), kwargs = {})
#   %mul_19 : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_6, %unsqueeze_4), kwargs = {})
#   %sub_2 : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%view_33, %mul_19), kwargs = {})
#   %view_34 : Tensor "f32[128, 1024, 8, 48][393216, 384, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%sub_2, [128, 1024, 8, 48]), kwargs = {})
#   %mul_38 : Tensor "f32[128, 1024, 8, 48][393216, 384, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_51, %view_34), kwargs = {})
#   %view_36 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_10, [128, 1024, 8]), kwargs = {})
#   %mul_20 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_36, 0.5), kwargs = {})
#   %sigmoid_2 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_20,), kwargs = {})
...
#   %mul_39 : Tensor "f32[128, 1024, 8, 48][393216, 384, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_51, %unsqueeze_5), kwargs = {})
#   %sum_11 : Tensor "f32[128, 1024, 8, 1][8192, 8, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_38, [3], True), kwargs = {dtype: torch.float32})
#   %convert_element_type_90 : Tensor "bf16[128, 1024, 8, 1][8192, 8, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sum_11, torch.bfloat16), kwargs = {})
#   %squeeze : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%convert_element_type_90, 3), kwargs = {})
#   %convert_element_type_91 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%squeeze, torch.float32), kwargs = {})
#   %convert_element_type_92 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sigmoid_2, torch.float32), kwargs = {})
#   %sub_5 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (1, %convert_element_type_92), kwargs = {})
#   %mul_40 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_92, %sub_5), kwargs = {})
#   %mul_41 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_91, %mul_40), kwargs = {})
#   %convert_element_type_93 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_41, torch.bfloat16), kwargs = {})
#   %mul_42 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_93, 0.5), kwargs = {})
#   %view_54 : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_39, [128, 1024, 4, 2, 48]), kwargs = {})
#   %neg : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.neg.default](args = (%view_54,), kwargs = {})
#   %convert_element_type_99 : Tensor "bf16[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_54, torch.bfloat16), kwargs = {})
#   %mul_44 : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%neg, %unsqueeze_4), kwargs = {})
#   %sum_12 : Tensor "f32[128, 1024, 4, 2, 1][8192, 8, 2, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_44, [4], True), kwargs = {dtype: torch.float32})
#   %expand_3 : Tensor "f32[128, 1024, 4, 2, 48][8192, 8, 2, 1, 0]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.expand.default](args = (%sum_12, [128, 1024, 4, 2, 48]), kwargs = {})
#   %mul_46 : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%expand_3, %unsqueeze_4), kwargs = {})
#   %convert_element_type_100 : Tensor "bf16[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_46, torch.bfloat16), kwargs = {})
#   %add_14 : Tensor "bf16[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_99, %convert_element_type_100), kwargs = {})
#   %view_55 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%add_14, [128, 1024, 8, 48]), kwargs = {})
#   %permute_48 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%view_55, [0, 2, 1, 3]), kwargs = {})
#   %permute_28 : Tensor "bf16[128, 4, 1024, 48][196608, 48, 192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%clone_4, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/rx/crxtd3jiieaiw2o7dk3xpqvbq72iuq7cge4j25z7j6nohv6rsb3y.py
...
# Graph fragment:
#   %view_35 : Tensor "bf16[131072, 12][12, 1]cuda:2" = PlaceHolder[target=view_35]
#   %constant_pad_nd_default_2 : Tensor "bf16[131072, 16][16, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%view_35, [0, 4, 0, 0]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gz/cgzgjlwqsnmoxywa5laangvydnv2vsouanri6gr7pkjwvhre3fzl.py
...
#   %convert_element_type_98 : Tensor "f32[8, 12][12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_tensor_2, torch.float32), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/2u/c2u63jrws2evanuftnh3dgvzz5hsm5pdnjxf647jon6txepky7wy.py
...
#   %sum_12 : Tensor "f32[128, 1024, 4, 2, 1][8192, 8, 2, 1, 1048576]cuda:2" = PlaceHolder[target=sum_12]
#   %getitem_28 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:2" = PlaceHolder[target=getitem_28]
#   %add_15 : Tensor "f32[128, 1024, 4, 1, 48][196608, 192, 48, 48, 1]cuda:2" = PlaceHolder[target=add_15]
#   %div_2 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2" = PlaceHolder[target=div_2]
#   %pow_11 : Tensor "f32[128, 1024, 4, 1][4096, 4, 1, 1]cuda:2" = PlaceHolder[target=pow_11]
#   %view_50 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_17, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_87 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_50, torch.float32), kwargs = {})
#   %view_51 : Tensor "f32[128, 1024, 8, 48][393216, 384, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_87, [128, 1024, 8, 48]), kwargs = {})
#   %permute_31 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_28, [0, 2, 1, 3]), kwargs = {})
...
#   %view_54 : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%mul_39, [128, 1024, 4, 2, 48]), kwargs = {})
#   %neg : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.neg.default](args = (%view_54,), kwargs = {})
#   %mul_43 : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%neg, %sum_6), kwargs = {})
#   %sum_13 : Tensor "f32[128, 1024, 4, 1, 48][196608, 192, 48, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_43, [3], True), kwargs = {dtype: torch.float32})
#   %expand_3 : Tensor "f32[128, 1024, 4, 2, 48][8192, 8, 2, 1, 0]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.expand.default](args = (%sum_12, [128, 1024, 4, 2, 48]), kwargs = {})
#   %mul_45 : Tensor "f32[128, 1024, 4, 2, 48][393216, 384, 96, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%expand_3, %view_33), kwargs = {})
#   %sum_14 : Tensor "f32[128, 1024, 4, 1, 48][196608, 192, 48, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_45, [3], True), kwargs = {dtype: torch.float32})
#   %add_15 : Tensor "f32[128, 1024, 4, 1, 48][196608, 192, 48, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%sum_13, %sum_14), kwargs = {})
#   %squeeze_1 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.squeeze.dim](args = (%add_15, -2), kwargs = {})
#   %clamp_min_2 : Tensor "f32[128, 1024, 4, 1][4096, 4, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%pow_11, 1e-12), kwargs = {})
#   %expand_2 : Tensor "f32[128, 1024, 4, 48][4096, 4, 1, 0]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.expand.default](args = (%clamp_min_2, [128, 1024, 4, 48]), kwargs = {})
#   %div_6 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%div_2, %expand_2), kwargs = {})
#   %neg_1 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.neg.default](args = (%squeeze_1,), kwargs = {})
#   %mul_47 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%neg_1, %div_6), kwargs = {})
#   %sum_15 : Tensor "f32[128, 1024, 4, 1][4096, 4, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_47, [3], True), kwargs = {dtype: torch.float32})
...
@triton_heuristics.persistent_reduction(
    ...
    reduction_hint=ReductionHint.INNER,
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*bf16', 'in_ptr1': '*bf16', 'in_ptr2': '*fp32', 'in_ptr3': '*fp32', 'in_ptr4': '*bf16', 'in_ptr5': '*fp32', 'in_ptr6': '*fp32', 'out_ptr0': '*fp32', 'out_ptr1': '*fp32', 'xnumel': 'i32', 'r0_numel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=2, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]], (5,): [['tt.divisibility', 16]], (6,): [['tt.divisibility', 16]], (7,): [['tt.divisibility', 16]], (8,): [['tt.divisibility', 16]], (9,): [['tt.divisibility', 16]], (10,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dw/cdwoqje6o7h7f3fl7xiwssflbt4qwksnlj3rrihyyxoojflr4rb7.py
...
#   %add_15 : Tensor "f32[128, 1024, 4, 1, 48][196608, 192, 48, 48, 1]cuda:2" = PlaceHolder[target=add_15]
#   %pow_11 : Tensor "f32[128, 1024, 4, 1][4096, 4, 1, 1]cuda:2" = PlaceHolder[target=pow_11]
#   %sum_15 : Tensor "f32[128, 1024, 4, 1][4096, 4, 1, 524288]cuda:2" = PlaceHolder[target=sum_15]
#   %clone_4 : Tensor "bf16[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2" = PlaceHolder[target=clone_4]
#   %getitem_42 : Tensor "bf16[128, 4, 1024, 48][196608, 48, 192, 1]cuda:2" = PlaceHolder[target=getitem_42]
#   %squeeze_1 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.squeeze.dim](args = (%add_15, -2), kwargs = {})
#   %clamp_min_2 : Tensor "f32[128, 1024, 4, 1][4096, 4, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.clamp_min.default](args = (%pow_11, 1e-12), kwargs = {})
#   %expand_2 : Tensor "f32[128, 1024, 4, 48][4096, 4, 1, 0]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.expand.default](args = (%clamp_min_2, [128, 1024, 4, 48]), kwargs = {})
#   %div_7 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%squeeze_1, %expand_2), kwargs = {})
#   %convert_element_type_101 : Tensor "bf16[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%div_7, torch.bfloat16), kwargs = {})
#   %full_default_1 : Tensor "f32[][]cuda:2"[num_users=6] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:2, pin_memory: False})
#   %ge : Tensor "b8[128, 1024, 4, 1][4096, 4, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.ge.Scalar](args = (%pow_11, 1e-12), kwargs = {})
#   %where : Tensor "f32[128, 1024, 4, 1][4096, 4, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%ge, %sum_15, %full_default_1), kwargs = {})
#   %div_8 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%clone_4, %pow_11), kwargs = {})
#   %eq : Tensor "b8[128, 1024, 4, 1][4096, 4, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%pow_11, 0), kwargs = {})
#   %where_1 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%eq, %full_default_1, %div_8), kwargs = {})
#   %mul_48 : Tensor "f32[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%where, %where_1), kwargs = {})
#   %convert_element_type_102 : Tensor "bf16[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_48, torch.bfloat16), kwargs = {})
#   %add_16 : Tensor "bf16[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_101, %convert_element_type_102), kwargs = {})
#   %permute_49 : Tensor "bf16[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_42, [0, 2, 1, 3]), kwargs = {})
#   %add_17 : Tensor "bf16[128, 1024, 4, 48][196608, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_16, %permute_49), kwargs = {})
#   %slice_7 : Tensor "bf16[128, 1024, 4, 48][786432, 768, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%empty_13, 2, 12, 9223372036854775807), kwargs = {})
#   %copy : Tensor "bf16[128, 1024, 4, 48][786432, 768, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_7, %add_17), kwargs = {})
#   %slice_scatter_default_1 : Tensor "bf16[128, 1024, 16, 48][786432, 768, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%empty_13, %copy, 2, 12, 9223372036854775807), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/on/conp5gtw3bo5roau4di4qa4lvlln42kppzrpeo6qec3nk7iazowp.py
...
#   %primals_19 : Tensor "f32[384][1]cuda:2" = PlaceHolder[target=primals_19]
#   %add_13 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2" = PlaceHolder[target=add_13]
#   %sum_16 : Tensor "f32[128, 1024, 1][1024, 1, 131072]cuda:2" = PlaceHolder[target=sum_16]
#   %view_53 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_19, [128, 1024, 12]), kwargs = {})
#   %full_default : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:2, pin_memory: False})
#   %slice_scatter_default : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default, %view_53, 2, 0, 12), kwargs = {})
#   %view_63 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_21, [128, 1024, 384]), kwargs = {})
#   %add_18 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %view_63), kwargs = {})
#   %convert_element_type_107 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_18, torch.float32), kwargs = {})
#   %convert_element_type_43 : Tensor "bf16[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_19, torch.bfloat16), kwargs = {})
#   %convert_element_type_109 : Tensor "f32[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%convert_element_type_43, torch.float32), kwargs = {})
#   %mul_49 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_107, %convert_element_type_109), kwargs = {})
#   %convert_element_type_44 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_7, torch.float32), kwargs = {})
#   %mul_16 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_44, %rsqrt_4), kwargs = {})
#   %mul_51 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_16, %mul_49), kwargs = {})
#   %sum_16 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_51, [2], True), kwargs = {})
#   %div_9 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_16, 384), kwargs = {})
#   %mul_52 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_9, %sum_16), kwargs = {})
#   %sub_6 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_49, %mul_52), kwargs = {})
#   %mul_53 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_6, %rsqrt_4), kwargs = {})
#   %mul_54 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_107, %mul_16), kwargs = {})
#   %sum_17 : Tensor "f32[384][1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_54, [0, 1]), kwargs = {})
#   %convert_element_type_110 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_53, torch.bfloat16), kwargs = {})
#   %add_19 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_13, %convert_element_type_110), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ut/cutqnkf2fpz55hjke76tp4ps7rok346273tro6boq5fjknaqu5gt.py
...
#   %view_99 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_41, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_201 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_99, torch.float32), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_view_0.run(add_11, rsqrt_6, tangents_1, primals_26, buf3, workspace_0, 131072, 384, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [reshape, getattr_6, contiguous_2, triton_kernel_wrapper_mutation], Original ATen: [aten.view, aten.permute, aten.clone]
            stream2 = get_raw_stream(2)
            triton_poi_fused_clone_permute_view_1.run(primals_25, buf6, 1536, 384, stream=stream2)
            del primals_25
            # Topologically Sorted Source Nodes: [reshape, getattr_6, contiguous_2, triton_kernel_wrapper_mutation], Original ATen: [aten.view, aten.permute, aten.clone]
            stream2 = get_raw_stream(2)
            _leaky_relu_sq_matmul_kernel_0.run(reinterpret_tensor(buf3, (131072, 384), (384, 1), 0), buf6, buf5, getitem_37, 24576, 1, 1, stream=stream2)
            del getitem_37
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_view_2.run(buf13, add_9, rsqrt_5, buf9, primals_23, workspace_1, 131072, 384, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [view_50, convert_element_type_87, view_51, transpose_11, view_5, unsqueeze_2, mul_9, sub_2, reshape_6, mul_38, linear_8, mul_10, sigmoid_2, getitem_16, mul_39, sum_11, convert_element_type_90, squeeze, convert_element_type_91, convert_element_type_92, sub_5, mul_40, mul_41, convert_element_type_93, mul_42, view_54, neg, convert_element_type_99, mul_44, sum_12, expand_3, mul_46, convert_element_type_100, add_14, view_55, permute_48, transpose_10, _scaled_dot_product_flash_attention_backward], Original ATen: [aten.view, aten._to_copy, aten.transpose, aten.unsqueeze, aten.mul, aten.sub, aten._unsafe_view, aten.sigmoid, aten.sum, aten.squeeze, aten.sigmoid_backward, aten.neg, aten.expand, aten.add, aten._scaled_dot_product_flash_attention_backward]
            stream2 = get_raw_stream(2)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_add_expand_mul_neg_sigmoid_sigmoid_backward_squeeze_sub_sum_transpose_unsqueeze_view_3.run(buf15, mm_10, div_2, getitem_28, sum_6, buf22, buf25, buf17, 1048576, 48, stream=stream2)
            buf18 = empty_strided_cuda((131072, 16), (16, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [constant_pad_nd_default_2], Original ATen: [aten.mm]
            stream2 = get_raw_stream(2)
            triton_poi_fused_mm_4.run(view_35, buf18, 2097152, stream=stream2)
            del view_35
            ...
            # Topologically Sorted Source Nodes: [slice_tensor_2, convert_element_type_98], Original ATen: [aten.mm, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_mm_5.run(buf19, buf21, 96, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [view_50, convert_element_type_87, view_51, transpose_11, view_5, linear_8, mul_10, sigmoid_2, getitem_16, mul_39, view_54, neg, mul_43, sum_13, expand_3, mul_45, sum_14, add_15, squeeze_1, normalize_2, div_6, neg_1, mul_47, sum_15], Original ATen: [aten.view, aten._to_copy, aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze, aten.neg, aten.sum, aten.expand, aten.add, aten.squeeze, aten.clamp_min, aten.div]
            stream2 = get_raw_stream(2)
            triton_per_fused__to_copy__unsafe_view_add_clamp_min_div_expand_mul_neg_sigmoid_squeeze_sum_transpose_unsqueeze_view_6.run(buf15, mm_10, sum_6, buf22, getitem_28, div_2, pow_11, buf23, buf24, 524288, 48, stream=stream2)
            del buf15
            del div_2
            del mm_10
            del sum_6
            ...
            # Topologically Sorted Source Nodes: [squeeze_1, normalize_2, div_7, convert_element_type_101, full_default_1, ge, where, div_8, eq, where_1, mul_48, convert_element_type_102, add_16, permute_49, add_17, getitem, copy_], Original ATen: [aten.squeeze, aten.clamp_min, aten.expand, aten.div, aten._to_copy, aten.scalar_tensor, aten.ge, aten.where, aten.eq, aten.masked_fill, aten.mul, aten.add, aten.transpose, aten.slice, aten.copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_add_clamp_min_copy_div_eq_expand_ge_masked_fill_mul_scalar_tensor_slice_squeeze_transpose_where_7.run(buf23, pow_11, buf24, clone_4, buf29, buf31, 100663296, stream=stream2)
            del buf29
            del clone_4
            del pow_11
            # Topologically Sorted Source Nodes: [permute_50, permute_51, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose]
            stream2 = get_raw_stream(2)
            _fused_qkv_postprocess_bwd_kernel_1.run(reinterpret_tensor(buf27, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf28, (128, 1024, 4, 48), (196608, 192, 48, 1), 0), view_32, buf31, select_1, select_3, 1572864, 1, 1, stream=stream2)
            del buf28
            del view_32
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_slice_backward_view_8.run(buf38, add_7, rsqrt_4, buf20, buf34, primals_19, workspace_2, 131072, 384, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused_clone_permute_view_1.run(primals_18, buf41, 1536, 384, stream=stream2)
            del primals_18
            # Topologically Sorted Source Nodes: [reshape, getattr_4, contiguous_2, triton_kernel_wrapper_mutation], Original ATen: [aten.view, aten.permute, aten.clone]
            stream2 = get_raw_stream(2)
            _leaky_relu_sq_matmul_kernel_0.run(reinterpret_tensor(buf38, (131072, 384), (384, 1), 0), buf41, buf40, getitem_24, 24576, 1, 1, stream=stream2)
            del getitem_24
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_view_2.run(buf48, add_5, rsqrt_3, buf44, primals_16, workspace_3, 131072, 384, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_add_expand_mul_neg_sigmoid_sigmoid_backward_squeeze_sub_sum_transpose_unsqueeze_view_3.run(buf50, mm_6, div_1, getitem_15, sum_4, buf57, buf60, buf52, 1048576, 48, stream=stream2)
            buf53 = buf18; del buf18  # reuse
            # Topologically Sorted Source Nodes: [constant_pad_nd_default_1], Original ATen: [aten.mm]
            stream2 = get_raw_stream(2)
            triton_poi_fused_mm_4.run(view_21, buf53, 2097152, stream=stream2)
            del view_21
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_mm_5.run(buf54, buf56, 96, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__to_copy__unsafe_view_add_clamp_min_div_expand_mul_neg_sigmoid_squeeze_sum_transpose_unsqueeze_view_6.run(buf50, mm_6, sum_4, buf57, getitem_15, div_1, pow_7, buf58, buf59, 524288, 48, stream=stream2)
            del buf50
            del div_1
            del mm_6
            del sum_4
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_add_clamp_min_copy_div_eq_expand_ge_masked_fill_mul_scalar_tensor_slice_squeeze_transpose_where_7.run(buf58, pow_7, buf59, clone_2, buf64, buf66, 100663296, stream=stream2)
            del buf64
            del clone_2
            del pow_7
            # Topologically Sorted Source Nodes: [permute_70, permute_71, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose]
            stream2 = get_raw_stream(2)
            _fused_qkv_postprocess_bwd_kernel_1.run(reinterpret_tensor(buf62, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf63, (128, 1024, 4, 48), (196608, 192, 48, 1), 0), view_18, buf66, select_1, select_3, 1572864, 1, 1, stream=stream2)
            del buf63
            del view_18
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_slice_backward_view_8.run(buf73, add_3, rsqrt_2, buf55, buf69, primals_12, workspace_4, 131072, 384, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused_clone_permute_view_1.run(primals_11, buf76, 1536, 384, stream=stream2)
            del primals_11
            # Topologically Sorted Source Nodes: [reshape, getattr_2, contiguous_2, triton_kernel_wrapper_mutation], Original ATen: [aten.view, aten.permute, aten.clone]
            stream2 = get_raw_stream(2)
            _leaky_relu_sq_matmul_kernel_0.run(reinterpret_tensor(buf73, (131072, 384), (384, 1), 0), buf76, buf75, getitem_11, 24576, 1, 1, stream=stream2)
            del getitem_11
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_view_2.run(buf83, add_1, rsqrt_1, buf79, primals_9, workspace_5, 131072, 384, stream=stream2)
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_add_expand_mul_neg_sigmoid_sigmoid_backward_squeeze_sub_sum_transpose_unsqueeze_view_3.run(buf85, mm_2, div, getitem_2, sum_2, buf92, buf95, buf87, 1048576, 48, stream=stream2)
            buf88 = buf53; del buf53  # reuse
            # Topologically Sorted Source Nodes: [constant_pad_nd_default], Original ATen: [aten.mm]
            stream2 = get_raw_stream(2)
            triton_poi_fused_mm_4.run(view_7, buf88, 2097152, stream=stream2)
            del view_7
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_mm_5.run(buf89, buf91, 96, stream=stream2)
            del buf89
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__to_copy__unsafe_view_add_clamp_min_div_expand_mul_neg_sigmoid_squeeze_sum_transpose_unsqueeze_view_6.run(buf85, mm_2, sum_2, buf92, getitem_2, div, pow_3, buf93, buf94, 524288, 48, stream=stream2)
            del buf85
            del buf92
            del div
            del mm_2
            ...
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_add_clamp_min_copy_div_eq_expand_ge_masked_fill_mul_scalar_tensor_slice_squeeze_transpose_where_7.run(buf93, pow_3, buf94, clone, buf99, buf101, 100663296, stream=stream2)
            del buf93
            del buf94
            del buf99
            del clone
            ...
            stream2 = get_raw_stream(2)
            _fused_qkv_postprocess_bwd_kernel_1.run(reinterpret_tensor(buf97, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf98, (128, 1024, 4, 48), (196608, 192, 48, 1), 0), view_4, buf101, select_1, select_3, 1572864, 1, 1, stream=stream2)
            del buf98
            del select_1
            del select_3
            del view_4
            ...
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_slice_backward_view_8.run(buf108, mm, rsqrt, buf90, buf104, primals_3, workspace_6, 131072, 384, stream=stream2)
            ...
            # Topologically Sorted Source Nodes: [view_99, convert_element_type_201], Original ATen: [aten.view, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_view_9.run(buf110, buf111, 50331648, stream=stream2)
            del buf110
...
def get_args():
    ...
    primals_3 = rand_strided((384, ), (1, ), device='cuda:2', dtype=torch.float32)
    primals_4 = rand_strided((768, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_9 = rand_strided((384, ), (1, ), device='cuda:2', dtype=torch.float32)
    primals_10 = rand_strided((1536, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_11 = rand_strided((384, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_12 = rand_strided((384, ), (1, ), device='cuda:2', dtype=torch.float32)
    primals_13 = rand_strided((768, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    primals_18 = rand_strided((384, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_19 = rand_strided((384, ), (1, ), device='cuda:2', dtype=torch.float32)
    primals_20 = rand_strided((768, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_23 = rand_strided((384, ), (1, ), device='cuda:2', dtype=torch.float32)
    primals_24 = rand_strided((1536, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    primals_25 = rand_strided((384, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    view_2 = rand_strided((131072, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    view_4 = rand_strided((128, 1024, 16, 48), (786432, 768, 48, 1), device='cuda:2', dtype=torch.bfloat16)
    clone = rand_strided((128, 1024, 4, 48), (196608, 192, 48, 1), device='cuda:2', dtype=torch.bfloat16)
    select_1 = rand_strided((1024, 24), (24, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    permute_6 = rand_strided((128, 4, 1024, 48), (196608, 48, 192, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    pow_3 = rand_strided((128, 1024, 4, 1), (4096, 4, 1, 1), device='cuda:2', dtype=torch.float32)
    div = rand_strided((128, 1024, 4, 48), (196608, 192, 48, 1), device='cuda:2', dtype=torch.float32)
    sum_2 = rand_strided((128, 1024, 4, 2, 1), (8192, 8, 2, 1, 1), device='cuda:2', dtype=torch.float32)
    ...
    add_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    rsqrt_1 = rand_strided((128, 1024, 1), (1024, 1, 1), device='cuda:2', dtype=torch.float32)
    view_13 = rand_strided((131072, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_11 = rand_strided((131072, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_12 = rand_strided((131072, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    view_16 = rand_strided((131072, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    view_18 = rand_strided((128, 1024, 16, 48), (786432, 768, 48, 1), device='cuda:2', dtype=torch.bfloat16)
    clone_2 = rand_strided((128, 1024, 4, 48), (196608, 192, 48, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_17 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_18 = rand_strided((128, 4, 1024, 48), (196608, 48, 192, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_15 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_16 = rand_strided((128, 8, 1024), (8192, 1024, 1), device='cuda:2', dtype=torch.float32)
    getitem_21 = rand_strided((2, ), (1, ), device='cuda:2', dtype=torch.uint64)
    getitem_22 = rand_strided((), (), device='cuda:2', dtype=torch.uint64)
    pow_7 = rand_strided((128, 1024, 4, 1), (4096, 4, 1, 1), device='cuda:2', dtype=torch.float32)
    div_1 = rand_strided((128, 1024, 4, 48), (196608, 192, 48, 1), device='cuda:2', dtype=torch.float32)
    sum_4 = rand_strided((128, 1024, 4, 2, 1), (8192, 8, 2, 1, 1), device='cuda:2', dtype=torch.float32)
    view_21 = rand_strided((131072, 12), (12, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    rsqrt_3 = rand_strided((128, 1024, 1), (1024, 1, 1), device='cuda:2', dtype=torch.float32)
    view_27 = rand_strided((131072, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_24 = rand_strided((131072, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_25 = rand_strided((131072, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    add_7 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    ...
    view_32 = rand_strided((128, 1024, 16, 48), (786432, 768, 48, 1), device='cuda:2', dtype=torch.bfloat16)
    clone_4 = rand_strided((128, 1024, 4, 48), (196608, 192, 48, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_29 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_30 = rand_strided((128, 4, 1024, 48), (196608, 48, 192, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_28 = rand_strided((128, 8, 1024, 48), (393216, 48, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_29 = rand_strided((128, 8, 1024), (8192, 1024, 1), device='cuda:2', dtype=torch.float32)
    getitem_34 = rand_strided((2, ), (1, ), device='cuda:2', dtype=torch.uint64)
    getitem_35 = rand_strided((), (), device='cuda:2', dtype=torch.uint64)
    pow_11 = rand_strided((128, 1024, 4, 1), (4096, 4, 1, 1), device='cuda:2', dtype=torch.float32)
    div_2 = rand_strided((128, 1024, 4, 48), (196608, 192, 48, 1), device='cuda:2', dtype=torch.float32)
    sum_6 = rand_strided((128, 1024, 4, 2, 1), (8192, 8, 2, 1, 1), device='cuda:2', dtype=torch.float32)
    view_35 = rand_strided((131072, 12), (12, 1), device='cuda:2', dtype=torch.bfloat16)
    mm_10 = rand_strided((131072, 8), (8, 1), device='cuda:2', dtype=torch.bfloat16)
    view_38 = rand_strided((131072, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    add_9 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    rsqrt_5 = rand_strided((128, 1024, 1), (1024, 1, 1), device='cuda:2', dtype=torch.float32)
    view_41 = rand_strided((131072, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_37 = rand_strided((131072, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    getitem_38 = rand_strided((131072, 1536), (1536, 1), device='cuda:2', dtype=torch.bfloat16)
    add_11 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    rsqrt_6 = rand_strided((128, 1024, 1), (1024, 1, 1), device='cuda:2', dtype=torch.float32)
    permute_42 = rand_strided((384, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_46 = rand_strided((8, 12), (12, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_62 = rand_strided((384, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_66 = rand_strided((8, 12), (12, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_82 = rand_strided((384, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_86 = rand_strided((8, 12), (12, 1), device='cuda:2', dtype=torch.bfloat16)
    permute_99 = rand_strided((384, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
    tangents_1 = rand_strided((131072, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
