...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/lm/clmptkaxang6eetuty5k6mn3cynmh5sn2r6ppg2s35f5dm2gt5fp.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/we/cweu3uy2akk4nifiisi6z36g3n6qcscv4baurauhbix5tdldbn3m.py
...
#   view_34 => view_34
# Graph fragment:
#   %mm_14 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_14]
...
#   %view_33 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_14, [128, 1024, 384]), kwargs = {})
#   %view_34 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%view_33, [128, 1024, 8, 48]), kwargs = {})
...
#   %mul_43 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_34, %permute_28), kwargs = {})
...
#   %mul_44 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_34, %unsqueeze_22), kwargs = {})
#   %sum_3 : Tensor "f32[128, 1024, 8, 1][8192, 8, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_43, [3], True), kwargs = {dtype: torch.float32})
#   %convert_element_type_63 : Tensor "bf16[128, 1024, 8, 1][8192, 8, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sum_3, torch.bfloat16), kwargs = {})
#   %squeeze : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%convert_element_type_63, 3), kwargs = {})
#   %convert_element_type_64 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%squeeze, torch.float32), kwargs = {})
#   %convert_element_type_65 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%sigmoid_2, torch.float32), kwargs = {})
#   %sub_1 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (1, %convert_element_type_65), kwargs = {})
#   %mul_45 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_65, %sub_1), kwargs = {})
#   %mul_46 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_64, %mul_45), kwargs = {})
#   %convert_element_type_66 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_46, torch.bfloat16), kwargs = {})
#   %mul_47 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_66, 0.5), kwargs = {})
#   %permute_39 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%mul_44, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/og/cogvdtaeeawjvadf255yncsk6iuonnfqsv3vj5cv3kkjkaky3kkz.py
...
#   %convert_element_type_72 : Tensor "f32[8, 12][12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%slice_tensor_2, torch.float32), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/3i/c3iyylwaev5fhzo6hgcx3l4jyp34qi457estuargc6bphqbx42v2.py
...
#   %permute_40 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_35, [0, 2, 1, 3]), kwargs = {})
#   %permute_41 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_34, [0, 2, 1, 3]), kwargs = {})
#   %permute_42 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_33, [0, 2, 1, 3]), kwargs = {})
...
#   %copy : Tensor "bf16[128, 1024, 8, 48][1179648, 1152, 48, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_7, %permute_40), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/5w/c5wumc5x543akpxfxgnjji5gxb74mawhy6pbad77t3o7lnnnf4ca.py
...
#   %tangents_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=tangents_1]
#   %primals_32 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_32]
#   %mm_16 : Tensor "bf16[131072, 12][12, 1]cuda:6" = PlaceHolder[target=mm_16]
#   %mm_18 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_18]
...
#   %mul_36 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%tangents_1, 0.5), kwargs = {})
#   %mul_37 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_36, %primals_32), kwargs = {})
...
#   %mul_39 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %mul_37), kwargs = {})
#   %sum_1 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_39, [2], True), kwargs = {})
...
#   %mul_40 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %sum_1), kwargs = {})
#   %sub : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_37, %mul_40), kwargs = {})
#   %mul_41 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %rsqrt_4), kwargs = {})
#   %mul_42 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_36, %mul_28), kwargs = {})
#   %sum_2 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_42, [0, 1]), kwargs = {})
#   %add_13 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%tangents_3, %mul_41), kwargs = {})
#   %view_36 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_16, [128, 1024, 12]), kwargs = {})
#   %convert_element_type_71 : Tensor "f32[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_36, torch.float32), kwargs = {})
...
#   %slice_scatter_default : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default, %convert_element_type_71, 2, 0, 12), kwargs = {})
#   %view_44 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_18, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_77 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_44, torch.float32), kwargs = {})
#   %add_14 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %convert_element_type_77), kwargs = {})
#   %mul_48 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_14, 0.5), kwargs = {})
#   %mul_49 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_48, %primals_26), kwargs = {})
#   %mul_51 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %mul_49), kwargs = {})
#   %sum_4 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_51, [2], True), kwargs = {})
#   %mul_52 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %sum_4), kwargs = {})
#   %sub_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_49, %mul_52), kwargs = {})
#   %mul_53 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_2, %rsqrt_4), kwargs = {})
#   %mul_54 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_48, %mul_28), kwargs = {})
#   %sum_5 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_54, [0, 1]), kwargs = {})
#   %add_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_13, %mul_53), kwargs = {})
...
#   %mul_56 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %unsqueeze_19), kwargs = {})
...
#   %mul_58 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_56, %unsqueeze_17), kwargs = {})
#   %convert_element_type_80 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_58, torch.bfloat16), kwargs = {})
...
#   %mul_60 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_56, %unsqueeze_15), kwargs = {})
#   %convert_element_type_81 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_60, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/hx/chx2lezlhibyceyhzgz2ksbw7eu3ltuqdlhfwz2o7uqbkze46anu.py
...
#   where_2 => where_2
# Graph fragment:
#   %mm_8 : Tensor "bf16[131072, 1024][1024, 1]cuda:6" = PlaceHolder[target=mm_8]
#   %mm_20 : Tensor "bf16[131072, 1024][1024, 1]cuda:6" = PlaceHolder[target=mm_20]
#   %view_46 : Tensor "bf16[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_20, [128, 1024, 1024]), kwargs = {})
#   %convert_element_type_86 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_46, torch.float32), kwargs = {})
#   %view_21 : Tensor "bf16[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_8, [128, 1024, 1024]), kwargs = {})
#   %convert_element_type_40 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_21, torch.float32), kwargs = {})
#   %gt_1 : Tensor "b8[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.gt.Scalar](args = (%convert_element_type_40, 0), kwargs = {})
#   %mul_23 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_40, 0.5), kwargs = {})
#   %where_1 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt_1, %convert_element_type_40, %mul_23), kwargs = {})
#   %pow_9 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%where_1, 1.0), kwargs = {})
#   %mul_62 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Scalar](args = (%pow_9, 2.0), kwargs = {})
#   %mul_63 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_86, %mul_62), kwargs = {})
#   %mul_64 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_63, 0.5), kwargs = {})
#   %where_2 : Tensor "f32[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt_1, %mul_63, %mul_64), kwargs = {})
#   %convert_element_type_92 : Tensor "bf16[128, 1024, 1024][1048576, 1024, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%where_2, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/r6/cr622dtm6wsppu3mkujdocy43ohxdcraiwpfwwm5qfjkgjd4z6d2.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/bj/cbjacoegotdlmd7pa3h43zohzz7qjyimfjyhdlr3tqpff6nd4wwr.py
...
#   %mm_22 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_22]
#   %primals_22 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_22]
#   %mm_26 : Tensor "bf16[131072, 12][12, 1]cuda:6" = PlaceHolder[target=mm_26]
#   %mm_28 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_28]
...
#   %unsqueeze_19 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_18, 1), kwargs = {})
#   %mul_56 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %unsqueeze_19), kwargs = {})
#   %view_48 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_22, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_97 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_48, torch.float32), kwargs = {})
#   %mul_65 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_97, 0.5773502691896258), kwargs = {})
#   %mul_66 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_65, %primals_22), kwargs = {})
#   %select_6 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_15, 0, 0), kwargs = {})
#   %unsqueeze_9 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_6, 0), kwargs = {})
#   %unsqueeze_10 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_9, 1), kwargs = {})
#   %mul_68 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %mul_66), kwargs = {})
#   %sum_10 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_68, [2], True), kwargs = {})
...
#   %mul_69 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_2, %sum_10), kwargs = {})
#   %sub_3 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_66, %mul_69), kwargs = {})
#   %mul_70 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_3, %rsqrt_2), kwargs = {})
#   %mul_71 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_65, %mul_15), kwargs = {})
#   %sum_11 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_71, [0, 1]), kwargs = {})
#   %add_17 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_56, %mul_70), kwargs = {})
#   %view_53 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_26, [128, 1024, 12]), kwargs = {})
#   %convert_element_type_112 : Tensor "f32[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_53, torch.float32), kwargs = {})
#   %slice_scatter_default_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default, %convert_element_type_112, 2, 0, 12), kwargs = {})
#   %view_61 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_28, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_118 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_61, torch.float32), kwargs = {})
#   %add_18 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default_2, %convert_element_type_118), kwargs = {})
#   %mul_77 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_18, 0.5773502691896258), kwargs = {})
#   %mul_78 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_77, %primals_16), kwargs = {})
#   %mul_80 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %mul_78), kwargs = {})
#   %sum_13 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_80, [2], True), kwargs = {})
#   %mul_81 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_2, %sum_13), kwargs = {})
#   %sub_5 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_78, %mul_81), kwargs = {})
#   %mul_82 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_5, %rsqrt_2), kwargs = {})
#   %mul_83 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_77, %mul_15), kwargs = {})
#   %sum_14 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_83, [0, 1]), kwargs = {})
#   %add_19 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_17, %mul_82), kwargs = {})
#   %mul_85 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %unsqueeze_10), kwargs = {})
...
#   %mul_87 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_85, %unsqueeze_8), kwargs = {})
#   %convert_element_type_121 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_87, torch.bfloat16), kwargs = {})
...
#   %mul_89 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_85, %unsqueeze_6), kwargs = {})
#   %convert_element_type_122 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_89, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/54/c54btckgrrwlfizhpzx3nlz73sreyp6vc7mk7k3rxfansi27b3gg.py
...
#   %mul_55 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %primals_3), kwargs = {})
#   %sum_6 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_55, [0, 1], True), kwargs = {dtype: torch.float32})
#   %select_12 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_25, 0, 0), kwargs = {})
#   %unsqueeze_18 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_12, 0), kwargs = {})
#   %unsqueeze_19 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_18, 1), kwargs = {})
#   %mul_56 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %unsqueeze_19), kwargs = {})
#   %mul_57 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %add_9), kwargs = {})
#   %sum_7 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_57, [0, 1], True), kwargs = {dtype: torch.float32})
...
#   %mul_59 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_56, %view_23), kwargs = {})
#   %sum_8 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_59, [0, 1], True), kwargs = {dtype: torch.float32})
...
#   %mul_61 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_56, %view_19), kwargs = {})
#   %sum_9 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_61, [0, 1], True), kwargs = {dtype: torch.float32})
#   %select_6 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_15, 0, 0), kwargs = {})
#   %unsqueeze_9 : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select_6, 0), kwargs = {})
#   %unsqueeze_10 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_9, 1), kwargs = {})
#   %mul_84 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %primals_3), kwargs = {})
#   %sum_15 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_84, [0, 1], True), kwargs = {dtype: torch.float32})
#   %mul_85 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %unsqueeze_10), kwargs = {})
#   %mul_86 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %add_4), kwargs = {})
#   %sum_16 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_86, [0, 1], True), kwargs = {dtype: torch.float32})
...
#   %mul_88 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_85, %view_11), kwargs = {})
#   %sum_17 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_88, [0, 1], True), kwargs = {dtype: torch.float32})
...
#   %mul_90 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_85, %view_7), kwargs = {})
#   %sum_18 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_90, [0, 1], True), kwargs = {dtype: torch.float32})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/d3/cd3zjeio7ggut62ibxehg24ecqmwarkkf6vekj626abtusvn4r5b.py
# Topologically Sorted Source Nodes: [mul_55, sum_6], Original ATen: [aten.mul, aten.sum]
# Source node to ATen node mapping:
#   mul_55 => mul_55
#   sum_6 => sum_6
# Graph fragment:
#   %buf25 : Tensor "f32[1, 1, 384, 349][134016, 134016, 1, 384]cuda:6" = PlaceHolder[target=buf25]
#   %mul_55 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_15, %primals_3), kwargs = {})
#   %sum_6 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_55, [0, 1], True), kwargs = {dtype: torch.float32})
#   return %sum_6
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/67/c67dm5lmpv2ttoget37imsms4jzvb2ukihotemv2e5hudhvxxn5a.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ih/cihocrt74fbbllmu46potdkuqdcsx3gtpiny6nerxc72bspm7hia.py
...
#   %mm_32 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_32]
#   %primals_12 : Tensor "f32[384][1]cuda:6" = PlaceHolder[target=primals_12]
#   %mm_36 : Tensor "bf16[131072, 12][12, 1]cuda:6" = PlaceHolder[target=mm_36]
#   %mm_38 : Tensor "bf16[131072, 384][384, 1]cuda:6" = PlaceHolder[target=mm_38]
...
#   %unsqueeze_10 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze_9, 1), kwargs = {})
#   %mul_85 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=5] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_19, %unsqueeze_10), kwargs = {})
#   %view_65 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_32, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_138 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_65, torch.float32), kwargs = {})
#   %mul_94 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_138, 0.7071067811865475), kwargs = {})
#   %mul_95 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_94, %primals_12), kwargs = {})
#   %select : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_1, 0, 0), kwargs = {})
#   %unsqueeze : Tensor "f32[1, 384][384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select, 0), kwargs = {})
#   %unsqueeze_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze, 1), kwargs = {})
#   %mul_97 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_2, %mul_95), kwargs = {})
#   %sum_19 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_97, [2], True), kwargs = {})
...
#   %mul_98 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_4, %sum_19), kwargs = {})
#   %sub_6 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_95, %mul_98), kwargs = {})
#   %mul_99 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_6, %rsqrt), kwargs = {})
#   %mul_100 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_94, %mul_2), kwargs = {})
#   %sum_20 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_100, [0, 1]), kwargs = {})
#   %add_21 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_85, %mul_99), kwargs = {})
#   %view_70 : Tensor "bf16[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_36, [128, 1024, 12]), kwargs = {})
#   %convert_element_type_153 : Tensor "f32[128, 1024, 12][12288, 12, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_70, torch.float32), kwargs = {})
#   %slice_scatter_default_4 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default, %convert_element_type_153, 2, 0, 12), kwargs = {})
#   %view_78 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_38, [128, 1024, 384]), kwargs = {})
#   %convert_element_type_159 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_78, torch.float32), kwargs = {})
#   %add_22 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default_4, %convert_element_type_159), kwargs = {})
#   %mul_106 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_22, 0.7071067811865475), kwargs = {})
#   %mul_107 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_106, %primals_4), kwargs = {})
#   %mul_109 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_2, %mul_107), kwargs = {})
#   %sum_22 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_109, [2], True), kwargs = {})
#   %mul_110 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_4, %sum_22), kwargs = {})
#   %sub_8 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_107, %mul_110), kwargs = {})
#   %mul_111 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_8, %rsqrt), kwargs = {})
#   %mul_112 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_106, %mul_2), kwargs = {})
#   %sum_23 : Tensor "f32[384][1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_112, [0, 1]), kwargs = {})
#   %add_23 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_21, %mul_111), kwargs = {})
#   %mul_114 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_23, %unsqueeze_1), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dd/cddeutc5gas3taht5tixtvqakpwjwjs4ewwxsnfbn3kizhejzho3.py
...
#   %primals_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=primals_3]
#   %primals_2 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6" = PlaceHolder[target=primals_2]
#   %mul_113 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_23, %primals_3), kwargs = {})
#   %sum_24 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_113, [0, 1], True), kwargs = {dtype: torch.float32})
#   %mul_115 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_23, %primals_2), kwargs = {})
#   %sum_25 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:6"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_115, [0, 1], True), kwargs = {dtype: torch.float32})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(6):
            ...
            triton_poi_fused_mm_0.run(view_27, buf7, 2097152, stream=stream6)
            del view_27
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_mm_0.run(view_15, buf49, 2097152, stream=stream6)
            del view_15
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_mm_0.run(view_3, buf91, 2097152, stream=stream6)
            del view_3
            ...
            # Topologically Sorted Source Nodes: [view_33, view_34, transpose_11, mul_43, linear_11, mul_19, sigmoid_2, getitem_30, mul_44, sum_3, convert_element_type_63, squeeze, convert_element_type_64, convert_element_type_65, sub_1, mul_45, mul_46, convert_element_type_66, mul_47, permute_39, _scaled_dot_product_flash_attention_backward], Original ATen: [aten.view, aten.transpose, aten.mul, aten._unsafe_view, aten.sigmoid, aten.unsqueeze, aten.sum, aten._to_copy, aten.squeeze, aten.sigmoid_backward, aten._scaled_dot_product_flash_attention_backward]
            stream6 = get_raw_stream(6)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_mul_sigmoid_sigmoid_backward_squeeze_sum_transpose_unsqueeze_view_1.run(buf4, getitem_24, mm_11, buf11, buf6, 1048576, 48, stream=stream6)
            del buf4
            del mm_11
            ...
            # Topologically Sorted Source Nodes: [slice_tensor_2, convert_element_type_72], Original ATen: [aten.mm, aten._to_copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_mm_2.run(buf8, buf10, 96, stream=stream6)
            del buf8
            ...
            # Topologically Sorted Source Nodes: [permute_40, permute_41, permute_42, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            triton_poi_fused_copy_slice_transpose_3.run(buf15, buf17, 150994944, stream=stream6)
            # Topologically Sorted Source Nodes: [permute_40, permute_41, permute_42, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_bwd_kernel_0.run(reinterpret_tensor(buf13, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf14, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), view_26, buf17, select_3, select_5, 2097152, 1, 1, stream=stream6)
            del view_26
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_mul_select_slice_backward_unsqueeze_view_4.run(add_10, rsqrt_4, tangents_1, primals_32, buf9, buf20, primals_26, tangents_3, primals_25, primals_21, primals_20, buf24, buf34, buf44, workspace_0, 131072, 384, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_mul_sigmoid_sigmoid_backward_squeeze_sum_transpose_unsqueeze_view_1.run(buf46, getitem_13, mm_6, buf53, buf48, 1048576, 48, stream=stream6)
            del buf46
            del mm_6
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_mm_2.run(buf50, buf52, 96, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [view_46, convert_element_type_86, linear_8, leaky_relu_1, pow_9, mul_62, mul_63, mul_64, where_2, convert_element_type_92], Original ATen: [aten.view, aten._to_copy, aten._unsafe_view, aten.leaky_relu, aten.pow, aten.mul, aten.leaky_relu_backward]
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_leaky_relu_backward_mul_pow_view_5.run(buf37, buf36, 134217728, stream=stream6)
            del buf36
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_copy_slice_transpose_3.run(buf57, buf59, 150994944, stream=stream6)
            # Topologically Sorted Source Nodes: [permute_65, permute_66, permute_67, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_bwd_kernel_0.run(reinterpret_tensor(buf55, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf56, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), view_14, buf59, select_3, select_5, 2097152, 1, 1, stream=stream6)
            del view_14
            ...
            # Topologically Sorted Source Nodes: [getitem_11, getitem_12, mul_8, getitem_13, getitem_14, mul_9, add_3, rms_norm_2, getitem, getitem_1, mul, getitem_2, getitem_3, mul_1, add, rms_norm], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._fused_rms_norm]
            stream6 = get_raw_stream(6)
            triton_poi_fused__fused_rms_norm_add_mul_select_unsqueeze_6.run(primals_15, add_4, primals_3, rsqrt_2, primals_1, primals_2, rsqrt, buf40, buf82, 50331648, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm_backward__to_copy_add_mul_select_slice_backward_unsqueeze_view_7.run(buf40, buf39, primals_22, buf51, buf62, primals_16, buf24, primals_25, rsqrt_2, primals_15, primals_11, primals_10, buf66, buf76, buf86, workspace_1, 131072, 384, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [mul_55, sum_6, getitem_22, getitem_23, mul_56, mul_57, sum_7, linear_9, mul_59, sum_8, linear_7, mul_61, sum_9, getitem_11, getitem_12, mul_84, sum_15, mul_85, mul_86, sum_16, linear_4, mul_88, sum_17, linear_2, mul_90, sum_18], Original ATen: [aten.mul, aten.sum, aten.select, aten.unsqueeze, aten._unsafe_view]
            stream6 = get_raw_stream(6)
            triton_red_fused__unsafe_view_mul_select_sum_unsqueeze_8.run(buf24, primals_3, add_9, primals_25, mm_9, mm_7, buf66, add_4, primals_15, mm_4, mm_2, buf25, buf27, buf30, buf32, buf67, buf69, buf72, buf74, 134016, 376, stream=stream6)
            del add_4
            del add_9
            del mm_2
            del mm_4
            ...
            # Topologically Sorted Source Nodes: [mul_55, sum_6], Original ATen: [aten.mul, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf25, buf26, 384, 349, stream=stream6)
            del buf25
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf27, buf28, 384, 349, stream=stream6)
            del buf27
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf30, buf31, 384, 349, stream=stream6)
            del buf30
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf32, buf33, 384, 349, stream=stream6)
            del buf32
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf67, buf68, 384, 349, stream=stream6)
            del buf67
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf69, buf70, 384, 349, stream=stream6)
            del buf69
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf72, buf73, 384, 349, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf74, buf75, 384, 349, stream=stream6)
            buf29 = empty_strided_cuda((2, 384), (384, 1), torch.float32)
            # Topologically Sorted Source Nodes: [squeeze_1, squeeze_2, full_default_1, squeeze_3, squeeze_4, add_16], Original ATen: [aten.squeeze, aten.select_backward, aten.add]
            stream6 = get_raw_stream(6)
            triton_poi_fused_add_select_backward_squeeze_10.run(buf26, buf28, buf29, 768, stream=stream6)
            del buf26
            del buf28
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_add_select_backward_squeeze_10.run(buf68, buf70, buf71, 768, stream=stream6)
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__scaled_dot_product_flash_attention_backward__to_copy__unsafe_view_mul_sigmoid_sigmoid_backward_squeeze_sum_transpose_unsqueeze_view_1.run(buf88, getitem_2, mm_1, buf95, buf90, 1048576, 48, stream=stream6)
            del buf88
            del mm_1
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy_mm_2.run(buf92, buf94, 96, stream=stream6)
            del buf92
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_leaky_relu_backward_mul_pow_view_5.run(buf79, buf78, 134217728, stream=stream6)
            del buf78
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_copy_slice_transpose_3.run(buf99, buf101, 150994944, stream=stream6)
            del buf99
            # Topologically Sorted Source Nodes: [permute_90, permute_91, permute_92, getitem, copy_, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy]
            stream6 = get_raw_stream(6)
            _fused_qkv_postprocess_bwd_kernel_0.run(reinterpret_tensor(buf97, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf98, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), view_2, buf101, select_3, select_5, 2097152, 1, 1, stream=stream6)
            del buf97
            del select_3
            del select_5
            del view_2
            ...
            stream6 = get_raw_stream(6)
            triton_per_fused__fused_rms_norm_backward__to_copy_add_mul_select_slice_backward_unsqueeze_view_11.run(buf108, buf82, buf81, primals_12, buf93, buf104, primals_4, primals_15, rsqrt, primals_1, buf111, workspace_2, 131072, 384, stream=stream6)
            ...
            # Topologically Sorted Source Nodes: [mul_113, sum_24, mul_115, sum_25], Original ATen: [aten.mul, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_12.run(buf108, primals_3, primals_2, buf109, buf112, 134016, 376, stream=stream6)
            del buf108
            del primals_2
            del primals_3
            ...
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf109, buf110, 384, 349, stream=stream6)
            del buf109
            buf113 = buf68; del buf68  # reuse
            # Topologically Sorted Source Nodes: [mul_115, sum_25], Original ATen: [aten.mul, aten.sum]
            stream6 = get_raw_stream(6)
            triton_red_fused_mul_sum_9.run(buf112, buf113, 384, 349, stream=stream6)
            del buf112
            ...
            stream6 = get_raw_stream(6)
            triton_poi_fused_add_select_backward_squeeze_10.run(buf110, buf113, buf114, 768, stream=stream6)
            del buf110
            del buf113
...
def get_args():
    ...
    mm_3 = rand_strided((131072, 1024), (1024, 1), device='cuda:6', dtype=torch.bfloat16)
    view_10 = rand_strided((131072, 1024), (1024, 1), device='cuda:6', dtype=torch.bfloat16)
    ...
    mm_8 = rand_strided((131072, 1024), (1024, 1), device='cuda:6', dtype=torch.bfloat16)
    view_22 = rand_strided((131072, 1024), (1024, 1), device='cuda:6', dtype=torch.bfloat16)
    ...
    permute_37 = rand_strided((8, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_46 = rand_strided((1152, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_50 = rand_strided((384, 1024), (1024, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_54 = rand_strided((1024, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_62 = rand_strided((8, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_71 = rand_strided((1152, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_75 = rand_strided((384, 1024), (1024, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_79 = rand_strided((1024, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_87 = rand_strided((8, 12), (12, 1), device='cuda:6', dtype=torch.bfloat16)
    permute_96 = rand_strided((1152, 384), (384, 1), device='cuda:6', dtype=torch.bfloat16)
    tangents_1 = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:6', dtype=torch.float32)
