...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/5q/c5q7qmkcteynwcecol25baenfovnenai3i24clg7pviekydxog6z.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/e6/ce6pwvi6rrvsxmwic3f22gx6d7flwtfgl5nyr4zyosq2x6x4o2zk.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/4g/c4g4w73kihtdagadkfjjfti534d3eqwcgad6p2rbcr6sbh4l34x7.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/mt/cmtceil4bqlda2r4l27oezajvv2hhghcazixc247lkkrp26yqi5o.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/mw/cmwdkpsy7ws5tqubcp342v4cc3r2twwymsczm7pl63iw2zmx6pdm.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/3f/c3ffhhn32nnqbi5k22nf2h22yy3gln423wrbau35aiwpxeyomeoa.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/x3/cx3nppqtrbic7hky6k2zg7mq63ok55thvhgomkreh5uv6ftdmyyf.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gx/cgxovz2ijy6pw7ydehmbnnlqu4wswmbl4pp4nveam7vlqpzjnrnx.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/mw/cmwzr5aijd2fdkwqcofocbdby6p5fpehkmeyssl5nlnumispu3w4.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/gr/cgrsjqmod36tktvarnotafzirtmzw6kd45q2sawp5jxtlu56miq4.py
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(4):
            ...
            # Topologically Sorted Source Nodes: [getitem, getitem_1, mul, getitem_2, getitem_3, mul_1, add, rms_norm, mul_2, linear, rms_norm_1, mul_5, linear_3], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._fused_rms_norm, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_red_fused__fused_rms_norm__to_copy_add_mul_select_unsqueeze_1.run(arg0_1, arg1_1, arg2_1, arg3_1, arg11_1, buf1, buf21, buf2, 131072, 384, stream=stream4)
            del arg11_1
            del arg3_1
            ...
            # Topologically Sorted Source Nodes: [linear, view, scaled_dot_product_attention, getitem_4, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            stream4 = get_raw_stream(4)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_3.run(buf3, buf8, 50331648, stream=stream4)
            del buf3
            # Topologically Sorted Source Nodes: [linear, view, scaled_dot_product_attention, getitem_4, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_5.run(buf23, 201326592, stream=stream4)
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_3.run(buf29, buf34, 50331648, stream=stream4)
            del buf29
            # Topologically Sorted Source Nodes: [linear_5, view_1, scaled_dot_product_attention_1, getitem_15, contiguous_8, transpose_6], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_5.run(buf49, 201326592, stream=stream4)
            ...
            # Topologically Sorted Source Nodes: [rms_norm_4, mul_18, getitem_29, contiguous_22, linear_11], Original ATen: [aten._fused_rms_norm, aten.mul, aten.slice, aten.clone, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_poi_fused__fused_rms_norm__to_copy_clone_mul_slice_8.run(buf51, buf52, arg25_1, buf70, 131072, 12, stream=stream4)
            del arg25_1
            del buf52
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_3.run(buf54, buf59, 50331648, stream=stream4)
            del buf54
            # Topologically Sorted Source Nodes: [linear_10, view_2, scaled_dot_product_attention_2, getitem_26, contiguous_16, transpose_10], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            stream4 = get_raw_stream(4)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_4.run(buf73, buf72, 50331648, stream=stream4)
            del buf72
            ...
            # Topologically Sorted Source Nodes: [linear_13, leaky_relu_2, square_2], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow]
            stream4 = get_raw_stream(4)
            triton_poi_fused__unsafe_view_leaky_relu_pow_9.run(buf68, buf69, 201326592, stream=stream4)
            del buf68
