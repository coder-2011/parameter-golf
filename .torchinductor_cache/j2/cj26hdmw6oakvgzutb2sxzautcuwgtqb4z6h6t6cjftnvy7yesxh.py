...
_tensor_constant0 = None  # device(type='cuda', index=4) torch.int64 (12,) (1,) 704411101180
_tensor_constant1 = None  # device(type='cuda', index=4) torch.int64 (12,) (1,) 704411114910
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tw/ctwthc7g5m7kvt7ig43jdhyqb5k7tbkzy2urxhmfkwpewxvb3qeh.py
...
#   %remainder : Tensor "i64[128, 1023, 12][12276, 12, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 32767), kwargs = {})
