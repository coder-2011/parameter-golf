...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/y4/cy4dme7empyd3u6snif77mr4lsougajuc3y54m646fija553qbjm.py
...
#   %add : Tensor "bf16[349, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_1, %arg3_1), kwargs = {})
#   return %add
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            _leaky_relu_sq_matmul_kernel_0.run(reinterpret_tensor(arg1_1, (349000, 384), (384, 1), 0), arg2_1, buf0, buf1, 65448, 1, 1, stream=stream2)
            del arg1_1
            del arg2_1
            del buf0
            ...
            # Topologically Sorted Source Nodes: [reshape_1, add], Original ATen: [aten.view, aten.add]
            stream2 = get_raw_stream(2)
            triton_poi_fused_add_view_0.run(buf5, arg3_1, 134016000, stream=stream2)
            del arg3_1
        return (buf5, )
...
def get_args():
    ...
    arg1_1 = rand_strided((349, 1000, 384), (384000, 384, 1), device='cuda:2', dtype=torch.bfloat16)
    arg2_1 = rand_strided((1536, 384), (384, 1), device='cuda:2', dtype=torch.bfloat16)
