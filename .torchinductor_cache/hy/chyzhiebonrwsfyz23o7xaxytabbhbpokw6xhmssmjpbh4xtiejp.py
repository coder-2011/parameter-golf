...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ix/cixfha3ago34ccezn2uvx2sh4kw4yvcsstbnygh4ulry6frvaqm2.py
...
#   %primals_2 : Tensor "bf16[196608, 128][128, 1]cuda:4" = PlaceHolder[target=primals_2]
...
def get_args():
    ...
    primals_2 = rand_strided((196608, 128), (128, 1), device='cuda:4', dtype=torch.bfloat16)
