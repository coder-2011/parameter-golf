...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/nt/cntgani4ujqp35avvocf5v5jsobbuvvfcvkixmrbbmbrqmorjf5i.py
...
#   %select : Tensor "i64[512, 4][4000, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%empty, 1, 0), kwargs = {})
...
#   %copy : Tensor "i64[512, 4][4000, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%select, %full_default), kwargs = {})
#   %select_scatter_default : Tensor "i64[512, 1000, 4][4000, 4, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.select_scatter.default](args = (%empty, %copy, 1, 0), kwargs = {})
#   %slice_8 : Tensor "i64[512, 999, 4][4000, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%select_scatter_default, 1, 1, 9223372036854775807), kwargs = {})
...
#   %mul : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze, %lift_fresh_copy), kwargs = {})
...
#   %mul_1 : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %lift_fresh_copy_1), kwargs = {})
#   %bitwise_xor : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.bitwise_xor.Tensor](args = (%mul, %mul_1), kwargs = {})
#   %remainder : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.remainder.Scalar](args = (%bitwise_xor, 8191), kwargs = {})
#   %add : Tensor "i64[512, 999, 4][3996, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%remainder, 1), kwargs = {})
#   %copy_1 : Tensor "i64[512, 999, 4][4000, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_8, %add), kwargs = {})
#   %slice_scatter_default : Tensor "i64[512, 1000, 4][4000, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%select_scatter_default, %copy_1, 1, 1, 9223372036854775807), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qe/cqedary2qzi5l3clamkm7fndyuu3jvhrpun73o2wkazlv77dx46p.py
...
#   sum_1 => sum_1
# Graph fragment:
#   %slice_scatter_default : Tensor "i64[512, 1000, 4][4000, 4, 1]cuda:2" = PlaceHolder[target=slice_scatter_default]
...
#   %add_1 : Tensor "i64[512, 1000, 4][4000, 4, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %mul_2), kwargs = {})
#   %embedding_1 : Tensor "bf16[512, 1000, 4, 128][512000, 512, 128, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%arg6_1, %add_1), kwargs = {})
#   %sum_1 : Tensor "f32[512, 1000, 128][128000, 128, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%embedding_1, [-2]), kwargs = {dtype: torch.float32})
#   %mul_3 : Tensor "f32[512, 1000, 128][128000, 128, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.5), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[512, 1000, 128][128000, 128, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_3, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/6h/c6hbjj7vgoy7nrx2j7ia5dvajbd4siqj5qt7v7a4acaqek6khmvh.py
...
#   %embedding : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.embedding.default](args = (%arg5_1, %arg4_1), kwargs = {})
#   return %embedding
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/hx/chx2t6tcgou7cuotlst2u6dstumwr5qnvkpobgubescnancrb7mi.py
...
#   %embedding : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2" = PlaceHolder[target=embedding]
#   %mm : Tensor "bf16[512000, 384][384, 1]cuda:2" = PlaceHolder[target=mm]
#   %addmm : Tensor "bf16[512000, 384][384, 1]cuda:2" = PlaceHolder[target=addmm]
#   %arg10_1 : Tensor "f32[][]cuda:2" = PlaceHolder[target=arg10_1]
#   %arg4_1 : Tensor "i64[512, 1000][1000, 1]cuda:2" = PlaceHolder[target=arg4_1]
#   %add_3 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2" = PlaceHolder[target=add_3]
#   %buf8 : Tensor "f32[512, 1000, 1][1000, 1, 512000]cuda:2" = PlaceHolder[target=buf8]
...
#   %view_1 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm, [512, 1000, 384]), kwargs = {})
#   %view_3 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%addmm, [512, 1000, 384]), kwargs = {})
#   %sigmoid : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_3,), kwargs = {})
#   %mul_4 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_1, %sigmoid), kwargs = {})
...
#   %mul_5 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_4, %convert_element_type_9), kwargs = {})
#   %add_2 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%embedding, %mul_5), kwargs = {})
#   %mul_7 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %add_2), kwargs = {})
#   %full_default_1 : Tensor "bf16[512, 1, 384][384, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([512, 1, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:2, pin_memory: False})
#   %slice_11 : Tensor "bf16[512, 999, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%add_2, 1, 0, -1), kwargs = {})
#   %cat : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%full_default_1, %slice_11], 1), kwargs = {})
#   %ne : Tensor "b8[512, 1000][1000, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%arg4_1, 1), kwargs = {})
#   %convert_element_type_11 : Tensor "bf16[512, 1000][1000, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%ne, torch.bfloat16), kwargs = {})
#   %unsqueeze_4 : Tensor "bf16[512, 1000, 1][1000, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%convert_element_type_11, -1), kwargs = {})
#   %mul_6 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%cat, %unsqueeze_4), kwargs = {})
#   %mul_8 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_3, %mul_6), kwargs = {})
#   %add_3 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_7, %mul_8), kwargs = {})
#   %convert_element_type_13 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_3, torch.float32), kwargs = {})
#   %pow_1 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_13, 2), kwargs = {})
...
#   %add_4 : Tensor "f32[512, 1000, 1][1000, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean, 1e-06), kwargs = {})
#   %rsqrt : Tensor "f32[512, 1000, 1][1000, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_4,), kwargs = {})
#   %mul_9 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_13, %rsqrt), kwargs = {})
...
#   %mul_10 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_9, %convert_element_type_12), kwargs = {})
#   %convert_element_type_14 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_10, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/3b/c3bap37elqveopbtbqvrke7uiwxmox7efqwkfb2vualcm57qg5eu.py
...
#   %view_5 : Tensor "bf16[512, 1000, 768][768000, 768, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_1, [512, 1000, 768]), kwargs = {})
#   %view_6 : Tensor "bf16[512, 1000, 16, 48][768000, 768, 48, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%view_5, [512, 1000, 16, 48]), kwargs = {})
#   %permute_6 : Tensor "bf16[512, 8, 1000, 48][384000, 48, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty_1, [0, 2, 1, 3]), kwargs = {})
#   %permute_7 : Tensor "bf16[512, 4, 1000, 48][192000, 48, 192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty_2, [0, 2, 1, 3]), kwargs = {})
#   %slice_12 : Tensor "bf16[512, 1000, 4, 48][768000, 768, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_6, 2, 12, 9223372036854775807), kwargs = {})
#   %clone : Tensor "bf16[512, 1000, 4, 48][192000, 192, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_12,), kwargs = {memory_format: torch.contiguous_format})
#   %permute_5 : Tensor "bf16[512, 4, 1000, 48][192000, 48, 192, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%clone, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/yc/cyc3rhhs5dwvkbkxxiajqa75527ga67kcmg5vnddizocspbw2fdy.py
# Topologically Sorted Source Nodes: [getitem_14, contiguous_6], Original ATen: [aten.slice, aten.clone]
# Source node to ATen node mapping:
#   contiguous_6 => clone_1
#   getitem_14 => slice_13
# Graph fragment:
#   %convert_element_type_14 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2" = PlaceHolder[target=convert_element_type_14]
#   %slice_13 : Tensor "bf16[512, 1000, 12][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%convert_element_type_14, 2, 0, 12), kwargs = {})
#   %clone_1 : Tensor "bf16[512, 1000, 12][12000, 12, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_13,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_1
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/wg/cwg7fzzsp6kgqcv4nitigcjlv5zr2ud2tyfrbql6wnwdpch53dq4.py
...
#   %mm_2 : Tensor "bf16[512000, 8][8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mm.default](args = (%view_7, %permute_9), kwargs = {})
#   return %buf23
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/lp/clpjh3rdqrfto7d22tznil6rmf5rjtvjtg732t4enhvx6dtltvss.py
...
#   %permute_8 : Tensor "bf16[512, 1000, 8, 48][384000, 384, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_2, [0, 2, 1, 3]), kwargs = {})
...
#   %mul_11 : Tensor "bf16[512, 1000, 8][8000, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_8, 0.5), kwargs = {})
#   %sigmoid_2 : Tensor "bf16[512, 1000, 8][8000, 8, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_11,), kwargs = {})
#   %unsqueeze_5 : Tensor "bf16[512, 1000, 8, 1][8000, 8, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sigmoid_2, 3), kwargs = {})
#   %mul_12 : Tensor "bf16[512, 1000, 8, 48][384000, 384, 48, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%permute_8, %unsqueeze_5), kwargs = {})
#   return %mul_12
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/r3/cr3avicv4ekrjkog5ysyhjq47th32pjfyovqpkbqxx3jiwjtsudg.py
...
#   %add_3 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2" = PlaceHolder[target=add_3]
#   %add_5 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2" = PlaceHolder[target=add_5]
#   %buf29 : Tensor "f32[512, 1000, 1][1000, 1, 512000]cuda:2" = PlaceHolder[target=buf29]
...
#   %add_5 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_11, %add_3), kwargs = {})
#   %convert_element_type_23 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_5, torch.float32), kwargs = {})
#   %pow_2 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%convert_element_type_23, 2), kwargs = {})
...
#   %add_6 : Tensor "f32[512, 1000, 1][1000, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_1, 1e-06), kwargs = {})
#   %rsqrt_1 : Tensor "f32[512, 1000, 1][1000, 1, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_6,), kwargs = {})
#   %mul_13 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_23, %rsqrt_1), kwargs = {})
...
#   %mul_14 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_13, %convert_element_type_22), kwargs = {})
#   %convert_element_type_24 : Tensor "bf16[512, 1000, 384][384000, 384, 1]cuda:2"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_14, torch.bfloat16), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(2):
            ...
            triton_poi_fused_add_bitwise_xor_copy_fill_lift_fresh_mul_remainder_select_slice_unsqueeze_0.run(arg4_1, buf1, 2048000, stream=stream2)
            buf2 = empty_strided_cuda((512, 1000, 128), (128000, 128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [arange, mul_2, add_1, embedding_1, sum_1, mul_3, linear], Original ATen: [aten.arange, aten.mul, aten.add, aten.embedding, aten.sum, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_add_arange_embedding_mul_sum_1.run(buf1, arg6_1, buf2, 65536000, stream=stream2)
            del arg6_1
            del buf1
            ...
            # Topologically Sorted Source Nodes: [embedding], Original ATen: [aten.embedding]
            stream2 = get_raw_stream(2)
            triton_poi_fused_embedding_2.run(arg4_1, arg5_1, buf4, 512000, 384, stream=stream2)
            del arg5_1
            ...
            # Topologically Sorted Source Nodes: [to_6, sigmoid_1, getitem_8, sub, linear, linear_1, sigmoid, mul_4, to_5, mul_5, add_2, mul_7, zeros_like, getitem_10, cat, ne, to_7, unsqueeze, mul_6, mul_8, add_3, rms_norm, to_8], Original ATen: [aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.rsub, aten._unsafe_view, aten.view, aten.mul, aten.add, aten.zeros_like, aten.slice, aten.cat, aten.ne, aten._fused_rms_norm]
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_cat_mul_ne_rsub_sigmoid_slice_unsqueeze_view_zeros_like_4.run(arg11_1, buf4, buf3, buf6, arg10_1, arg4_1, arg12_1, buf7, buf9, 512000, 384, stream=stream2)
            del arg10_1
            del arg11_1
            del arg12_1
            del arg4_1
            ...
            stream2 = get_raw_stream(2)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf10, (512, 1000, 16, 48), (768000, 768, 48, 1), 0), buf11, buf12, reinterpret_tensor(arg0_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg1_1, (1000, 24), (24, 1), 0), 6144000, 1, 1, stream=stream2)
            buf15 = empty_strided_cuda((512, 4, 1000, 48), (192000, 48, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_11, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            stream2 = get_raw_stream(2)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_5.run(buf10, buf15, 98304000, stream=stream2)
            del buf10
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_11, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_6], Original ATen: [aten.slice, aten.clone]
            stream2 = get_raw_stream(2)
            triton_poi_fused_clone_slice_6.run(buf9, buf22, 6144000, stream=stream2)
            buf23 = empty_strided_cuda((512000, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_14, contiguous_6, linear_3, to_10], Original ATen: [aten.slice, aten.clone, aten.view, aten._to_copy, aten.t, aten.mm]
            stream2 = get_raw_stream(2)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_7.run(buf22, buf23, 6144000, stream=stream2)
            del buf22
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_3, mul_9, sigmoid_2, getitem_15, mul_10], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream2 = get_raw_stream(2)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_9.run(buf26, buf25, 196608000, stream=stream2)
            del buf25
            ...
            # Topologically Sorted Source Nodes: [linear_4, add_4, rms_norm_1, to_12], Original ATen: [aten._unsafe_view, aten.add, aten._fused_rms_norm, aten._to_copy]
            stream2 = get_raw_stream(2)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_10.run(buf28, buf7, arg16_1, buf30, 512000, 384, stream=stream2)
            del arg16_1
