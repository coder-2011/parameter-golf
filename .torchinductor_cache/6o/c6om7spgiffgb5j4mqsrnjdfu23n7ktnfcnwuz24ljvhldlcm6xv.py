...
#   %mul_15 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_25, %convert_element_type_27), kwargs = {})
#   %convert_element_type_23 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_5, torch.float32), kwargs = {})
#   %mul_13 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_23, %rsqrt_1), kwargs = {})
#   %mul_17 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_13, %mul_15), kwargs = {})
#   %sum_2 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_17, [2], True), kwargs = {})
#   %div : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_13, 384), kwargs = {})
#   %mul_18 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div, %sum_2), kwargs = {})
#   %sub_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (%mul_15, %mul_18), kwargs = {})
#   %mul_19 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_1, %rsqrt_1), kwargs = {})
#   %mul_20 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_25, %mul_13), kwargs = {})
#   %sum_3 : Tensor "f32[384][1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_20, [0, 1]), kwargs = {})
#   %convert_element_type_28 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_19, torch.bfloat16), kwargs = {})
#   %add_7 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%tangents_2, %convert_element_type_28), kwargs = {})
#   return %sum_2,%add_7
...
#   %mul_21 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_15, %permute_8), kwargs = {})
...
#   %sigmoid_2 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_11,), kwargs = {})
...
#   %mul_22 : Tensor "bf16[128, 1024, 8, 48][393216, 384, 48, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_15, %unsqueeze_5), kwargs = {})
#   %sum_4 : Tensor "f32[128, 1024, 8, 1][8192, 8, 1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_21, [3], True), kwargs = {dtype: torch.float32})
...
#   %mul_23 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_37, %sub_2), kwargs = {})
#   %mul_24 : Tensor "f32[128, 1024, 8][8192, 8, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_36, %mul_23), kwargs = {})
#   %convert_element_type_38 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_24, torch.bfloat16), kwargs = {})
#   %mul_25 : Tensor "bf16[128, 1024, 8][8192, 8, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_38, 0.5), kwargs = {})
#   %permute_19 : Tensor "bf16[128, 8, 1024, 48][393216, 48, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%mul_22, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/br/cbrtsgajl6pt462ndhazmvlrasl45fsvrs55x6xgqoisj62qsa5h.py
...
# Graph fragment:
#   %permute_17 : Tensor "bf16[8, 12][12, 1]cuda:1" = PlaceHolder[target=permute_17]
#   %constant_pad_nd_default : Tensor "bf16[8, 16][16, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.constant_pad_nd.default](args = (%permute_17, [0, 4, 0, 0]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/cq/ccqiriyv76psobcybctpxlwtlazinidmzanxczlsalxqw3yvyslj.py
...
# Graph fragment:
#   %mm_6 : Tensor "bf16[8, 12][12, 1]cuda:1" = PlaceHolder[target=mm_6]
#   %convert_element_type_43 : Tensor "f32[8, 12][12, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mm_6, torch.float32), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ag/cagmf77ufz4o2ae2dcxhbzpc3va3mwwocqddmpd5kookqcwnzcvt.py
...
#   %slice_10 : Tensor "bf16[128, 1024, 4, 48][786432, 768, 48, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%empty_3, 2, 12, 9223372036854775807), kwargs = {})
#   %copy_2 : Tensor "bf16[128, 1024, 4, 48][786432, 768, 48, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.copy.default](args = (%slice_10, %permute_20), kwargs = {})
#   %slice_scatter_default_1 : Tensor "bf16[128, 1024, 16, 48][786432, 768, 48, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%empty_3, %copy_2, 2, 12, 9223372036854775807), kwargs = {})
#   %select_2 : Tensor "bf16[1024, 1, 24][24, 24, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_1, 0, 0), kwargs = {})
#   %select_3 : Tensor "bf16[1024, 24][24, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%select_2, 1, 0), kwargs = {})
#   %select_4 : Tensor "bf16[1024, 1, 24][24, 24, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%primals_2, 0, 0), kwargs = {})
#   %select_5 : Tensor "bf16[1024, 24][24, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%select_4, 1, 0), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/v3/cv3x6kvgohytp6ca2eyekkvspmvuemgtp2wobqpckqhky5pzqxsr.py
...
#   %mm_default : Tensor "bf16[131072, 16][16, 1]cuda:1" = PlaceHolder[target=mm_default]
...
#   %add_8 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%tangents_3, %add_7), kwargs = {})
#   %slice_tensor : Tensor "bf16[131072, 12][16, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mm_default, 1, 0, -4), kwargs = {})
#   %view_17 : Tensor "bf16[128, 1024, 12][16384, 16, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%slice_tensor, [128, 1024, 12]), kwargs = {})
#   %full_default_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([128, 1024, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:1, pin_memory: False})
#   %slice_scatter_default : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default_2, %view_17, 2, 0, 12), kwargs = {})
...
#   %add_9 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%slice_scatter_default, %view_25), kwargs = {})
#   %convert_element_type_48 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_9, torch.float32), kwargs = {})
...
#   %mul_26 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_48, %convert_element_type_50), kwargs = {})
#   %convert_element_type_13 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_3, torch.float32), kwargs = {})
#   %mul_9 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=3] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_13, %rsqrt), kwargs = {})
#   %mul_28 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_9, %mul_26), kwargs = {})
#   %sum_5 : Tensor "f32[128, 1024, 1][1024, 1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_28, [2], True), kwargs = {})
#   %div_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.div.Tensor](args = (%mul_9, 384), kwargs = {})
#   %mul_29 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%div_1, %sum_5), kwargs = {})
...
#   %mul_30 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub_3, %rsqrt), kwargs = {})
#   %mul_31 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_48, %mul_9), kwargs = {})
#   %sum_6 : Tensor "f32[384][1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_31, [0, 1]), kwargs = {})
#   %convert_element_type_51 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_30, torch.bfloat16), kwargs = {})
#   %add_10 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=4] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_8, %convert_element_type_51), kwargs = {})
#   return %sum_5,%add_10
...
# Graph fragment:
#   %add_10 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1" = PlaceHolder[target=add_10]
...
#   %mul_40 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1" = PlaceHolder[target=mul_40]
...
#   %mul_32 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %unsqueeze_3), kwargs = {})
...
#   %unsqueeze_4 : Tensor "bf16[128, 1024, 1][1024, 1, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%convert_element_type_11, -1), kwargs = {})
...
#   %mul_34 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %sub), kwargs = {})
...
#   %convert_element_type_9 : Tensor "bf16[][]cuda:1"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_11, torch.bfloat16), kwargs = {})
#   %mul_36 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_32, %unsqueeze_4), kwargs = {})
#   %slice_13 : Tensor "bf16[128, 1023, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mul_36, 1, 1, 1024), kwargs = {})
#   %slice_scatter_default_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default_2, %slice_13, 1, 0, -1), kwargs = {})
#   %add_12 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_34, %slice_scatter_default_2), kwargs = {})
#   %mul_40 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_12, %convert_element_type_9), kwargs = {})
#   %mul_41 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_40, %view_1), kwargs = {})
#   %mul_42 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_40, %sigmoid), kwargs = {})
#   %convert_element_type_62 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_41, torch.float32), kwargs = {})
...
#   %mul_43 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_63, %sub_5), kwargs = {})
#   %mul_44 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_62, %mul_43), kwargs = {})
#   %convert_element_type_64 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_44, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/mf/cmfubsf3iola72v52nqr7a4fmli5egqxasgn2zxhle2klmes7lp7.py
...
# Graph fragment:
#   %full_default_7 : Tensor "f32[8192, 384][384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([8192, 384], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:1, pin_memory: False})
#   return %index_put_1
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/jp/cjpi32az5lxke54bfghoj2tgr75q77rvruxbzk56zbmds6mmif7q.py
...
#   %index_put_1 : Tensor "f32[8192, 384][384, 1]cuda:1" = PlaceHolder[target=index_put_1]
...
#   %mul_33 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %mul_6), kwargs = {})
#   %sum_7 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_33, [0, 1], True), kwargs = {dtype: torch.float32})
#   %sub : Tensor "bf16[1, 1, 384][384, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sub.Tensor](args = (1, %unsqueeze_3), kwargs = {})
#   %mul_34 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %sub), kwargs = {})
#   %view_1 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%mm, [128, 1024, 384]), kwargs = {})
#   %view_3 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%addmm, [128, 1024, 384]), kwargs = {})
#   %sigmoid : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=3] = call_function[target=torch.ops.aten.sigmoid.default](args = (%view_3,), kwargs = {})
#   %mul_4 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_1, %sigmoid), kwargs = {})
#   %convert_element_type_9 : Tensor "bf16[][]cuda:1"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%primals_11, torch.bfloat16), kwargs = {})
...
#   %add_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%embedding, %mul_5), kwargs = {})
#   %mul_35 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %add_2), kwargs = {})
#   %sum_8 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%mul_35, [0, 1], True), kwargs = {dtype: torch.float32})
#   %mul_36 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_32, %unsqueeze_4), kwargs = {})
#   %slice_13 : Tensor "bf16[128, 1023, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mul_36, 1, 1, 1024), kwargs = {})
#   %slice_scatter_default_2 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.slice_scatter.default](args = (%full_default_2, %slice_13, 1, 0, -1), kwargs = {})
#   %add_12 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_34, %slice_scatter_default_2), kwargs = {})
#   %mul_39 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_12, %mul_4), kwargs = {})
#   %sum_9 : Tensor "f32[][]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.sum.default](args = (%mul_39,), kwargs = {dtype: torch.float32})
...
#   %add_13 : Tensor "bf16[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_12, %view_28), kwargs = {})
#   %full_default_4 : Tensor "f32[][]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:1, pin_memory: False})
#   %convert_element_type_81 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_13, torch.float32), kwargs = {})
#   %eq_1 : Tensor "b8[128, 1024][1024, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%primals_5, -1), kwargs = {})
#   %unsqueeze_8 : Tensor "b8[128, 1024, 1][1024, 1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%eq_1, -1), kwargs = {})
#   %where_1 : Tensor "f32[128, 1024, 384][393216, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%unsqueeze_8, %full_default_4, %convert_element_type_81), kwargs = {})
#   %full_default_7 : Tensor "f32[8192, 384][384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([8192, 384], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:1, pin_memory: False})
#   %index_put_1 : Tensor "f32[8192, 384][384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_7, [%primals_5], %where_1, True), kwargs = {})
#   return %buf32,%buf46
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/67/c67yfztjvbsb5sinbo4k6gpir4istyzhcbxflplrx5pngmzllgih.py
...
#   %add_11 : Tensor "bf16[1, 1, 384][384, 384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%convert_element_type_54, %neg), kwargs = {})
#   %squeeze_1 : Tensor "bf16[1, 384][384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.squeeze.dim](args = (%add_11, 1), kwargs = {})
...
#   %mul_37 : Tensor "f32[384][1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_57, %sub_4), kwargs = {})
#   %mul_38 : Tensor "f32[384][1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_56, %mul_37), kwargs = {})
#   return %mul_38
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/yi/cyif5j2izvljelkx5q6ibwak4tdxgleo6h5n2yvtqlrf5ebmvt5n.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ej/cejkyl7xp5htzxqxbwskaarzdobrw4fsxaobjfm7sxjifc5koacw.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/qr/cqrjjbtsym26xhzydiriqprc5nhgdtm55sjap35flz62lcaquo5k.py
# Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_41, convert_element_type_62, convert_element_type_63, sub_5, mul_43, mul_44, convert_element_type_64, view_26, sum_10], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten.sigmoid_backward, aten.sum]
# Source node to ATen node mapping:
#   convert_element_type_62 => convert_element_type_62
#   convert_element_type_63 => convert_element_type_63
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/dv/cdvzkemoni3flsffa7eil76ntgok2pcwipatqiso5p52tvohj7ra.py
...
# Graph fragment:
#   %full_default_5 : Tensor "f32[32768, 128][128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([32768, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:1, pin_memory: False})
#   return %index_put
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pn/cpnras5w5ncjrb52a5sliosyu4daounk6ndj75rqvrqs7hcl4t4n.py
...
#   where => where
# Graph fragment:
#   %add_1 : Tensor "i64[128, 1024, 4][4096, 4, 1]cuda:1" = PlaceHolder[target=add_1]
#   %mm_13 : Tensor "bf16[131072, 128][128, 1]cuda:1" = PlaceHolder[target=mm_13]
#   %index_put : Tensor "f32[32768, 128][128, 1]cuda:1" = PlaceHolder[target=index_put]
#   %view_30 : Tensor "bf16[128, 1024, 128][131072, 128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_13, [128, 1024, 128]), kwargs = {})
#   %convert_element_type_75 : Tensor "f32[128, 1024, 128][131072, 128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_30, torch.float32), kwargs = {})
#   %mul_45 : Tensor "f32[128, 1024, 128][131072, 128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_75, 0.5), kwargs = {})
#   %unsqueeze_6 : Tensor "f32[128, 1024, 1, 128][131072, 128, 128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%mul_45, -2), kwargs = {})
#   %expand : Tensor "f32[128, 1024, 4, 128][131072, 128, 0, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.expand.default](args = (%unsqueeze_6, [128, 1024, 4, 128]), kwargs = {})
#   %convert_element_type_default : Tensor "f32[128, 1024, 4, 128][524288, 512, 128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%expand, torch.float32), kwargs = {})
#   %eq : Tensor "b8[128, 1024, 4][4096, 4, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.eq.Scalar](args = (%add_1, -1), kwargs = {})
#   %unsqueeze_7 : Tensor "b8[128, 1024, 4, 1][4096, 4, 1, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%eq, -1), kwargs = {})
#   %full_default_4 : Tensor "f32[][]cuda:1"[num_users=2] = call_function[target=torch.ops.aten.full.default](args = ([], 0.0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:1, pin_memory: False})
#   %where : Tensor "f32[128, 1024, 4, 128][524288, 512, 128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%unsqueeze_7, %full_default_4, %convert_element_type_default), kwargs = {})
#   %full_default_5 : Tensor "f32[32768, 128][128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([32768, 128], 0), kwargs = {dtype: torch.float32, layout: torch.strided, device: cuda:1, pin_memory: False})
#   %index_put : Tensor "f32[32768, 128][128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.aten.index_put_.default](args = (%full_default_5, [%add_1], %where, True), kwargs = {})
#   return %buf43
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ah/cahzladqqofwzhhmymxmdvuvq7ezmkh3hbfmh6sksy544kd3agqo.py
...
# Graph fragment:
#   %buf43 : Tensor "f32[32768, 128][128, 1]cuda:1" = PlaceHolder[target=buf43]
#   %convert_element_type_80 : Tensor "bf16[32768, 128][128, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%index_put, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/k5/ck535kojo4jnmimsw7bmcgz7yqbw5hzzacsuv7o66aacqqkbzwdy.py
...
# Graph fragment:
#   %buf46 : Tensor "f32[8192, 384][384, 1]cuda:1" = PlaceHolder[target=buf46]
#   %convert_element_type_82 : Tensor "bf16[8192, 384][384, 1]cuda:1"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%index_put_1, torch.bfloat16), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(1):
            ...
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_0.run(add_5, rsqrt_1, tangents_1, primals_17, tangents_2, buf3, workspace_0, 131072, 384, stream=stream1)
            ...
            # Topologically Sorted Source Nodes: [constant_pad_nd_default], Original ATen: [aten.mm]
            stream1 = get_raw_stream(1)
            triton_poi_fused_mm_2.run(permute_17, buf9, 128, stream=stream1)
            del permute_17
            ...
            # Topologically Sorted Source Nodes: [convert_element_type_43], Original ATen: [aten._to_copy]
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy_3.run(buf8, buf11, 96, stream=stream1)
            del buf8
            ...
            # Topologically Sorted Source Nodes: [permute_20, permute_21, permute_22, getitem, copy_, getitem_1, getitem_2, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy, aten.select]
            stream1 = get_raw_stream(1)
            triton_poi_fused_copy_select_slice_transpose_4.run(buf16, buf18, 100663296, stream=stream1)
            del buf16
            # Topologically Sorted Source Nodes: [permute_20, permute_21, permute_22, getitem, copy_, getitem_1, getitem_2, triton_kernel_wrapper_mutation], Original ATen: [aten.transpose, aten.slice, aten.copy, aten.select]
            stream1 = get_raw_stream(1)
            _fused_qkv_postprocess_bwd_kernel_0.run(reinterpret_tensor(buf14, (128, 1024, 8, 48), (393216, 384, 48, 1), 0), reinterpret_tensor(buf15, (128, 1024, 4, 48), (196608, 192, 48, 1), 0), view_6, buf18, reinterpret_tensor(primals_1, (1024, 24), (24, 1), 0), reinterpret_tensor(primals_2, (1024, 24), (24, 1), 0), 1572864, 1, 1, stream=stream1)
            del buf15
            del primals_1
            del primals_2
            del view_6
            ...
            stream1 = get_raw_stream(1)
            triton_per_fused__fused_rms_norm__fused_rms_norm_backward__to_copy_add_mm_slice_backward_view_5.run(buf25, add_3, rsqrt, buf10, buf21, primals_13, tangents_3, workspace_1, 131072, 384, stream=stream1)
            ...
            # Topologically Sorted Source Nodes: [full_default_2, to_6, sigmoid_1, getitem_8, mul_32, to_7, unsqueeze, sub, mul_34, linear, linear_1, sigmoid, to_5, mul_36, slice_13, add_12, mul_40, mul_41, mul_42, convert_element_type_62, convert_element_type_63, sub_5, mul_43, mul_44, convert_element_type_64], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.rsub, aten._unsafe_view, aten.view, aten.slice, aten.add, aten.sigmoid_backward]
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy__unsafe_view_add_mul_rsub_sigmoid_sigmoid_backward_slice_slice_backward_unsqueeze_view_6.run(buf25, primals_12, ne, primals_11, mm, addmm, buf34, buf39, 50331648, stream=stream1)
            ...
            # Topologically Sorted Source Nodes: [full_default_7], Original ATen: [aten.embedding_dense_backward]
            stream1 = get_raw_stream(1)
            triton_poi_fused_embedding_dense_backward_7.run(buf45, 3145728, stream=stream1)
            buf32 = empty_strided_cuda((128, 1024, 1), (1024, 1, 131072), torch.float32)
            # Call mix order reduction kernel
            # Topologically Sorted Source Nodes: [full_default_2, to_6, sigmoid_1, getitem_8, mul_32, to_7, unsqueeze, mul_6, mul_33, sum_7, sub, mul_34, linear, linear_1, sigmoid, mul_4, to_5, mul_5, add_2, mul_35, sum_8, mul_36, slice_13, add_12, mul_39, sum_9, view_28, add_13, full_default_4, convert_element_type_81, eq_1, unsqueeze_8, where_1, full_default_7, index_put_1], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.sum, aten.rsub, aten._unsafe_view, aten.view, aten.add, aten.slice, aten.embedding_dense_backward]
            workspace_2 = empty_strided_cuda((1572864, ), (1, ), torch.float32)
            stream1 = get_raw_stream(1)
            triton_per_fused__to_copy__unsafe_view_add_embedding_dense_backward_mul_rsub_sigmoid_slice_slice_backward_sum_unsqueeze_view_8.run(buf25, primals_12, ne, mm, addmm, primals_5, buf35, cat, embedding, primals_11, buf32, buf45, workspace_2, 131072, 384, stream=stream1)
            ...
            # Topologically Sorted Source Nodes: [to_6, sigmoid_1, convert_element_type_54, convert_element_type_55, neg, add_11, squeeze_1, squeeze_2, convert_element_type_56, convert_element_type_57, sub_4, mul_37, mul_38], Original ATen: [aten._to_copy, aten.sigmoid, aten.neg, aten.add, aten.squeeze, aten.sigmoid_backward]
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy_add_neg_sigmoid_sigmoid_backward_squeeze_9.run(buf30, buf29, primals_12, 384, stream=stream1)
            del primals_12
            buf33 = empty_strided_cuda((), (), torch.float32)
            # Topologically Sorted Source Nodes: [full_default_2, to_6, sigmoid_1, getitem_8, mul_32, to_7, unsqueeze, sub, mul_34, linear, linear_1, sigmoid, mul_4, mul_36, slice_13, add_12, mul_39, sum_9], Original ATen: [aten.slice_backward, aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.mul, aten.rsub, aten._unsafe_view, aten.view, aten.slice, aten.add, aten.sum]
            stream1 = get_raw_stream(1)
            triton_red_fused__to_copy__unsafe_view_add_mul_rsub_sigmoid_slice_slice_backward_sum_unsqueeze_view_10.run(buf32, buf33, 1, 131072, stream=stream1)
            del buf32
            ...
            # Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_41, convert_element_type_62, convert_element_type_63, sub_5, mul_43, mul_44, convert_element_type_64, view_26, sum_10], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten.sigmoid_backward, aten.sum]
            stream1 = get_raw_stream(1)
            triton_red_fused__unsafe_view_mul_sigmoid_sigmoid_backward_sum_view_11.run(buf34, buf37, 134016, 376, stream=stream1)
            del buf34
            buf38 = reinterpret_tensor(buf29, (1, 384), (384, 1), 0); del buf29  # reuse
            # Topologically Sorted Source Nodes: [linear, linear_1, sigmoid, mul_41, convert_element_type_62, convert_element_type_63, sub_5, mul_43, mul_44, convert_element_type_64, view_26, sum_10], Original ATen: [aten._unsafe_view, aten.view, aten.sigmoid, aten.mul, aten.sigmoid_backward, aten.sum]
            stream1 = get_raw_stream(1)
            triton_red_fused__unsafe_view_mul_sigmoid_sigmoid_backward_sum_view_12.run(buf37, buf38, 384, 349, stream=stream1)
            del buf37
            ...
            # Topologically Sorted Source Nodes: [full_default_5], Original ATen: [aten.embedding_dense_backward]
            stream1 = get_raw_stream(1)
            triton_poi_fused_embedding_dense_backward_13.run(buf42, 4194304, stream=stream1)
            # Topologically Sorted Source Nodes: [view_30, convert_element_type_75, mul_45, unsqueeze_6, expand, convert_element_type_default, eq, unsqueeze_7, full_default_4, where, full_default_5, index_put], Original ATen: [aten.view, aten._to_copy, aten.mul, aten.unsqueeze, aten.expand, aten.embedding_dense_backward]
            stream1 = get_raw_stream(1)
            triton_poi_fused__to_copy_embedding_dense_backward_expand_mul_unsqueeze_view_14.run(add_1, buf41, buf42, 524288, 128, stream=stream1)
            del add_1
            del buf41
            buf44 = empty_strided_cuda((32768, 128), (128, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [convert_element_type_80], Original ATen: [aten.embedding_dense_backward]
            stream1 = get_raw_stream(1)
            triton_poi_fused_embedding_dense_backward_15.run(buf42, buf44, 4194304, stream=stream1)
            del buf42
            buf47 = empty_strided_cuda((8192, 384), (384, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [convert_element_type_82], Original ATen: [aten.embedding_dense_backward]
            stream1 = get_raw_stream(1)
            triton_poi_fused_embedding_dense_backward_16.run(buf45, buf47, 3145728, stream=stream1)
            del buf45
...
def get_args():
    ...
    embedding = rand_strided((128, 1024, 384), (393216, 384, 1), device='cuda:1', dtype=torch.bfloat16)
    add_1 = rand_strided((128, 1024, 4), (4096, 4, 1), device='cuda:1', dtype=torch.int64)
    view = rand_strided((131072, 128), (128, 1), device='cuda:1', dtype=torch.bfloat16)
    ...
    permute_34 = rand_strided((384, 128), (128, 1), device='cuda:1', dtype=torch.bfloat16)
