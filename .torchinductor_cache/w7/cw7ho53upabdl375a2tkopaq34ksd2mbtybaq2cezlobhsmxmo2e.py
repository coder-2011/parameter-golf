...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/nv/cnvlgr4boaf7tqq6z2ke3ushlmdbbn7r4ragppf64w4vpe2usr5b.py
...
#   x => add
# Graph fragment:
#   %arg2_1 : Tensor "f32[512, 1000, 384][384000, 384, 1]cuda:0" = PlaceHolder[target=arg2_1]
...
def get_args():
    ...
    arg2_1 = rand_strided((512, 1000, 384), (384000, 384, 1), device='cuda:0', dtype=torch.float32)
