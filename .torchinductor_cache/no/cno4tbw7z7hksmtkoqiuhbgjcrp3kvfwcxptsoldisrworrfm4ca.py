...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/5t/c5tinoo4epxlkazev33nkawzgnrdk2sppm74dytkuhuw6xqtv5fi.py
...
#   sum_1 => sum_1
# Graph fragment:
#   %arg0_1 : Tensor "i64[350, 1000, 12][12000, 12, 1]cuda:4" = PlaceHolder[target=arg0_1]
...
#   %embedding : Tensor "bf16[350, 1000, 12, 128][1536000, 1536, 128, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.embedding.default](args = (%arg1_1, %arg0_1), kwargs = {})
#   %sum_1 : Tensor "f32[350, 1000, 128][128000, 128, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.sum.dim_IntList](args = (%embedding, [-2]), kwargs = {dtype: torch.float32})
#   %mul : Tensor "f32[350, 1000, 128][128000, 128, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sum_1, 0.28867513459481287), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[350, 1000, 128][128000, 128, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/cd/ccdej22ruvmvsozakqqa25nuapwhf4afeszqgatoyzxxenb7mzwv.py
...
#   %arg5_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4" = PlaceHolder[target=arg5_1]
...
#   %arg8_1 : Tensor "i64[350, 1000][1000, 1]cuda:4" = PlaceHolder[target=arg8_1]
#   %add_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4" = PlaceHolder[target=add_1]
#   %buf6 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:4" = PlaceHolder[target=buf6]
...
#   %mul_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_1, %sigmoid), kwargs = {})
...
#   %mul_2 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_1, %convert_element_type_9), kwargs = {})
#   %add : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%arg5_1, %mul_2), kwargs = {})
#   %mul_4 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%sub, %add), kwargs = {})
#   %full_default : Tensor "bf16[350, 1, 384][384, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.full.default](args = ([350, 1, 384], 0), kwargs = {dtype: torch.bfloat16, layout: torch.strided, device: cuda:4, pin_memory: False})
#   %slice_2 : Tensor "bf16[350, 999, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%add, 1, 0, -1), kwargs = {})
#   %cat : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.cat.default](args = ([%full_default, %slice_2], 1), kwargs = {})
#   %ne : Tensor "b8[350, 1000][1000, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.ne.Scalar](args = (%arg8_1, 1), kwargs = {})
...
#   %unsqueeze_2 : Tensor "bf16[350, 1000, 1][1000, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%convert_element_type_11, -1), kwargs = {})
#   %mul_3 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%cat, %unsqueeze_2), kwargs = {})
#   %mul_5 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %mul_3), kwargs = {})
#   %add_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=3] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_4, %mul_5), kwargs = {})
#   %convert_element_type_13 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_1, torch.float32), kwargs = {})
...
#   %add_2 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean, 1e-06), kwargs = {})
#   %rsqrt : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_2,), kwargs = {})
#   %mul_6 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_13, %rsqrt), kwargs = {})
...
#   %mul_7 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_6, %convert_element_type_12), kwargs = {})
#   %convert_element_type_14 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_7, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/fp/cfpabwfgia5jo6cvrptxyfgmu5zs3lbwn3lg3kqqtd6kqem5eu5w.py
...
#   %slice_4 : Tensor "bf16[350, 1000, 12][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%convert_element_type_14, 2, 0, 12), kwargs = {})
#   %clone_1 : Tensor "bf16[350, 1000, 12][12000, 12, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_4,), kwargs = {memory_format: torch.contiguous_format})
#   return %clone_1
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/js/cjsxkdhkxw4fk34jh6mqcnjm7u7byhycn2z6mmzzz7naqj23vlk2.py
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ny/cnyuotarisvgbi7tey46ewatz7i746ut2kkjyx32kh354x7amsug.py
...
#   %permute_6 : Tensor "bf16[350, 8, 1000, 48][384000, 48, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty, [0, 2, 1, 3]), kwargs = {})
#   %permute_7 : Tensor "bf16[350, 4, 1000, 48][192000, 48, 192, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty_1, [0, 2, 1, 3]), kwargs = {})
#   %slice_3 : Tensor "bf16[350, 1000, 4, 48][768000, 768, 48, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_6, 2, 12, 9223372036854775807), kwargs = {})
#   %clone : Tensor "bf16[350, 1000, 4, 48][192000, 192, 48, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_3,), kwargs = {memory_format: torch.contiguous_format})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pm/cpmqamanyjty64kmcfdszngncn4vzffkuoiz7ex64oifonowjfnp.py
...
#   %mul_8 : Tensor "bf16[350, 1000, 8][8000, 8, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_8, 0.5), kwargs = {})
#   %sigmoid_2 : Tensor "bf16[350, 1000, 8][8000, 8, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_8,), kwargs = {})
#   %unsqueeze_3 : Tensor "bf16[350, 1000, 8, 1][8000, 8, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sigmoid_2, 3), kwargs = {})
#   %mul_9 : Tensor "bf16[350, 1000, 8, 48][384000, 384, 48, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%permute_8, %unsqueeze_3), kwargs = {})
#   return %mul_9
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/pc/cpchkfz5f4m7gsmrbp75ak2higodydza6ti257xazjzxdpvw5gat.py
...
#   %add_3 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=2] = call_function[target=torch.ops.aten.add.Tensor](args = (%view_11, %add_1), kwargs = {})
#   %convert_element_type_23 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=2] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%add_3, torch.float32), kwargs = {})
...
#   %add_4 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_1, 1e-06), kwargs = {})
#   %rsqrt_1 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_4,), kwargs = {})
#   %mul_10 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_23, %rsqrt_1), kwargs = {})
...
#   %mul_11 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_10, %convert_element_type_22), kwargs = {})
#   %convert_element_type_24 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:4"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_11, torch.bfloat16), kwargs = {})
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(4):
            ...
            # Topologically Sorted Source Nodes: [embedding, sum_1, mul, linear], Original ATen: [aten.embedding, aten.sum, aten.mul, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_per_fused__to_copy_embedding_mul_sum_2.run(arg0_1, arg1_1, buf1, 44800000, 12, stream=stream4)
            del arg0_1
            del arg1_1
            ...
            # Topologically Sorted Source Nodes: [to_5, sigmoid_1, getitem, sub, linear, linear_1, sigmoid, mul_1, to_4, mul_2, add, mul_4, zeros_like, getitem_2, cat, ne, to_6, unsqueeze, mul_3, mul_5, add_2, rms_norm, to_7], Original ATen: [aten._to_copy, aten.sigmoid, aten.unsqueeze, aten.rsub, aten._unsafe_view, aten.view, aten.mul, aten.add, aten.zeros_like, aten.slice, aten.cat, aten.ne, aten._fused_rms_norm]
            stream4 = get_raw_stream(4)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_cat_mul_ne_rsub_sigmoid_slice_unsqueeze_view_zeros_like_3.run(arg7_1, arg5_1, buf2, buf4, arg6_1, arg8_1, arg9_1, buf5, buf7, 350000, 384, stream=stream4)
            del arg5_1
            del arg6_1
            del arg7_1
            del arg8_1
            ...
            # Topologically Sorted Source Nodes: [getitem_6, contiguous_6], Original ATen: [aten.slice, aten.clone]
            stream4 = get_raw_stream(4)
            triton_poi_fused_clone_slice_4.run(buf7, buf20, 4200000, stream=stream4)
            buf21 = empty_strided_cuda((350000, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_6, contiguous_6, linear_3, to_9], Original ATen: [aten.slice, aten.clone, aten.view, aten._to_copy, aten.t, aten.mm]
            stream4 = get_raw_stream(4)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_5.run(buf20, buf21, 4200000, stream=stream4)
            del buf20
            ...
            stream4 = get_raw_stream(4)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf8, (350, 1000, 16, 48), (768000, 768, 48, 1), 0), buf9, buf10, reinterpret_tensor(arg11_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg12_1, (1000, 24), (24, 1), 0), 4200000, 1, 1, stream=stream4)
            del arg11_1
            del arg12_1
            buf13 = empty_strided_cuda((350, 4, 1000, 48), (192000, 48, 192, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_3, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            stream4 = get_raw_stream(4)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_6.run(buf8, buf13, 67200000, stream=stream4)
            del buf8
            # Topologically Sorted Source Nodes: [linear_2, view, scaled_dot_product_attention, getitem_3, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_3, mul_6, sigmoid_2, getitem_7, mul_7], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream4 = get_raw_stream(4)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_7.run(buf24, buf23, 134400000, stream=stream4)
            del buf23
            ...
            # Topologically Sorted Source Nodes: [linear_4, add_3, rms_norm_1, to_11], Original ATen: [aten._unsafe_view, aten.add, aten._fused_rms_norm, aten._to_copy]
            stream4 = get_raw_stream(4)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_8.run(buf26, buf5, arg15_1, buf28, 350000, 384, stream=stream4)
            del arg15_1
...
def get_args():
    ...
    arg0_1 = rand_strided((350, 1000, 12), (12000, 12, 1), device='cuda:4', dtype=torch.int64)
    ...
    arg5_1 = rand_strided((350, 1000, 384), (384000, 384, 1), device='cuda:4', dtype=torch.bfloat16)
    arg6_1 = rand_strided((), (), device='cuda:4', dtype=torch.float32)
    arg7_1 = rand_strided((384, ), (1, ), device='cuda:4', dtype=torch.float32)
    arg8_1 = rand_strided((350, 1000), (1000, 1), device='cuda:4', dtype=torch.int64)
