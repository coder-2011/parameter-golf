...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/ea/ceabcmjban4xozfhleuh4xnhvpd27imxej6fuxfo32qrgeh73onh.py
...
#   %arg1_1 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=arg1_1]
#   %arg2_1 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=arg2_1]
#   %buf0 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf0]
#   %arg3_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg3_1]
#   %buf21 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf21]
#   %arg11_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg11_1]
#   %mul_4 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=mul_4]
...
#   %mul : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %arg1_1), kwargs = {})
...
#   %mul_1 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_3, %arg2_1), kwargs = {})
#   %add : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul, %mul_1), kwargs = {})
#   %pow_1 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add, 2), kwargs = {})
...
#   %add_1 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean, 1e-06), kwargs = {})
#   %rsqrt : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_1,), kwargs = {})
#   %mul_2 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add, %rsqrt), kwargs = {})
#   %mul_3 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_2, %arg3_1), kwargs = {})
#   %mul_4 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_3, 0.7071067811865475), kwargs = {})
#   %convert_element_type_2 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_4, torch.bfloat16), kwargs = {})
#   %pow_2 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add, 2), kwargs = {})
...
#   %add_2 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_1, 1e-06), kwargs = {})
#   %rsqrt_1 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_2,), kwargs = {})
#   %mul_7 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add, %rsqrt_1), kwargs = {})
#   %mul_8 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_7, %arg11_1), kwargs = {})
#   %mul_9 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_8, 0.7071067811865475), kwargs = {})
#   %convert_element_type_13 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_9, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/64/c64km5dbnub33afa57u3lgsngyimj6ni5awwf4h3pgfykrnytgoe.py
...
# Graph fragment:
#   %mul_4 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=mul_4]
#   %slice_2 : Tensor "f32[350, 1000, 12][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mul_4, 2, 0, 12), kwargs = {})
#   %clone_1 : Tensor "f32[350, 1000, 12][12000, 12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_2,), kwargs = {memory_format: torch.contiguous_format})
#   %convert_element_type_6 : Tensor "bf16[350, 1000, 12][12000, 12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%clone_1, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/zb/czbabdttfyv3ocyoqwxrv3qk5ljfnk2dflf7cu5s32kiasvfgnss.py
...
# Graph fragment:
#   %convert_element_type_6 : Tensor "bf16[350, 1000, 12][12032, 12, 1]cuda:3" = PlaceHolder[target=convert_element_type_6]
#   %slice_2 : Tensor "f32[350, 1000, 12][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mul_4, 2, 0, 12), kwargs = {})
#   %clone_1 : Tensor "f32[350, 1000, 12][12000, 12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_2,), kwargs = {memory_format: torch.contiguous_format})
#   %convert_element_type_6 : Tensor "bf16[350, 1000, 12][12000, 12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%clone_1, torch.bfloat16), kwargs = {})
#   %view_3 : Tensor "bf16[350000, 12][12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%convert_element_type_6, [350000, 12]), kwargs = {})
#   %convert_element_type_5 : Tensor "bf16[8, 12][12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%arg7_1, torch.bfloat16), kwargs = {})
...
#   %mm_1 : Tensor "bf16[350000, 8][8, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mm.default](args = (%view_3, %permute_7), kwargs = {})
#   return %buf16
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/mr/cmrwa47owmqse47eaxopvnkwu56kzdocuc6br5atukhjiqrmal4s.py
...
#   view => view_2
# Graph fragment:
#   %mm : Tensor "bf16[350000, 1152][1152, 1]cuda:3" = PlaceHolder[target=mm]
#   %view_1 : Tensor "bf16[350, 1000, 1152][1152000, 1152, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm, [350, 1000, 1152]), kwargs = {})
#   %view_2 : Tensor "bf16[350, 1000, 24, 48][1152000, 1152, 48, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.reshape.default](args = (%view_1, [350, 1000, 24, 48]), kwargs = {})
#   %permute_4 : Tensor "bf16[350, 8, 1000, 48][384000, 48, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty, [0, 2, 1, 3]), kwargs = {})
#   %permute_5 : Tensor "bf16[350, 8, 1000, 48][384000, 48, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%empty_1, [0, 2, 1, 3]), kwargs = {})
#   %slice_1 : Tensor "bf16[350, 1000, 8, 48][1152000, 1152, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%view_2, 2, 16, 9223372036854775807), kwargs = {})
#   %clone : Tensor "bf16[350, 1000, 8, 48][384000, 384, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_1,), kwargs = {memory_format: torch.contiguous_format})
#   %permute_3 : Tensor "bf16[350, 8, 1000, 48][384000, 48, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%clone, [0, 2, 1, 3]), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/r3/cr3r6cnfcmjc45yhjazhfxgvyjvhvoszxviz4v67twu2bpo5undy.py
...
#   %mm_1 : Tensor "bf16[350000, 8][8, 1]cuda:3" = PlaceHolder[target=mm_1]
#   %permute_6 : Tensor "bf16[350, 1000, 8, 48][384000, 384, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.permute.default](args = (%getitem_2, [0, 2, 1, 3]), kwargs = {})
#   %view_4 : Tensor "bf16[350, 1000, 8][8000, 8, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_1, [350, 1000, 8]), kwargs = {})
#   %mul_5 : Tensor "bf16[350, 1000, 8][8000, 8, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%view_4, 0.5), kwargs = {})
#   %sigmoid : Tensor "bf16[350, 1000, 8][8000, 8, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.sigmoid.default](args = (%mul_5,), kwargs = {})
#   %unsqueeze_4 : Tensor "bf16[350, 1000, 8, 1][8000, 8, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%sigmoid, 3), kwargs = {})
#   %mul_6 : Tensor "bf16[350, 1000, 8, 48][384000, 384, 48, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%permute_6, %unsqueeze_4), kwargs = {})
#   return %mul_6
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/yy/cyyppm24eagi2o3a4ampoiphx6zpl3obhkspyr6e63bkmokk4h44.py
...
#   square => pow_3
# Graph fragment:
#   %mm_3 : Tensor "bf16[350000, 1536][1536, 1]cuda:3" = PlaceHolder[target=mm_3]
#   %view_9 : Tensor "bf16[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_3, [350, 1000, 1536]), kwargs = {})
#   %convert_element_type_16 : Tensor "f32[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_9, torch.float32), kwargs = {})
#   %gt : Tensor "b8[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.gt.Scalar](args = (%convert_element_type_16, 0), kwargs = {})
#   %mul_10 : Tensor "f32[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_16, 0.5), kwargs = {})
#   %where : Tensor "f32[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt, %convert_element_type_16, %mul_10), kwargs = {})
#   %pow_3 : Tensor "f32[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%where, 2), kwargs = {})
#   %convert_element_type_21 : Tensor "bf16[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%pow_3, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/st/cstwweo4zwg2ppyuikdadexdvw5pbunxv3m2q37uutcxssqvbmal.py
...
#   %mm_2 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_2]
#   %arg10_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg10_1]
#   %mm_4 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_4]
#   %mul_13 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=mul_13]
#   %buf27 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf27]
#   %arg15_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg15_1]
#   %buf48 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf48]
#   %arg21_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg21_1]
#   %mul_17 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=mul_17]
#   %select : Tensor "f32[384][1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.select.int](args = (%arg0_1, 0, 0), kwargs = {})
#   %unsqueeze : Tensor "f32[1, 384][384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%select, 0), kwargs = {})
#   %unsqueeze_1 : Tensor "f32[1, 1, 384][384, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.unsqueeze.default](args = (%unsqueeze, 1), kwargs = {})
#   %mul : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_1, %arg1_1), kwargs = {})
...
#   %view_7 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_2, [350, 1000, 384]), kwargs = {})
#   %mul_11 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_6, %view_7), kwargs = {})
#   %add_3 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add, %mul_11), kwargs = {})
...
#   %view_11 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_4, [350, 1000, 384]), kwargs = {})
#   %mul_12 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_8, %view_11), kwargs = {})
#   %add_4 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_3, %mul_12), kwargs = {})
#   %mul_13 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_10, %add_4), kwargs = {})
...
#   %mul_14 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_12, %arg2_1), kwargs = {})
#   %add_5 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_13, %mul_14), kwargs = {})
#   %pow_4 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_5, 2), kwargs = {})
#   %mean_2 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_4, [2], True), kwargs = {})
#   %add_6 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_2, 1e-06), kwargs = {})
#   %rsqrt_2 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_6,), kwargs = {})
#   %mul_15 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_5, %rsqrt_2), kwargs = {})
#   %mul_16 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_15, %arg15_1), kwargs = {})
#   %mul_17 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_16, 0.5773502691896258), kwargs = {})
#   %convert_element_type_26 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_17, torch.bfloat16), kwargs = {})
#   %pow_5 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_5, 2), kwargs = {})
#   %mean_3 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_5, [2], True), kwargs = {})
#   %add_7 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_3, 1e-06), kwargs = {})
#   %rsqrt_3 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_7,), kwargs = {})
#   %mul_20 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_5, %rsqrt_3), kwargs = {})
#   %mul_21 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_20, %arg21_1), kwargs = {})
#   %mul_22 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_21, 0.5773502691896258), kwargs = {})
#   %convert_element_type_37 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_22, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/xr/cxrqvgbttdapakkobq3zbefznynnabgsbcwoqtwgzh5nhtdtm46w.py
...
#   %mm_7 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_7]
#   %arg20_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg20_1]
#   %mm_9 : Tensor "bf16[350000, 384][384, 1]cuda:3" = PlaceHolder[target=mm_9]
#   %add_10 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3" = PlaceHolder[target=add_10]
#   %buf54 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf54]
#   %arg25_1 : Tensor "f32[384][1]cuda:3" = PlaceHolder[target=arg25_1]
#   %buf68 : Tensor "f32[350, 1000, 1][1000, 1, 350016]cuda:3" = PlaceHolder[target=buf68]
...
#   %view_19 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_7, [350, 1000, 384]), kwargs = {})
#   %mul_24 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_15, %view_19), kwargs = {})
#   %add_8 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_5, %mul_24), kwargs = {})
...
#   %view_23 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_9, [350, 1000, 384]), kwargs = {})
#   %mul_25 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_17, %view_23), kwargs = {})
#   %add_9 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Tensor](args = (%add_8, %mul_25), kwargs = {})
#   %mul_26 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_19, %add_9), kwargs = {})
...
#   %mul_27 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%unsqueeze_21, %arg2_1), kwargs = {})
#   %add_10 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=5] = call_function[target=torch.ops.aten.add.Tensor](args = (%mul_26, %mul_27), kwargs = {})
#   %pow_7 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_10, 2), kwargs = {})
#   %mean_4 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_7, [2], True), kwargs = {})
#   %add_11 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_4, 1e-06), kwargs = {})
#   %rsqrt_4 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_11,), kwargs = {})
#   %mul_28 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %rsqrt_4), kwargs = {})
#   %mul_29 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %arg25_1), kwargs = {})
#   %mul_30 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_29, 0.5), kwargs = {})
#   %convert_element_type_50 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_30, torch.bfloat16), kwargs = {})
#   %pow_8 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%add_10, 2), kwargs = {})
#   %mean_5 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mean.dim](args = (%pow_8, [2], True), kwargs = {})
#   %add_12 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.add.Scalar](args = (%mean_5, 1e-06), kwargs = {})
#   %rsqrt_5 : Tensor "f32[350, 1000, 1][1000, 1, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.rsqrt.default](args = (%add_12,), kwargs = {})
#   %mul_33 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%add_10, %rsqrt_5), kwargs = {})
#   %mul_34 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_33, %arg31_1), kwargs = {})
#   %mul_35 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_34, 0.5), kwargs = {})
#   %convert_element_type_61 : Tensor "bf16[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%mul_35, torch.bfloat16), kwargs = {})
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/4q/c4qe6h6aj4fkbhhojibd3xundq6kaj37shzyqsmuzerjpcixi44g.py
...
#   %mul_29 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_28, %arg25_1), kwargs = {})
#   %mul_30 : Tensor "f32[350, 1000, 384][384000, 384, 1]cuda:3"[num_users=2] = call_function[target=torch.ops.aten.mul.Tensor](args = (%mul_29, 0.5), kwargs = {})
#   %slice_6 : Tensor "f32[350, 1000, 12][384000, 384, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.slice.Tensor](args = (%mul_30, 2, 0, 12), kwargs = {})
#   %clone_5 : Tensor "f32[350, 1000, 12][12000, 12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.clone.default](args = (%slice_6,), kwargs = {memory_format: torch.contiguous_format})
#   %convert_element_type_54 : Tensor "bf16[350, 1000, 12][12000, 12, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%clone_5, torch.bfloat16), kwargs = {})
...
@triton_heuristics.pointwise(
    size_hints={'x': 8388608}, 
    filename=__file__,
    triton_meta={'signature': {'in_ptr0': '*fp32', 'in_ptr1': '*fp32', 'in_ptr2': '*fp32', 'out_ptr0': '*bf16', 'xnumel': 'i32', 'XBLOCK': 'constexpr'}, 'device': DeviceProperties(type='cuda', index=3, multi_processor_count=132, cc=90, major=9, regs_per_multiprocessor=65536, max_threads_per_multi_processor=2048, max_threads_per_block=1024, warp_size=32), 'constants': {}, 'native_matmul': False, 'enable_fp_fusion': True, 'launch_pdl': False, 'disable_ftz': False, 'configs': [{(0,): [['tt.divisibility', 16]], (1,): [['tt.divisibility', 16]], (2,): [['tt.divisibility', 16]], (3,): [['tt.divisibility', 16]], (4,): [['tt.divisibility', 16]]}]},
...
# kernel path: /workspace/parameter-golf/.torchinductor_cache/tf/ctfeebsyvfncrkgamnvtgdg7ljdgfkrdkwlcrrpsybv43pixbh26.py
...
#   square_2 => pow_9
# Graph fragment:
#   %mm_13 : Tensor "bf16[350000, 1536][1536, 1]cuda:3" = PlaceHolder[target=mm_13]
#   %view_33 : Tensor "bf16[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.reshape.default](args = (%mm_13, [350, 1000, 1536]), kwargs = {})
#   %convert_element_type_64 : Tensor "f32[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=3] = call_function[target=torch.ops.prims.convert_element_type.default](args = (%view_33, torch.float32), kwargs = {})
#   %gt_2 : Tensor "b8[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.gt.Scalar](args = (%convert_element_type_64, 0), kwargs = {})
#   %mul_36 : Tensor "f32[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.mul.Tensor](args = (%convert_element_type_64, 0.5), kwargs = {})
#   %where_2 : Tensor "f32[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.where.self](args = (%gt_2, %convert_element_type_64, %mul_36), kwargs = {})
#   %pow_9 : Tensor "f32[350, 1000, 1536][1536000, 1536, 1]cuda:3"[num_users=1] = call_function[target=torch.ops.aten.pow.Tensor_Scalar](args = (%where_2, 2), kwargs = {})
#   return %pow_9
...
class Runner:
    ...
    def call(self, args):
        ...
        with torch.cuda._DeviceGuard(3):
            ...
            # Topologically Sorted Source Nodes: [getitem, getitem_1, mul, getitem_2, getitem_3, mul_1, add, rms_norm, mul_2, linear, rms_norm_1, mul_5, linear_3], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_red_fused__fused_rms_norm__to_copy_add_mul_select_unsqueeze_1.run(arg0_1, arg1_1, arg2_1, arg3_1, arg11_1, buf1, buf22, buf2, 350000, 384, stream=stream3)
            del arg11_1
            del arg3_1
            buf15 = empty_strided_cuda((350, 1000, 12), (12032, 12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_7, contiguous_6, linear_1], Original ATen: [aten.slice, aten.clone, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_slice_2.run(buf1, buf15, 4200000, stream=stream3)
            del buf1
            buf16 = empty_strided_cuda((350000, 12), (12, 1), torch.bfloat16)
            # Topologically Sorted Source Nodes: [getitem_7, contiguous_6, linear_1], Original ATen: [aten.slice, aten.clone, aten._to_copy, aten.view, aten.t, aten.mm]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_3.run(buf15, buf16, 4200000, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf3, (350, 1000, 24, 48), (1152000, 1152, 48, 1), 0), buf4, buf5, reinterpret_tensor(arg5_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg6_1, (1000, 24), (24, 1), 0), 5600000, 1, 1, stream=stream3)
            buf8 = reinterpret_tensor(buf2, (350, 8, 1000, 48), (384000, 48, 384, 1), 0); del buf2  # reuse
            # Topologically Sorted Source Nodes: [linear, view, scaled_dot_product_attention, getitem_4, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            stream3 = get_raw_stream(3)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_4.run(buf3, buf8, 134400000, stream=stream3)
            del buf3
            # Topologically Sorted Source Nodes: [linear, view, scaled_dot_product_attention, getitem_4, contiguous, transpose_2], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            # Topologically Sorted Source Nodes: [transpose_3, linear_1, mul_3, sigmoid, getitem_8, mul_4], Original ATen: [aten.transpose, aten._unsafe_view, aten.mul, aten.sigmoid, aten.unsqueeze]
            stream3 = get_raw_stream(3)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_5.run(buf19, buf18, 134400000, stream=stream3)
            ...
            # Topologically Sorted Source Nodes: [linear_3, leaky_relu, square, linear_4], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_6.run(buf24, 537600000, stream=stream3)
            ...
            # Topologically Sorted Source Nodes: [getitem, getitem_1, mul, getitem_2, getitem_3, mul_1, add, getitem_11, getitem_12, getitem_9, linear_2, mul_6, add_1, getitem_10, linear_4, mul_7, add_2, mul_8, getitem_13, getitem_14, mul_9, add_3, rms_norm_2, mul_10, linear_5, rms_norm_3, mul_13, linear_8], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_red_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_7.run(arg14_1, arg0_1, arg1_1, arg2_1, arg9_1, buf20, arg10_1, buf25, arg15_1, arg21_1, buf26, buf28, buf49, buf29, 350000, 384, stream=stream3)
            del arg0_1
            del arg10_1
            del arg15_1
            del arg1_1
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_slice_2.run(buf28, buf42, 4200000, stream=stream3)
            del buf28
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_3.run(buf42, buf43, 4200000, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf30, (350, 1000, 24, 48), (1152000, 1152, 48, 1), 0), buf31, buf32, reinterpret_tensor(arg5_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg6_1, (1000, 24), (24, 1), 0), 5600000, 1, 1, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_4.run(buf30, buf35, 134400000, stream=stream3)
            del buf30
            # Topologically Sorted Source Nodes: [linear_5, view_1, scaled_dot_product_attention_1, getitem_15, contiguous_8, transpose_6], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_5.run(buf46, buf45, 134400000, stream=stream3)
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy__unsafe_view_leaky_relu_pow_6.run(buf51, 537600000, stream=stream3)
            ...
            # Topologically Sorted Source Nodes: [getitem_13, getitem_14, mul_9, add_3, getitem_22, getitem_23, getitem_20, linear_7, mul_14, add_4, getitem_21, linear_9, mul_15, add_5, mul_16, getitem_24, getitem_25, mul_17, add_6, rms_norm_4, mul_18, linear_10, rms_norm_5, mul_21, linear_13], Original ATen: [aten.select, aten.unsqueeze, aten.mul, aten.add, aten._unsafe_view, aten._fused_rms_norm, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_per_fused__fused_rms_norm__to_copy__unsafe_view_add_mul_select_unsqueeze_8.run(buf53, arg24_1, arg14_1, arg2_1, arg19_1, buf47, arg20_1, buf52, arg25_1, arg31_1, buf54, buf55, buf69, 350000, 384, stream=stream3)
            del arg14_1
            del arg19_1
            del arg20_1
            del arg24_1
            ...
            # Topologically Sorted Source Nodes: [rms_norm_4, mul_18, getitem_29, contiguous_22, linear_11], Original ATen: [aten._fused_rms_norm, aten.mul, aten.slice, aten.clone, aten._to_copy]
            stream3 = get_raw_stream(3)
            triton_poi_fused__fused_rms_norm__to_copy_clone_mul_slice_9.run(buf53, buf54, arg25_1, buf72, 4200000, stream=stream3)
            del arg25_1
            del buf54
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__to_copy_clone_mm_slice_t_view_3.run(buf72, buf73, 4200000, stream=stream3)
            del buf72
            ...
            stream3 = get_raw_stream(3)
            _fused_qkv_postprocess_fwd_kernel_0.run(reinterpret_tensor(buf56, (350, 1000, 24, 48), (1152000, 1152, 48, 1), 0), buf57, buf58, reinterpret_tensor(arg5_1, (1000, 24), (24, 1), 0), reinterpret_tensor(arg6_1, (1000, 24), (24, 1), 0), 5600000, 1, 1, stream=stream3)
            del arg5_1
            del arg6_1
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__scaled_dot_product_flash_attention__unsafe_view_clone_slice_transpose_view_4.run(buf56, buf61, 134400000, stream=stream3)
            del buf56
            # Topologically Sorted Source Nodes: [linear_10, view_2, scaled_dot_product_attention_2, getitem_26, contiguous_16, transpose_10], Original ATen: [aten._unsafe_view, aten.view, aten.transpose, aten.slice, aten.clone, aten._scaled_dot_product_flash_attention]
            ...
            stream3 = get_raw_stream(3)
            triton_poi_fused__unsafe_view_mul_sigmoid_transpose_unsqueeze_5.run(buf76, buf75, 134400000, stream=stream3)
            del buf75
            ...
            # Topologically Sorted Source Nodes: [linear_13, leaky_relu_2, square_2], Original ATen: [aten._unsafe_view, aten.leaky_relu, aten.pow]
            stream3 = get_raw_stream(3)
            triton_poi_fused__unsafe_view_leaky_relu_pow_10.run(buf70, buf71, 537600000, stream=stream3)
            del buf70
...
def get_args():
    ...
    arg1_1 = rand_strided((350, 1000, 384), (384000, 384, 1), device='cuda:3', dtype=torch.float32)
    arg2_1 = rand_strided((350, 1000, 384), (384000, 384, 1), device='cuda:3', dtype=torch.bfloat16)
