...
#
# Standalone Python wrappers for the dropout_layer_norm extension. This file
# intentionally does not import flash_attn; it calls the compiled extension
# module directly.
...
def _dropout_add_layer_norm_subset_forward(
    ...
    beta: torch.Tensor | None,
    colscale: torch.Tensor | None,
    x0_subset: torch.Tensor | None,
    out_subset: torch.Tensor | None,
    dropout_p: float,
    epsilon: float,
...
def _dropout_add_layer_norm_parallel_residual_backward(
    dz0: torch.Tensor,
    dz1: torch.Tensor | None,
    dx: torch.Tensor | None,
    x: torch.Tensor,
    dmask0: torch.Tensor | None,
    dmask1: torch.Tensor | None,
    mu: torch.Tensor | None,
    rsigma: torch.Tensor,
    gamma0: torch.Tensor,
    gamma1: torch.Tensor | None,
    ...
    dxmat = dx.view(xmat.shape) if dx is not None else None
    return dropout_layer_norm.dropout_add_ln_parallel_residual_bwd(
        dz0mat,
        dz1mat,
        dxmat,
        xmat,
...
def dropout_add_layer_norm_subset(
    ...
    epsilon: float,
    layerscale: torch.Tensor | None = None,
    x0_subset: torch.Tensor | None = None,
    out_subset: torch.Tensor | None = None,
    rowscale_const: float = 1.0,
    out_numrows: int = 0,
    prenorm: bool = False,
    residual_in_fp32: bool = False,
    return_dropout_mask: bool = False,
...
class DropoutAddLayerNorm(torch.nn.Module):
    ...
    def forward(self, x0: torch.Tensor, residual: torch.Tensor | None = None):
