#!/usr/bin/env bash
set -euo pipefail
export RUN_ID=fix_sp1892_parallel_xsa_muon_qat6_gptq6_keepfragile_20260428_223813
...
cd "/workspace/parameter-golf/runs/fix_sp1892_parallel_xsa_muon_qat6_gptq6_keepfragile_20260428_223813"
