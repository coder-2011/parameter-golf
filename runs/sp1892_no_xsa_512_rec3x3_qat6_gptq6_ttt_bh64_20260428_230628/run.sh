#!/usr/bin/env bash
set -euo pipefail
export RUN_ID=sp1892_no_xsa_512_rec3x3_qat6_gptq6_ttt_bh64_20260428_230628
...
export QAT_ACTIVATION_BITS=0
export QAT_START_STEP=500
export QAT_LINEAR=1
export QAT_EMBEDDINGS=0
export QAT_TIED_OUTPUT=0
...
export GPTQ_QUANTIZE_EMBEDDINGS=0
export QUANT_BITS=6
export QUANT_KEEP_FLOAT_PATTERNS=tok_emb.weight,bigram_hash.embed.weight,poe_heads
...
export TTT_GRAD_CLIP=1
cd "/workspace/parameter-golf/runs/sp1892_no_xsa_512_rec3x3_qat6_gptq6_ttt_bh64_20260428_230628"
