#!/bin/bash
set -euo pipefail
cd /workspace/parameter-golf/runs/exp_bigram8192
...
export BIGRAM_HASH_BUCKETS=8192 BIGRAM_HASH_DIM=128 BIGRAM_HASH_HEADS=2 BIGRAM_HASH_GATE=1
export RUN_ID=exp_bigram8192
