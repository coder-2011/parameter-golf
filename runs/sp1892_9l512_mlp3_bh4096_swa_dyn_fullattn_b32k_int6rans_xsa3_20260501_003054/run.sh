#!/usr/bin/env bash
set -euo pipefail
export RUN_ID=sp1892_9l512_mlp3_bh4096_swa_dyn_fullattn_b32k_int6rans_xsa3_20260501_003054
...
cd /workspace/parameter-golf/runs/sp1892_9l512_mlp3_bh4096_swa_dyn_fullattn_b32k_int6rans_xsa3_20260501_003054
