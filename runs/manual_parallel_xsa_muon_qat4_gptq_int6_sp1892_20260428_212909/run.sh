#!/usr/bin/env bash
set -euo pipefail
export RUN_ID=manual_parallel_xsa_muon_qat4_gptq_int6_sp1892_20260428_212909
...
cd /workspace/parameter-golf/runs/manual_parallel_xsa_muon_qat4_gptq_int6_sp1892_20260428_212909
