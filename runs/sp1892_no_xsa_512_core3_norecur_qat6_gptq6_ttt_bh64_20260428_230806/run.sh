#!/usr/bin/env bash
set -euo pipefail
export RUN_ID=sp1892_no_xsa_512_core3_norecur_qat6_gptq6_ttt_bh64_20260428_230806
...
cd "/workspace/parameter-golf/runs/sp1892_no_xsa_512_core3_norecur_qat6_gptq6_ttt_bh64_20260428_230806"
