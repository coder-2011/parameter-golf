#!/bin/bash
set -euo pipefail
cd /workspace/parameter-golf/runs/exp_noloop_currentstack_solo
...
export RECURRENT_DIM=256 RECURRENT_NUM_HEADS=4 MEAN_RECURRENCE=1 MEAN_BACKPROP_DEPTH=1
...
export PRELUDE_NORM=0 GRAD_CLIP_NORM=0.0
export RUN_ID=exp_noloop_currentstack_solo
