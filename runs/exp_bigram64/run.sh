#!/bin/bash
set -euo pipefail
cd /workspace/parameter-golf/runs/exp_bigram64
...
export BIGRAM_HASH_BUCKETS=4096 BIGRAM_HASH_DIM=64 BIGRAM_HASH_HEADS=2 BIGRAM_HASH_GATE=1
export RUN_ID=exp_bigram64
