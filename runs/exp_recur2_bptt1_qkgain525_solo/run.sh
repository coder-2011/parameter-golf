#!/bin/bash
set -euo pipefail
cd /workspace/parameter-golf/runs/exp_recur2_bptt1_qkgain525_solo
...
export PRELUDE_NORM=0 GRAD_CLIP_NORM=0.0 QK_GAIN_INIT=5.25
export RUN_ID=exp_recur2_bptt1_qkgain525_solo
