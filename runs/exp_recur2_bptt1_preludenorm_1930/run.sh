#!/bin/bash
set -euo pipefail
cd /workspace/parameter-golf/runs/exp_recur2_bptt1_preludenorm_1930
...
export VOCAB_SIZE=1024 MODEL_DIM=256 NUM_HEADS=4 NUM_KV_HEADS=2 MLP_MULT=3
export N_LAYERS_IN_PRELUDE=1 N_LAYERS_IN_RECURRENT_BLOCK=2 N_LAYERS_IN_CODA=1
export RECURRENT_DIM=256 RECURRENT_NUM_HEADS=4 MEAN_RECURRENCE=2 MEAN_BACKPROP_DEPTH=1
export TRAIN_BATCH_TOKENS=16384 TRAIN_SEQ_LEN=512 ITERATIONS=1930 MAX_WALLCLOCK_SECONDS=0
...
export PRELUDE_NORM=1 GRAD_CLIP_NORM=0.0
export RUN_ID=exp_recur2_bptt1_preludenorm_1930
