#!/bin/bash
set -euo pipefail
cd /workspace/parameter-golf/runs/exp_recur2_bptt1_preludenorm_clip_solo
...
export PRELUDE_NORM=1 GRAD_CLIP_NORM=1.0
export RUN_ID=exp_recur2_bptt1_preludenorm_clip_solo
