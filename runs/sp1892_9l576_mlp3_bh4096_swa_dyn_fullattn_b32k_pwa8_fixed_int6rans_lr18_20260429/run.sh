...
export RUN_ID=sp1892_9l576_mlp3_bh4096_swa_dyn_fullattn_b32k_pwa8_fixed_int6rans_lr18_20260429
...
export RECURRENT_DIM=576
export RECURRENT_INTERMEDIATE_DIM=1728
...
export ATTN_QKV_MODE=pwa
export PWA_NUM_BASES=8
export PWA_PERMUTE_SIZE=4
export ATTENTION_WINDOW=-1
...
export SWA_DYNAMIC_MIN_EVERY=10
export SWA_DYNAMIC_POWER=1.5
export SWA_DYNAMIC_WEIGHT_MAX=2.0

export MUON_WD=0.04
export MUON_ROW_NORMALIZE=1
export MATRIX_LR=0.018
export SCALAR_LR=0.018
export TIED_EMBED_LR=0.028

cd /workspace/parameter-golf/runs/sp1892_9l576_mlp3_bh4096_swa_dyn_fullattn_b32k_pwa8_fixed_int6rans_lr18_20260429
