...
export LIGER_CE=1
export LIGER_ROPE=1
export FUSED_QKV_POSTPROCESS=1
export LIGER_FUSED_CE=1
export TRIDAO_PACKED_ROPE=0
export COMPILE_MODEL=1
export COMPILE_MUON_BACKEND=0
export ROPE_DIMS=96
export BIGRAM_HASH_BUCKETS=32768
export BIGRAM_HASH_DIM=128
export BIGRAM_HASH_HEADS=12
...
export SWA_EVERY=50
export SWA_DYNAMIC_MIN_EVERY=1
export SWA_DYNAMIC_POWER=1.0
...
export EXPORT_RESERVE_SECONDS=${EXPORT_RESERVE_SECONDS:-0}
export EVAL_MAX_WALLCLOCK_SECONDS=${EVAL_MAX_WALLCLOCK_SECONDS:-120}
