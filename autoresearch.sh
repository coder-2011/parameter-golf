#!/bin/bash
# ATTENTION AI AGENTS: EVERY FEW RUNS, READ autoresearch.md FOR UP-TO-DATE INFORMATION ON HYPERPARAMETERS
set -euo pipefail
cd "$(dirname "$0")"
...
# SP8192 CaseOps 300s — Scale up within 16MB limit, MEAN_RECURRENCE=1
...
export DATA_PATH="./caseops_sp8192/datasets/fineweb10B_sp8192_lossless_caps_caseops_v1_reserved"
export TOKENIZER_PATH="./data/tokenizers/fineweb_8192_bpe_lossless_caps_caseops_v1_reserved.model"
export VOCAB_SIZE=8192
export MODEL_DIM=400
export RECURRENT_DIM=400
export NUM_HEADS=4
...
export DOCUMENT_PACKING=${DOCUMENT_PACKING:-0}
export DOCUMENT_PACKING_CU_BUCKET_SIZE=${DOCUMENT_PACKING_CU_BUCKET_SIZE:-64}
...
export FUSED_SOFTCAPPED_CE=${FUSED_SOFTCAPPED_CE:-0}
export LIGER_ROPE=${LIGER_ROPE:-0}
export TRIDAO_PACKED_ROPE=${TRIDAO_PACKED_ROPE:-0}
export FUSED_QKV_POSTPROCESS=${FUSED_QKV_POSTPROCESS:-0}
export MONITORING=0
export LOCKSTEP_N=0
export LOCKSTEP_K=0
...
export PWA_LR=${PWA_LR:-${MATRIX_LR}}
export SCALAR_LR=${SCALAR_LR:-0.04}
export MUON_BACKEND_STEPS=5
export MUON_NS_COEFFS=${MUON_NS_COEFFS:-classic}
...
export SWA_START_STEP=${SWA_START_STEP:-1500}
...
export QAT_GROUP_SIZE=${QAT_GROUP_SIZE:-32}
export QAT_ACTIVATION_BITS=${QAT_ACTIVATION_BITS:-0}
export QAT_LINEAR=${QAT_LINEAR:-1}
export QAT_EMBEDDINGS=${QAT_EMBEDDINGS:-1}
...
export QUANT_EMBED_BITS=${QUANT_EMBED_BITS:-7}
export QUANT_ATTN_BITS=${QUANT_ATTN_BITS:-6}
export QUANT_MLP_BITS=${QUANT_MLP_BITS:-6}
export QUANT_LOW_BITS=${QUANT_LOW_BITS:-4}
export QUANT_CONTROL_BITS=${QUANT_CONTROL_BITS:-0}
export QUANT_LOW_BIT_PATTERNS=${QUANT_LOW_BIT_PATTERNS:-project_out,poe_heads}
export QUANT_KEEP_FLOAT_PATTERNS=${QUANT_KEEP_FLOAT_PATTERNS:-}
export LQER_ENABLED=${LQER_ENABLED:-0}
...
export RRHP_REDUCTION_FACTOR=${RRHP_REDUCTION_FACTOR:-4}
export PWA_NUM_BASES=${PWA_NUM_BASES:-6}
export PWA_PERMUTE_SIZE=${PWA_PERMUTE_SIZE:-4}
export PWA_INIT_SCALE=${PWA_INIT_SCALE:-0.7071067811865475}
...
export PARALLEL_RESIDUAL_RECORD_CONTROLS=${PARALLEL_RESIDUAL_RECORD_CONTROLS:-1}
export PARALLEL_RESIDUAL_TIED_NORM=${PARALLEL_RESIDUAL_TIED_NORM:-0}
export PARALLEL_RESIDUAL_IN_FP32=${PARALLEL_RESIDUAL_IN_FP32:-0}
export UNET_SKIP_ENABLED=${UNET_SKIP_ENABLED:-0}
export UNET_SKIP_INIT=${UNET_SKIP_INIT:-1.0}
export RESIDUAL_FORGET_GATE=${RESIDUAL_FORGET_GATE:-1}
export RESIDUAL_FORGET_GATE_BIAS=${RESIDUAL_FORGET_GATE_BIAS:--4.0}
export RESIDUAL_FORGET_MIN_RAD=${RESIDUAL_FORGET_MIN_RAD:-0.99}
export RESIDUAL_FORGET_MAX_RAD=${RESIDUAL_FORGET_MAX_RAD:-0.999}
export ATTN_OUT_GATE_ENABLED=${ATTN_OUT_GATE_ENABLED:-0}
export ATTN_OUT_GATE_SRC=${ATTN_OUT_GATE_SRC:-proj}
export GATED_ATTN_ENABLED=${GATED_ATTN_ENABLED:-0}
export GATED_ATTN_INIT_STD=${GATED_ATTN_INIT_STD:-0.01}
