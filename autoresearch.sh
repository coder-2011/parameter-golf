...
export LAUREL_SCOPE=${LAUREL_SCOPE:-none}
export LAUREL_RANK=${LAUREL_RANK:-0}
export LAUREL_SCALE_INIT=${LAUREL_SCALE_INIT:-0.01}
export LAUREL_NORM=${LAUREL_NORM:-1}
export RESIDUAL_MODE=${RESIDUAL_MODE:-sequential}
export PARALLEL_RESIDUAL_SCOPE=${PARALLEL_RESIDUAL_SCOPE:-none}
